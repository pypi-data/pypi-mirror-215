...
class ChiliConnector:
    ...
    def __str__(self) -> str:
        return f'ChiliConnector(backofficeURL={self.backofficeURL}, environment={self.enviroment}, baseURL={self.baseURL}, requestURL={self.requestURL})'

    def asDict(self) -> dict:
        return {"backofficeURL":self.backofficeURL, "environment":self.enviroment, "baseURL":self.baseURL, "requestURL":self.requestURL}
