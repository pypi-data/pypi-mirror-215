...
class GetRelationView(BaseView):
    ...
    async def get_relation_queryset(self, filters: dict, *args, **kwargs) -> QuerySet:
        ...
        queryset = self.filter_relation_controller.query(queryset=queryset, values=filters)
    ...
    def relation_filter_queryset(self, queryset: QuerySet, filters: dict) -> QuerySet:
        """
        处理filters
    ...
    def _handler_get_relation_settings(self):
        ...
        self.filter_relation_controller = FilterController(get_base_filter_list(self.relation_filter_fields))
