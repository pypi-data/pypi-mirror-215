...
class PluginUploader:
  ...
  ;
    ...
    def upload_plugin(self,plugin_directory:Path,
        ...
        anaconda_packages = [w for w in anaconda_packages if 'snowflake-connector-python' not in w]
        ...
        with open(install_script,'w',encoding='utf-8') as setup_script:
            ...
            for proc_template in ['API_LIMITS','APPLY','CONFIGURATION_FORM','CONNECTION_TEST','CONNECTION_FORM','CREATE_BILLING_EVENTS','NETWORK_ADDRESSES','RETRIEVE_SECRETS']:
