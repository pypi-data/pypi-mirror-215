...
from guardian_queryset.manager import GuardianManager, ForeignKeyGuardianManager
...
class ForeignKeyGuardianModel(GuardianModel):
    is_foreign_key_guardian = True

    objects = ForeignKeyGuardianManager()
