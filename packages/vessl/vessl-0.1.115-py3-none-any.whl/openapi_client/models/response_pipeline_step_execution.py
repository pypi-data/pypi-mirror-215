...
class ResponsePipelineStepExecution(object):
    ...
    openapi_types = {
        ...
        'jupyter_visualization_result': 'ResponsePipelineStepJupyterVisualizationResult',
    ...
    attribute_map = {
        ...
        'jupyter_visualization_result': 'jupyter_visualization_result',
        'logs': 'logs',
    ...
    def __init__(self, context=None, created_dt=None, description=None, external_service_result=None, id=None, if_result=None, input_result=None, judgment_result=None, jupyter_visualization_result=None, logs=None, run_result=None, status=None, title=None, type=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._jupyter_visualization_result = None
        self._logs = None
        ...
        if jupyter_visualization_result is not None:
            self.jupyter_visualization_result = jupyter_visualization_result
        self.logs = logs
    ...
    @property
    def jupyter_visualization_result(self):
        """Gets the jupyter_visualization_result of this ResponsePipelineStepExecution.  # noqa: E501


        :return: The jupyter_visualization_result of this ResponsePipelineStepExecution.  # noqa: E501
        :rtype: ResponsePipelineStepJupyterVisualizationResult
        """
        return self._jupyter_visualization_result

    @jupyter_visualization_result.setter
    def jupyter_visualization_result(self, jupyter_visualization_result):
        """Sets the jupyter_visualization_result of this ResponsePipelineStepExecution.


        :param jupyter_visualization_result: The jupyter_visualization_result of this ResponsePipelineStepExecution.  # noqa: E501
        :type jupyter_visualization_result: ResponsePipelineStepJupyterVisualizationResult
        """

        self._jupyter_visualization_result = jupyter_visualization_result
