...
class OrmKernelResourceSpecEdges(object):
    ...
    def __init__(self, kernel_cluster=None, pipeline_step_jupyter_visualization_specs=None, pipeline_step_run_specs=None, pricing_plans=None, local_vars_configuration=None):  # noqa: E501
