...
class OrmPipelineSpec(object):
    ...
    def __init__(self, created_dt=None, edges=None, id=None, parameter_spec=None, pipeline_id=None, published=None, revision=None, step_dependencies=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
