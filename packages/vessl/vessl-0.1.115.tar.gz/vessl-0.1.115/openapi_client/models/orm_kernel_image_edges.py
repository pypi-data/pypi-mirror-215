...
class OrmKernelImageEdges(object):
    ...
    def __init__(self, model_service_revisions=None, organization=None, organization_credentials=None, pipeline_step_jupyter_visualization_specs=None, pipeline_step_run_specs=None, local_vars_configuration=None):  # noqa: E501
