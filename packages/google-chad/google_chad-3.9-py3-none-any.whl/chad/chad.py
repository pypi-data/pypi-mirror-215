...
class Chad:
	...
	def __download(self, url):
		...
		response = None
		try:
			response = session.get(url, headers = self.__get_headers(), proxies = None, timeout = 90, verify = False, allow_redirects = True)
...
class Validate:
	...
	def __basic(self):
		...
		print("Chad v3.9 ( github.com/ivan-sincek/chad )")
		print("")
