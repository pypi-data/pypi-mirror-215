...
class ResultsOnlyProtocolArgumentsConfig:
    """Configuration for the Results Only Protocol Arguments."""
...
class ResultsOnlyProtocolConfig(ProtocolConfig):
    """Configuration for the Results Only Protocol."""
...
class FederatedAveragingProtocolArgumentsConfig:
    """Configuration for the Fdereated Averaging Protocol Arguments."""
...
class FederatedAveragingProtocolConfig(ProtocolConfig):
    """Configuration for the Fdereated Averaging Protocol."""
