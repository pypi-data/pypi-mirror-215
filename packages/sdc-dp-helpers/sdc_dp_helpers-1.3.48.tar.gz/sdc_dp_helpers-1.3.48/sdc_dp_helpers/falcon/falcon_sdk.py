# pylint: disable=too-few-public-methods,arguments-differ,import-error,too-many-arguments,too-many-locals,line-too-long, disable=useless-elif-before-else, disable=R1705, disable=R1720, disable=W1309
""" Falcon Reader SDK"""
...
class ChannelIdsV1(RequestHandler):
    ...
    @retry_handler(exceptions=FalconQuotaException, total_tries=1)
    ...
    def make_api_call(self, **kwargs):
        ...
        if int(response.status_code) == 429:
            if 'Retry-After' in response.headers and 'Too Many Requests' not in response.reason:
