...
class RouteHandler(APIHandler):
    ...
    def get(self):
        try:
            ...
            self.log.info(f"There has been an exception reading the nbconvert-queue db => {e}")
    ...
    def post(self):
        ...
        self.finish(json.dumps({
            "data": "This is /nbconvert-queue/run endpoint!"
        }))
...
def setup_handlers(web_app):
    ...
    handlers = [
        (url_path_join(base_url, "nbconvert-queue", "run"), RouteHandler)
    ]
