"use strict";
(self["webpackChunknbconvert_queue"] = self["webpackChunknbconvert_queue"] || []).push([["lib_index_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_viewBox_27-4_-4_8_8-ebac61"],{
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap_Stack__WEBPACK_IMPORTED_MODULE_5__["default"], { gap: 1, direction: "horizontal" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap_OverlayTrigger__WEBPACK_IMPORTED_MODULE_6__["default"], { placement: "bottom", overlay: removeFromListTooltip },
                        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_bootstrap_Button__WEBPACK_IMPORTED_MODULE_7__["default"], { className: "ms-auto", variant: "link", size: "sm", onClick: e => handleDeleteClick(e, run.id, run.pid), disabled: false },
                            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: "fa fa-times m-3", "aria-hidden": "true" }))))))));
};
...
async function requestAPI(endPoint = '', init = {}) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.URLExt.join(settings.baseUrl, 'nbconvert-queue', // API Namespace
    endPoint);
    let response;
    try {
        ...
        app.commands.addCommand('nbconvert_queue:open', {
            ...
            execute: () => {
                ...
                (0,_handler__WEBPACK_IMPORTED_MODULE_4__.requestAPI)('run', {
                    ...
                    .catch(reason => {
                    console.error(`The nbconvert_queue server extension appears to be missing.\n${reason}`);
                });
            }
        });
...
//# sourceMappingURL=lib_index_js-data_image_svg_xml_3csvg_xmlns_27http_www_w3_org_2000_svg_27_viewBox_27-4_-4_8_8-ebac61.3fad158ff198e0983a0d.js.map