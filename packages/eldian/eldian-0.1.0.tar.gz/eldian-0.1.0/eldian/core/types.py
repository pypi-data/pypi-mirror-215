...
class KEEP:
    """
    A KindlyExcuseExactPlacement (abbrv. KEEP) is a placeholder object that indicates
      the wrapped object should be ignored by the Mapper class when removing values.
