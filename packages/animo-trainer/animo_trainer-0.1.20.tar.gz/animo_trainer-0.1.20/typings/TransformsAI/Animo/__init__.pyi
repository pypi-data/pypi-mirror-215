...
from System import Guid, Func_2, IEquatable_1, Array_1, Random, Predicate_1
...
class GridObject(abc.ABC):
    ...
    def ContinueUsingIntentOverride(self, characterAction: CharacterObject.Actions, intent: clr.Reference[Intent]) -> bool: ...
    ...
    def GetSubObjects(self, outObjects: List_1[GridObject]) -> None: ...
    def OnDestroyed(self, outIntents: List_1[Intent]) -> None: ...
    ...
    class FindCausedIntent_MethodGroup:
        ...
        class FindCausedIntent_1(typing.Generic[FindCausedIntent_1_T1]):
            ...
            def __call__(self, selector: Func_2[FindCausedIntent_1_T, bool] = ...) -> FindCausedIntent_1_T:...
    ...
    class FindIntent_MethodGroup:
        ...
        class FindIntent_1(typing.Generic[FindIntent_1_T1]):
            FindIntent_1_T = GridObject.FindIntent_MethodGroup.FindIntent_1_T1
    ...
    class TryMove_MethodGroup:
        ...
        @typing.overload
        def __call__(self, target: GridTransform, outIntents: List_1[Intent]) -> bool:...
...
class HoldableObject(GridObject):
    ...
    @Holder.setter
    def Holder(self, value: Actor) -> Actor: ...
    @property
    def InstanceId(self) -> Guid: ...
    @property
    def IntentsFiredThisTurn(self) -> List_1[Intent]: ...
...
class IIntentConflictResolver(typing.Protocol):
    @abc.abstractmethod
...
class ObjectInfo(IEquatable_1[ObjectInfo], abc.ABC):
    ...
    def CanMakeExist(self, typeIds: TypeIds) -> bool: ...
...
class SimulationRunner:
    ...
    # Skipped LeaseIntents due to it being static, abstract and generic.

    LeaseIntents : LeaseIntents_MethodGroup
    class LeaseIntents_MethodGroup:
        def __getitem__(self, t:typing.Type[LeaseIntents_1_T1]) -> LeaseIntents_1[LeaseIntents_1_T1]: ...

        LeaseIntents_1_T1 = typing.TypeVar('LeaseIntents_1_T1')
        class LeaseIntents_1(typing.Generic[LeaseIntents_1_T1]):
            LeaseIntents_1_T = SimulationRunner.LeaseIntents_MethodGroup.LeaseIntents_1_T1
            def __call__(self) -> PooledList_1[LeaseIntents_1_T]:...
...
class VoxelGrid:
    ...
    def FindClosestGroundMaterial(self, position: Vec2Int, material: GroundMaterials) -> typing.Optional[Vec3Int]: ...
    @staticmethod
