...
from TransformsAI.Animo import VoxelGrid, ObjectInfo
...
class RewardEvaluator:
    ...
    def ClearExecutionCounts(self) -> int: ...
    def OnIntentExecuted(self, intent: Intent) -> None: ...
    def OnStepComplete(self, grid: VoxelGrid) -> None: ...
...
class TargetedReward(Reward):
    ...
    def CheckBesideTarget(self, grid: VoxelGrid, cell: Vec2Int, target: RewardTarget) -> bool: ...
