...
class GridSensor(Sensor):
    ...
    def GetGridObservations(self, character: Character, xzdObservations: Array_1[float]) -> None: ...
...
class VariableLengthSensor(Sensor):
    ...
    @property
    def SensorSpec(self) -> SensorSpec: ...
    def GetEntitiesObservations(self, character: Character, outEPObservations: Array_1[float], offset: int = ...) -> None: ...
...
class VectorSensor(Sensor):
    ...
    class GetObservations_MethodGroup:
        @typing.overload
        def __call__(self, character: Character, values: Span_1[float]) -> None:...
        @typing.overload
        def __call__(self, character: Character, observations: Array_1[float], offset: int = ...) -> None:...
