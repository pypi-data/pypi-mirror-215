import typing
from TransformsAI.Animo import ObjectInfo, GridObject, VoxelGrid, GridTransform
from System import IEquatable_1, Array_1, Guid
...
class SnowPalObject(GridObject):
    def __init__(self) -> None: ...
    DecisionOverride : SnowPalObject.Decision
    Info : ObjectInfo
    ...
    class Decision(typing.SupportsInt):
        ...
        # Values:
        Wait : SnowPalObject.Decision # 0
        MoveForward : SnowPalObject.Decision # 1
        TurnRight : SnowPalObject.Decision # 2
        TurnLeft : SnowPalObject.Decision # 3
        TurnAround : SnowPalObject.Decision # 4
        ThrowSnowball : SnowPalObject.Decision # 5
    ...
    class States(typing.SupportsInt):
        ...
        # Values:
        Idle : SnowPalObject.States # 0
        Wander : SnowPalObject.States # 1
        Aim : SnowPalObject.States # 2
        Throw : SnowPalObject.States # 3
        ForceMove : SnowPalObject.States # 4
        Asleep : SnowPalObject.States # 5
        Flee : SnowPalObject.States # 6
