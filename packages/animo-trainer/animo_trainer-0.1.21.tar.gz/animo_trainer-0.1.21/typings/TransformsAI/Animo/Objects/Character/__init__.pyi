...
from System import Array_1, IEquatable_1, Guid
from TransformsAI.Animo.Intents import Intent, UseIntent
from TransformsAI.Animo import ObjectInfo, GridObject, Actor, VoxelGrid, HoldableObject, GridTransform
...
class CharacterObject(Actor):
    ...
    @property
    def ObjectInUse(self) -> GridObject: ...
    @ObjectInUse.setter
    def ObjectInUse(self, value: GridObject) -> GridObject: ...
    @property
