...
class SentinelAPI:
    ...
    def query(
        ...
        **keywords
        ...
        response, count = self._load_query(query, formatted_order_by, limit, offset, progress_id)
    ...
    def _load_query(self, query, order_by=None, limit=None, offset=0, progress_id=None):
