...
class Encoder_Conv_AE_MNIST(BaseEncoder):
    ...
    .. code-block::
            ...
            >>> from XGen.models.nn.benchmarks.mnist import Encoder_Conv_AE_MNIST
...
class Encoder_Conv_VAE_MNIST(BaseEncoder):
    ...
    .. code-block::
            ...
            >>> from XGen.models.nn.benchmarks.mnist import Encoder_Conv_VAE_MNIST
...
class Encoder_Conv_SVAE_MNIST(BaseEncoder):
    ...
    .. code-block::
            ...
            >>> from XGen.models.nn.benchmarks.mnist import Encoder_Conv_SVAE_MNIST
...
class Decoder_Conv_AE_MNIST(BaseDecoder):
    ...
    .. code-block::
            ...
            >>> from XGen.models.nn.benchmarks.mnist import Decoder_Conv_AE_MNIST
            >>> from XGen.models import VAEConfig
            >>> model_config = VAEConfig(input_dim=(1, 28, 28), latent_dim=16)
...
class Discriminator_Conv_MNIST(BaseDiscriminator):
    ...
    .. code-block::
            ...
            >>> from XGen.models.nn.benchmarks.mnist import Discriminator_Conv_MNIST
