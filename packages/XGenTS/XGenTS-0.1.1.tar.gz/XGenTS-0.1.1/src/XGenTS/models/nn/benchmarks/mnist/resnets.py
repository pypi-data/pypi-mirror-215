...
class Encoder_ResNet_AE_MNIST(BaseEncoder):
    ...
    .. code-block::
        ...
        >>> from XGen.models.nn.benchmarks.mnist import Encoder_ResNet_AE_MNIST
...
class Encoder_ResNet_VAE_MNIST(BaseEncoder):
    ...
    .. code-block::
        ...
        >>> from XGen.models.nn.benchmarks.mnist import Encoder_ResNet_VAE_MNIST
...
class Encoder_ResNet_SVAE_MNIST(BaseEncoder):
    ...
    .. code-block::
        ...
        >>> from XGen.models.nn.benchmarks.mnist import Encoder_ResNet_SVAE_MNIST
...
class Encoder_ResNet_VQVAE_MNIST(BaseEncoder):
    ...
    .. code-block::
        ...
        >>> from XGen.models.nn.benchmarks.mnist import Encoder_ResNet_VQVAE_MNIST
...
class Decoder_ResNet_AE_MNIST(BaseDecoder):
    ...
    .. code-block::
        ...
        >>> from XGen.models.nn.benchmarks.mnist import Decoder_ResNet_AE_MNIST
        >>> from XGen.models import VAEConfig
        >>> model_config = VAEConfig(input_dim=(1, 28, 28), latent_dim=16)
...
class Decoder_ResNet_VQVAE_MNIST(BaseDecoder):
    ...
    .. code-block::
        ...
        >>> from XGen.models.nn.benchmarks.mnist import Decoder_ResNet_VQVAE_MNIST
        >>> from XGen.models import VQVAEConfig
        >>> model_config = VQVAEConfig(input_dim=(1, 28, 28), latent_dim=16)
