...
def computeIndex(
    ...
    **kwargs,
    ...
    >>> hrsii.computeIndex("NDVI",N = 0.643,R = 0.175)
    0.5721271393643031
    ...
    hrsii is versatile! Let's compute Spectral Indices from a :code:`numpy.ndarray`:
...
def computeKernel(kernel: str, params: Optional[dict] = None, **kwargs) -> Any:
    ...
    Examples
    --------
    Compute a kernel index with the help of :code:`hrsii.computeKernel()`:
    ...
    ...     index = "kNDVI",
    ...     kNN = 1.0,
    ...     kNR = hrsii.computeKernel("RBF",a = 0.68,b = 0.13,sigma = (0.68 + 0.13) / 2)
    ... )
    0.4309459271768674
    ...
    ...     index = "kNDVI",
    ...     params = {
    ...         "kNN": hrsii.computeKernel(
    ...             kernel = "poly",
    ...             params = {
    ...                 "a" : 0.68,
    ...                 "b": 0.68,
    ...                 "p": 2.0,
    ...                 "c": hrsii.constants.c.default
    ...             }
    ...         ),
    ...         "kNR": hrsii.computeKernel(
    ...             kernel = "poly",
