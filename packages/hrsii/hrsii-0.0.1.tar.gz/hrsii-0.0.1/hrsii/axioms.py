...
from .hrsii import computeIndex
...
class SpectralIndex(object):
    ...
    >>> hrsii.indices.NIRv.contributor
    'https://github.com/davemlz'
    >>> hrsii.indices.NIRv.compute(N = 0.67,R = 0.12)
    0.4664556962025317
    """
    ...
    def compute(self, params=None, **kwargs):
        ...
        >>> hrsii.indices.NDVI.compute(N = 0.643, R = 0.175, L = 0.5)
        0.5721271393643031
        """
