...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'aserto.directory.schema.v2.group_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GROUPPROPERTIES._serialized_start=70
  _GROUPPROPERTIES._serialized_end=124
