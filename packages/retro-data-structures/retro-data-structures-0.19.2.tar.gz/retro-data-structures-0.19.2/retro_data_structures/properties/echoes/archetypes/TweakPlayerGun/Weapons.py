...
class Weapons(BaseProperty):
    ...
    def _dependencies_for_bomb(self, asset_manager, is_mlvl: bool):
        yield from self.bomb.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_power_bomb(self, asset_manager, is_mlvl: bool):
        yield from self.power_bomb.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_missile(self, asset_manager, is_mlvl: bool):
        yield from self.missile.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_power_beam(self, asset_manager, is_mlvl: bool):
        yield from self.power_beam.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_dark_beam(self, asset_manager, is_mlvl: bool):
        yield from self.dark_beam.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_dark_beam_blob(self, asset_manager, is_mlvl: bool):
        yield from self.dark_beam_blob.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_light_beam(self, asset_manager, is_mlvl: bool):
        yield from self.light_beam.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_annihilator_beam(self, asset_manager, is_mlvl: bool):
        yield from self.annihilator_beam.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_phazon_beam(self, asset_manager, is_mlvl: bool):
        yield from self.phazon_beam.dependencies_for(asset_manager, is_mlvl)
