...
class ScanInfoSecondaryModel(BaseProperty):
    ...
    def _dependencies_for_secondary_static_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.secondary_static_model, is_mlvl)

    def _dependencies_for_secondary_animated_model(self, asset_manager, is_mlvl: bool):
        yield from self.secondary_animated_model.dependencies_for(asset_manager, is_mlvl)
