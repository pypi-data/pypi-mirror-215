...
class PlasmaBeamInfo(BaseProperty):
    ...
    def _dependencies_for_weapon_system(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.weapon_system, is_mlvl)

    def _dependencies_for_contact_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.contact_effect, is_mlvl)

    def _dependencies_for_pulse_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.pulse_effect, is_mlvl)

    def _dependencies_for_beam_texture(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.beam_texture, is_mlvl)

    def _dependencies_for_glow_texture(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.glow_texture, is_mlvl)

    def _dependencies_for_beam_streaks(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.beam_streaks, is_mlvl)
