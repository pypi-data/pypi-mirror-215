...
class SpacePirateWeaponData(BaseProperty):
    ...
    def _dependencies_for_grenade_launcher(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.grenade_launcher, is_mlvl)
    ...
    def _dependencies_for_sound_grenade_bounce(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_grenade_bounce, is_mlvl)

    def _dependencies_for_sound_grenade_explode(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_grenade_explode, is_mlvl)
