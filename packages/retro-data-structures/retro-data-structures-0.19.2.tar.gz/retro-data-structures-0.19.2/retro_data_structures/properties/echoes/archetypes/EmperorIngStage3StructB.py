...
class EmperorIngStage3StructB(BaseProperty):
    ...
    def _dependencies_for_unknown_struct2_0x3826ec75(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct2_0x3826ec75.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct2_0x93bf1106(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct2_0x93bf1106.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct2_0xc4b88b80(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct2_0xc4b88b80.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct2_0x32c6dc77(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct2_0x32c6dc77.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct2_0xc6e7b293(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct2_0xc6e7b293.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct2_0x20746b56(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct2_0x20746b56.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct2_0x2ab44adb(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct2_0x2ab44adb.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct2_0xe2e78a78(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct2_0xe2e78a78.dependencies_for(asset_manager, is_mlvl)
