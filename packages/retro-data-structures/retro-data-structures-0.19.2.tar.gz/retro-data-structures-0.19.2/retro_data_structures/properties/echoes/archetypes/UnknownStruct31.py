...
class UnknownStruct31(BaseProperty):
    ...
    def _dependencies_for_ing_spiderball_guardian_struct_0x152db484(self, asset_manager, is_mlvl: bool):
        yield from self.ing_spiderball_guardian_struct_0x152db484.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ing_spiderball_guardian_struct_0x2d163ff7(self, asset_manager, is_mlvl: bool):
        yield from self.ing_spiderball_guardian_struct_0x2d163ff7.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ing_spiderball_guardian_struct_0x8c2fbb19(self, asset_manager, is_mlvl: bool):
        yield from self.ing_spiderball_guardian_struct_0x8c2fbb19.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ing_spiderball_guardian_struct_0x5d612911(self, asset_manager, is_mlvl: bool):
        yield from self.ing_spiderball_guardian_struct_0x5d612911.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ing_spiderball_guardian_struct_0xfc58adff(self, asset_manager, is_mlvl: bool):
        yield from self.ing_spiderball_guardian_struct_0xfc58adff.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ing_spiderball_guardian_struct_0xc463268c(self, asset_manager, is_mlvl: bool):
        yield from self.ing_spiderball_guardian_struct_0xc463268c.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_proximity_damage(self, asset_manager, is_mlvl: bool):
        yield from self.proximity_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0xaed23abc(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0xaed23abc.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_spiderball_rolling(self, asset_manager, is_mlvl: bool):
        yield from self.sound_spiderball_rolling.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0xcee38f10(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0xcee38f10.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x796fa303(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x796fa303.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_enter_stunned(self, asset_manager, is_mlvl: bool):
        yield from self.sound_enter_stunned.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x44c1f241(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x44c1f241.dependencies_for(asset_manager, is_mlvl)
