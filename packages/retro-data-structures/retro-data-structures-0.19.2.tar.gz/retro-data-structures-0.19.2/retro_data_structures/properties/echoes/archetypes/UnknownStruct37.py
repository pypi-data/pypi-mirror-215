...
class UnknownStruct37(BaseProperty):
    ...
    def _dependencies_for_dark_water_ring_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.dark_water_ring_effect, is_mlvl)

    def _dependencies_for_pre_jump_telegraph_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.pre_jump_telegraph_effect, is_mlvl)
    ...
    def _dependencies_for_tongue_particle_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.tongue_particle_effect, is_mlvl)

    def _dependencies_for_tongue_particle_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.tongue_particle_model, is_mlvl)

    def _dependencies_for_tongue_tip_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.tongue_tip_model, is_mlvl)
    ...
    def _dependencies_for_weak_spot_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.weak_spot_vulnerability.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_unknown_struct36(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct36.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_swamp_boss_stage1_struct_0x4500f774(self, asset_manager, is_mlvl: bool):
        yield from self.swamp_boss_stage1_struct_0x4500f774.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_swamp_boss_stage1_struct_0x3e1e7597(self, asset_manager, is_mlvl: bool):
        yield from self.swamp_boss_stage1_struct_0x3e1e7597.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_swamp_boss_stage1_struct_0xa1c4f609(self, asset_manager, is_mlvl: bool):
        yield from self.swamp_boss_stage1_struct_0xa1c4f609.dependencies_for(asset_manager, is_mlvl)
