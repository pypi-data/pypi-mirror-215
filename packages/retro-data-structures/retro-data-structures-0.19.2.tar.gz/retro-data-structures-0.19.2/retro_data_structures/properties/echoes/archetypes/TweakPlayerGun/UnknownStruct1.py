...
class UnknownStruct1(BaseProperty):
    ...
    def _dependencies_for_super_missile(self, asset_manager, is_mlvl: bool):
        yield from self.super_missile.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_darkburst(self, asset_manager, is_mlvl: bool):
        yield from self.darkburst.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sunburst(self, asset_manager, is_mlvl: bool):
        yield from self.sunburst.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sonic_boom(self, asset_manager, is_mlvl: bool):
        yield from self.sonic_boom.dependencies_for(asset_manager, is_mlvl)
