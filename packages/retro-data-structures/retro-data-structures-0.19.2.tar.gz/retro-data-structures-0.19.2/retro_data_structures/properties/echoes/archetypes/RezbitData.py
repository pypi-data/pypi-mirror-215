...
class RezbitData(BaseProperty):
    ...
    def _dependencies_for_model_no_holos(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.model_no_holos, is_mlvl)

    def _dependencies_for_skin_no_holos(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.skin_no_holos, is_mlvl)

    def _dependencies_for_shield_explode_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.shield_explode_effect, is_mlvl)

    def _dependencies_for_sound_shield_explode(self, asset_manager, is_mlvl: bool):
        yield from self.sound_shield_explode.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_shield_on(self, asset_manager, is_mlvl: bool):
        yield from self.sound_shield_on.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_shield_off(self, asset_manager, is_mlvl: bool):
        yield from self.sound_shield_off.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_flinch(self, asset_manager, is_mlvl: bool):
        yield from self.sound_flinch.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_energy_bolt_damage(self, asset_manager, is_mlvl: bool):
        yield from self.energy_bolt_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_energy_bolt_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.energy_bolt_projectile, is_mlvl)

    def _dependencies_for_sound_energy_bolt(self, asset_manager, is_mlvl: bool):
        yield from self.sound_energy_bolt.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_virus_damage(self, asset_manager, is_mlvl: bool):
        yield from self.virus_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_0xbb3f8a7b(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0xbb3f8a7b, is_mlvl)

    def _dependencies_for_sound_0x601f846d(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x601f846d, is_mlvl)

    def _dependencies_for_cutting_laser_damage(self, asset_manager, is_mlvl: bool):
        yield from self.cutting_laser_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_cutting_laser(self, asset_manager, is_mlvl: bool):
        yield from self.sound_cutting_laser.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_cutting_laser_beam_info(self, asset_manager, is_mlvl: bool):
        yield from self.cutting_laser_beam_info.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_shield_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.shield_vulnerability.dependencies_for(asset_manager, is_mlvl)
