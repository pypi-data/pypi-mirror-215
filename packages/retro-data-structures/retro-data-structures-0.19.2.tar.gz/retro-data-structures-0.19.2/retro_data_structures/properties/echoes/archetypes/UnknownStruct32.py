...
class UnknownStruct32(BaseProperty):
    ...
    def _dependencies_for_ing_space_jump_guardian_struct_0x5e1d1931(self, asset_manager, is_mlvl: bool):
        yield from self.ing_space_jump_guardian_struct_0x5e1d1931.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ing_space_jump_guardian_struct_0x6b08e2e5(self, asset_manager, is_mlvl: bool):
        yield from self.ing_space_jump_guardian_struct_0x6b08e2e5.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ing_space_jump_guardian_struct_0xf223aa76(self, asset_manager, is_mlvl: bool):
        yield from self.ing_space_jump_guardian_struct_0xf223aa76.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ing_space_jump_guardian_struct_0xd0db5f7a(self, asset_manager, is_mlvl: bool):
        yield from self.ing_space_jump_guardian_struct_0xd0db5f7a.dependencies_for(asset_manager, is_mlvl)
