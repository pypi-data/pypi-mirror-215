...
class SplitterMainChassisData(BaseProperty):
    ...
    def _dependencies_for_spin_attack_damage(self, asset_manager, is_mlvl: bool):
        yield from self.spin_attack_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_alerted(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_alerted, is_mlvl)
    ...
    def _dependencies_for_spin_attack_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.spin_attack_vulnerability.dependencies_for(asset_manager, is_mlvl)
