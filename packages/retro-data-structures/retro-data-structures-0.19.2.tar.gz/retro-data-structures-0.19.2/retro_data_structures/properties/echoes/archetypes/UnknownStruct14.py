...
class UnknownStruct14(BaseProperty):
    ...
    def _dependencies_for_sound_cloak(self, asset_manager, is_mlvl: bool):
        yield from self.sound_cloak.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_de_cloak(self, asset_manager, is_mlvl: bool):
        yield from self.sound_de_cloak.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_shadow_decoy_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.shadow_decoy_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_shadow_dash_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.shadow_dash_vulnerability.dependencies_for(asset_manager, is_mlvl)
