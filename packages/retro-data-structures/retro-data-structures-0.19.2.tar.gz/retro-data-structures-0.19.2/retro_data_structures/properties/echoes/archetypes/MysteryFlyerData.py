...
class MysteryFlyerData(BaseProperty):
    ...
    def _dependencies_for_shot_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.shot_projectile, is_mlvl)

    def _dependencies_for_shot_damage(self, asset_manager, is_mlvl: bool):
        yield from self.shot_damage.dependencies_for(asset_manager, is_mlvl)
