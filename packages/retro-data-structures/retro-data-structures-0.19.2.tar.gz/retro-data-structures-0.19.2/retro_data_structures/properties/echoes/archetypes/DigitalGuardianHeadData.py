...
class DigitalGuardianHeadData(BaseProperty):
    ...
    def _dependencies_for_scannable_info_shield_head(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.scannable_info_shield_head, is_mlvl)

    def _dependencies_for_scannable_info_stunned_head(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.scannable_info_stunned_head, is_mlvl)

    def _dependencies_for_scannable_info_final_head(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.scannable_info_final_head, is_mlvl)

    def _dependencies_for_head_armor(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.head_armor, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x0a693a04(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x0a693a04.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_part_0x5ff0b26c(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x5ff0b26c, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x50baee63(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x50baee63.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0xa5e1ec03(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0xa5e1ec03.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x8d6053cb(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x8d6053cb.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_part_0xc91ef399(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0xc91ef399, is_mlvl)

    def _dependencies_for_echo_targets(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.echo_targets, is_mlvl)

    def _dependencies_for_part_0x342ae844(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x342ae844, is_mlvl)

    def _dependencies_for_explode_energy_stuff(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.explode_energy_stuff, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x76eedd2a(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x76eedd2a.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0xa5ecbe17(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0xa5ecbe17.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0xb1fc705f(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0xb1fc705f.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x2bc2677a(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x2bc2677a.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x7f5b82b2(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x7f5b82b2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_echo_parameters(self, asset_manager, is_mlvl: bool):
        yield from self.echo_parameters.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_part_0x321c97a9(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x321c97a9, is_mlvl)

    def _dependencies_for_audio_playback_parms_0xd5cc7e71(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0xd5cc7e71.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0xa62c0ea7(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0xa62c0ea7.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0xfd9f5486(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0xfd9f5486.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_annihilator_pulse(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.annihilator_pulse, is_mlvl)

    def _dependencies_for_annihilator_pulse_damage(self, asset_manager, is_mlvl: bool):
        yield from self.annihilator_pulse_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_annihilator_charge(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.annihilator_charge, is_mlvl)

    def _dependencies_for_annihilator_charge_damage(self, asset_manager, is_mlvl: bool):
        yield from self.annihilator_charge_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_frme(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.frme, is_mlvl)

    def _dependencies_for_plasma_beam_info(self, asset_manager, is_mlvl: bool):
        yield from self.plasma_beam_info.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_lock_on_missiles(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.lock_on_missiles, is_mlvl)

    def _dependencies_for_lock_on_missiles_damage(self, asset_manager, is_mlvl: bool):
        yield from self.lock_on_missiles_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_machine_gun(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.machine_gun, is_mlvl)

    def _dependencies_for_machine_gun_damage(self, asset_manager, is_mlvl: bool):
        yield from self.machine_gun_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_machine_gun(self, asset_manager, is_mlvl: bool):
        yield from self.sound_machine_gun.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_digital_guardian_head_struct_0x8f6732ea(self, asset_manager, is_mlvl: bool):
        yield from self.digital_guardian_head_struct_0x8f6732ea.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_digital_guardian_head_struct_0x8e128141(self, asset_manager, is_mlvl: bool):
        yield from self.digital_guardian_head_struct_0x8e128141.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_digital_guardian_head_struct_0xea54b390(self, asset_manager, is_mlvl: bool):
        yield from self.digital_guardian_head_struct_0xea54b390.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_digital_guardian_head_struct_0xbbd3e7a7(self, asset_manager, is_mlvl: bool):
        yield from self.digital_guardian_head_struct_0xbbd3e7a7.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_digital_guardian_head_struct_0x2dd88764(self, asset_manager, is_mlvl: bool):
        yield from self.digital_guardian_head_struct_0x2dd88764.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_digital_guardian_head_struct_0x48b46e55(self, asset_manager, is_mlvl: bool):
        yield from self.digital_guardian_head_struct_0x48b46e55.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_bomb_pit_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.bomb_pit_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_echo_target_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.echo_target_vulnerability.dependencies_for(asset_manager, is_mlvl)
