...
class UnknownStruct29(BaseProperty):
    ...
    def _dependencies_for_damage_info_0x0e1a78bd(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_0x0e1a78bd.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_damage_info_0x19c3d263(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_0x19c3d263.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_boost_ball_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.boost_ball_model, is_mlvl)

    def _dependencies_for_part_0x15534429(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x15534429, is_mlvl)

    def _dependencies_for_boost_ball_shield_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.boost_ball_shield_effect, is_mlvl)

    def _dependencies_for_spsc(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.spsc, is_mlvl)

    def _dependencies_for_sound_bounce(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_bounce, is_mlvl)

    def _dependencies_for_sound_into_ball(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_into_ball, is_mlvl)

    def _dependencies_for_sound_outof_ball(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_outof_ball, is_mlvl)
    ...
    def _dependencies_for_sound_boost(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_boost, is_mlvl)

    def _dependencies_for_sound_rolling(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_rolling, is_mlvl)

    def _dependencies_for_boost_ball_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.boost_ball_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_damage_info_0x5616d5f1(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_0x5616d5f1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_damage_info_0xed685533(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_0xed685533.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_part_0xd771ec43(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0xd771ec43, is_mlvl)

    def _dependencies_for_part_0x2009a977(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x2009a977, is_mlvl)

    def _dependencies_for_part_0x62ab33a2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x62ab33a2, is_mlvl)

    def _dependencies_for_ing_boost_ball_guardian_struct_0xbab98497(self, asset_manager, is_mlvl: bool):
        yield from self.ing_boost_ball_guardian_struct_0xbab98497.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ing_boost_ball_guardian_struct_0xfe18a18f(self, asset_manager, is_mlvl: bool):
        yield from self.ing_boost_ball_guardian_struct_0xfe18a18f.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ing_boost_ball_guardian_struct_0xc2784287(self, asset_manager, is_mlvl: bool):
        yield from self.ing_boost_ball_guardian_struct_0xc2784287.dependencies_for(asset_manager, is_mlvl)
