...
class SandBossStructA(BaseProperty):
    ...
    def _dependencies_for_armor_piece2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.armor_piece2, is_mlvl)

    def _dependencies_for_armor_piece3(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.armor_piece3, is_mlvl)

    def _dependencies_for_armor_piece4(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.armor_piece4, is_mlvl)

    def _dependencies_for_armor_piece5(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.armor_piece5, is_mlvl)

    def _dependencies_for_armor_piece6(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.armor_piece6, is_mlvl)

    def _dependencies_for_armor_piece7(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.armor_piece7, is_mlvl)

    def _dependencies_for_tail_armor(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.tail_armor, is_mlvl)

    def _dependencies_for_sound_armor_impact(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.sound_armor_impact, is_mlvl)
