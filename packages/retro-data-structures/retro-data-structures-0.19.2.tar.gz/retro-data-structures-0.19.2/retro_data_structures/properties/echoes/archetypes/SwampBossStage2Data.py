...
class SwampBossStage2Data(BaseProperty):
    ...
    def _dependencies_for_upper_left_wing_target(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.upper_left_wing_target, is_mlvl)

    def _dependencies_for_lower_left_wing_target(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.lower_left_wing_target, is_mlvl)

    def _dependencies_for_upper_right_wing_target(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.upper_right_wing_target, is_mlvl)

    def _dependencies_for_lower_right_wing_target(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.lower_right_wing_target, is_mlvl)

    def _dependencies_for_swamp_boss_stage2_struct_0x7fa9256a(self, asset_manager, is_mlvl: bool):
        yield from self.swamp_boss_stage2_struct_0x7fa9256a.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_swamp_boss_stage2_struct_0x8b884b8e(self, asset_manager, is_mlvl: bool):
        yield from self.swamp_boss_stage2_struct_0x8b884b8e.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_swamp_boss_stage2_struct_0x04b7a789(self, asset_manager, is_mlvl: bool):
        yield from self.swamp_boss_stage2_struct_0x04b7a789.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_swamp_boss_stage2_struct_0xf096c96d(self, asset_manager, is_mlvl: bool):
        yield from self.swamp_boss_stage2_struct_0xf096c96d.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spit_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.spit_projectile, is_mlvl)

    def _dependencies_for_spit_damage(self, asset_manager, is_mlvl: bool):
        yield from self.spit_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spit_visor_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.spit_visor_effect, is_mlvl)

    def _dependencies_for_sound_spit_visor(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_spit_visor, is_mlvl)

    def _dependencies_for_swoop_damage(self, asset_manager, is_mlvl: bool):
        yield from self.swoop_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_splash(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.splash, is_mlvl)

    def _dependencies_for_splash_shock_wave(self, asset_manager, is_mlvl: bool):
        yield from self.splash_shock_wave.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_scan_info_light(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.scan_info_light, is_mlvl)

    def _dependencies_for_scan_info_dark(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.scan_info_dark, is_mlvl)

    def _dependencies_for_bubble_telegraph_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.bubble_telegraph_effect, is_mlvl)

    def _dependencies_for_wing_damage_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.wing_damage_effect, is_mlvl)

    def _dependencies_for_unknown_struct38(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct38.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_blow_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.blow_effect, is_mlvl)

    def _dependencies_for_blow_damage(self, asset_manager, is_mlvl: bool):
        yield from self.blow_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_stunned_sound(self, asset_manager, is_mlvl: bool):
        yield from self.stunned_sound.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x427a116a(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x427a116a.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0xc05d5c7a(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0xc05d5c7a.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x2b3c923a(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x2b3c923a.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_flinch_sound(self, asset_manager, is_mlvl: bool):
        yield from self.flinch_sound.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_stunned_flinch_sound(self, asset_manager, is_mlvl: bool):
        yield from self.stunned_flinch_sound.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x878a6522(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x878a6522.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x692fa63c(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x692fa63c.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0xbe3d39aa(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0xbe3d39aa.dependencies_for(asset_manager, is_mlvl)
