...
class ShockWaveInfo(BaseProperty):
    ...
    def _dependencies_for_shock_wave_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.shock_wave_effect, is_mlvl)
