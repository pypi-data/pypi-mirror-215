...
class UnknownStruct40(BaseProperty):
    ...
    def _dependencies_for_part_0x8f06342a(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x8f06342a, is_mlvl)

    def _dependencies_for_sound_0xd8b11129(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0xd8b11129, is_mlvl)

    def _dependencies_for_sound_0xe99e5316(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0xe99e5316, is_mlvl)
    ...
    def _dependencies_for_part_0x686489fd(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x686489fd, is_mlvl)
