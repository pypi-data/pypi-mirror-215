...
class SandBossStructB(BaseProperty):
    ...
    def _dependencies_for_sound_charge_beam(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_charge_beam, is_mlvl)
