...
class UnknownStruct33(BaseProperty):
    ...
    def _dependencies_for_damage(self, asset_manager, is_mlvl: bool):
        yield from self.damage.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_hit_normal_damage(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.hit_normal_damage, is_mlvl)

    def _dependencies_for_hit_heavy_damage(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.hit_heavy_damage, is_mlvl)

    def _dependencies_for_death(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.death, is_mlvl)

    def _dependencies_for_sound_idle(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_idle, is_mlvl)

    def _dependencies_for_sound_move(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_move, is_mlvl)
