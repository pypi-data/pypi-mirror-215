...
class IngBlobSwarm(BaseObjectType):
    ...
    def _dependencies_for_unknown_0x7399abbb(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_0x7399abbb, is_mlvl)
