...
class SafeZone(BaseObjectType):
    ...
    def _dependencies_for_impact_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.impact_effect, is_mlvl)

    def _dependencies_for_normal_safe_zone_struct(self, asset_manager, is_mlvl: bool):
        yield from self.normal_safe_zone_struct.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_energized_safe_zone_struct(self, asset_manager, is_mlvl: bool):
        yield from self.energized_safe_zone_struct.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_supercharged_safe_zone_struct(self, asset_manager, is_mlvl: bool):
        yield from self.supercharged_safe_zone_struct.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_normal_damage(self, asset_manager, is_mlvl: bool):
        yield from self.normal_damage.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_flash_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.flash_sound, is_mlvl)

    def _dependencies_for_safe_zone_struct_a_0x8a09f99a(self, asset_manager, is_mlvl: bool):
        yield from self.safe_zone_struct_a_0x8a09f99a.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_safe_zone_struct_a_0xafb855b8(self, asset_manager, is_mlvl: bool):
        yield from self.safe_zone_struct_a_0xafb855b8.dependencies_for(asset_manager, is_mlvl)
