...
class TweakPlayerGun(BaseObjectType):
    ...
    def _dependencies_for_holstering(self, asset_manager, is_mlvl: bool):
        yield from self.holstering.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_position(self, asset_manager, is_mlvl: bool):
        yield from self.position.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_arm_position(self, asset_manager, is_mlvl: bool):
        yield from self.arm_position.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_weapons(self, asset_manager, is_mlvl: bool):
        yield from self.weapons.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_combos(self, asset_manager, is_mlvl: bool):
        yield from self.combos.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_beam_misc(self, asset_manager, is_mlvl: bool):
        yield from self.beam_misc.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ricochet_damage_factor(self, asset_manager, is_mlvl: bool):
        yield from self.ricochet_damage_factor.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_recoil(self, asset_manager, is_mlvl: bool):
        yield from self.recoil.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_combo_recoil(self, asset_manager, is_mlvl: bool):
        yield from self.combo_recoil.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_projectile_recoil(self, asset_manager, is_mlvl: bool):
        yield from self.projectile_recoil.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_flame_thrower(self, asset_manager, is_mlvl: bool):
        yield from self.flame_thrower.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_wave_buster(self, asset_manager, is_mlvl: bool):
        yield from self.wave_buster.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_projectile_impact(self, asset_manager, is_mlvl: bool):
        yield from self.projectile_impact.dependencies_for(asset_manager, is_mlvl)
