...
class DebrisExtended(BaseObjectType):
    ...
    def _dependencies_for_particle1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.particle1, is_mlvl)
    ...
    def _dependencies_for_particle2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.particle2, is_mlvl)

    def _dependencies_for_death_particle(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.death_particle, is_mlvl)
