...
class SpecialFunction(BaseObjectType):
    ...
    def _dependencies_for_sound1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound1, is_mlvl)

    def _dependencies_for_sound2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound2, is_mlvl)

    def _dependencies_for_sound3(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound3, is_mlvl)
