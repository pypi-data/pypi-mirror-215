...
class SporbNeedle(BaseObjectType):
    ...
    def _dependencies_for_explosion_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.explosion_effect, is_mlvl)

    def _dependencies_for_launch_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.launch_sound, is_mlvl)

    def _dependencies_for_flight_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.flight_sound, is_mlvl)

    def _dependencies_for_hit_player_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.hit_player_sound, is_mlvl)

    def _dependencies_for_collision_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.collision_sound, is_mlvl)

    def _dependencies_for_explosion_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.explosion_sound, is_mlvl)
