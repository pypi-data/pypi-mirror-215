...
class Water(BaseObjectType):
    ...
    def _dependencies_for_trigger(self, asset_manager, is_mlvl: bool):
        yield from self.trigger.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_light_map(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.light_map, is_mlvl)

    def _dependencies_for_color_map(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.color_map, is_mlvl)

    def _dependencies_for_color_warp_map(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.color_warp_map, is_mlvl)

    def _dependencies_for_gloss_map(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.gloss_map, is_mlvl)

    def _dependencies_for_env_map(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.env_map, is_mlvl)

    def _dependencies_for_txtr(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.txtr, is_mlvl)

    def _dependencies_for_foam_map(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.foam_map, is_mlvl)

    def _dependencies_for_alpha_map(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.alpha_map, is_mlvl)

    def _dependencies_for_flow_color(self, asset_manager, is_mlvl: bool):
        yield from self.flow_color.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_layer_info_0xe75248e4(self, asset_manager, is_mlvl: bool):
        yield from self.layer_info_0xe75248e4.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_layer_info_0x385e0d43(self, asset_manager, is_mlvl: bool):
        yield from self.layer_info_0x385e0d43.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_layer_info_0xd369b640(self, asset_manager, is_mlvl: bool):
        yield from self.layer_info_0xd369b640.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_layer_info_0x6ddea66d(self, asset_manager, is_mlvl: bool):
        yield from self.layer_info_0x6ddea66d.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_splash_small(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.splash_small, is_mlvl)

    def _dependencies_for_splash_medium(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.splash_medium, is_mlvl)

    def _dependencies_for_splash_big(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.splash_big, is_mlvl)

    def _dependencies_for_visor_runoff(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.visor_runoff, is_mlvl)

    def _dependencies_for_visor_runoff_ball(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.visor_runoff_ball, is_mlvl)

    def _dependencies_for_sound_sound_runoff(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_sound_runoff, is_mlvl)

    def _dependencies_for_sound_sound_runoff_ball(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_sound_runoff_ball, is_mlvl)

    def _dependencies_for_sound_splash_small(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_splash_small, is_mlvl)

    def _dependencies_for_sound_splash_medium(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_splash_medium, is_mlvl)

    def _dependencies_for_sound_splash_big(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_splash_big, is_mlvl)
