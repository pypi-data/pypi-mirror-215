...
class MetroidAlpha(BaseObjectType):
    ...
    def _dependencies_for_energy_drain_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.energy_drain_vulnerability.dependencies_for(asset_manager, is_mlvl)
