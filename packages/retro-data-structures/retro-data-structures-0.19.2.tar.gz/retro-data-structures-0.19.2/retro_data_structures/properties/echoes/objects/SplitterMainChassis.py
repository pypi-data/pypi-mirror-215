...
class SplitterMainChassis(BaseObjectType):
    ...
    def _dependencies_for_splitter_main_chassis_data(self, asset_manager, is_mlvl: bool):
        yield from self.splitter_main_chassis_data.dependencies_for(asset_manager, is_mlvl)
