...
class ElitePirate(BaseObjectType):
    ...
    def _dependencies_for_shielded_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.shielded_model, is_mlvl)

    def _dependencies_for_shielded_skin_rules(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.shielded_skin_rules, is_mlvl)

    def _dependencies_for_dark_shield(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.dark_shield, is_mlvl)

    def _dependencies_for_dark_shield_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.dark_shield_sound, is_mlvl)

    def _dependencies_for_dark_shield_pop(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.dark_shield_pop, is_mlvl)

    def _dependencies_for_light_shield(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.light_shield, is_mlvl)

    def _dependencies_for_light_shield_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.light_shield_sound, is_mlvl)

    def _dependencies_for_light_shield_pop(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.light_shield_pop, is_mlvl)

    def _dependencies_for_single_shock_wave_info(self, asset_manager, is_mlvl: bool):
        yield from self.single_shock_wave_info.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_double_shock_wave_info(self, asset_manager, is_mlvl: bool):
        yield from self.double_shock_wave_info.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_rocket(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.rocket, is_mlvl)

    def _dependencies_for_rocket_damage(self, asset_manager, is_mlvl: bool):
        yield from self.rocket_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_rocket_launcher_actor_info(self, asset_manager, is_mlvl: bool):
        yield from self.rocket_launcher_actor_info.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_rocket_launcher_anim_info(self, asset_manager, is_mlvl: bool):
        yield from self.rocket_launcher_anim_info.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_0x7e6e0d38(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0x7e6e0d38.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_visor_electric_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.visor_electric_effect, is_mlvl)

    def _dependencies_for_sound_visor_electric(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_visor_electric, is_mlvl)
