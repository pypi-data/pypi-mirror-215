...
class Kralee(BaseObjectType):
    ...
    def _dependencies_for_warp_in_particle_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.warp_in_particle_effect, is_mlvl)

    def _dependencies_for_warp_out_particle_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.warp_out_particle_effect, is_mlvl)

    def _dependencies_for_warp_in_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.warp_in_sound, is_mlvl)

    def _dependencies_for_warp_out_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.warp_out_sound, is_mlvl)
