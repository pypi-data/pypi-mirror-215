...
class RiftPortal(BaseObjectType):
    ...
    def _dependencies_for_background_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.background_model, is_mlvl)

    def _dependencies_for_background_animation(self, asset_manager, is_mlvl: bool):
        yield from self.background_animation.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_incandescent_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.incandescent_model, is_mlvl)

    def _dependencies_for_incandescent_animation(self, asset_manager, is_mlvl: bool):
        yield from self.incandescent_animation.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_line_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.line_model, is_mlvl)

    def _dependencies_for_line_animation(self, asset_manager, is_mlvl: bool):
        yield from self.line_animation.dependencies_for(asset_manager, is_mlvl)
