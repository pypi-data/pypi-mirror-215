...
class SafeZoneCrystal(BaseObjectType):
    ...
    def _dependencies_for_actor_parameters(self, asset_manager, is_mlvl: bool):
        yield from self.actor_parameters.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_scannable_info_collapsed(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.scannable_info_collapsed, is_mlvl)

    def _dependencies_for_scannable_info_entangled(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.scannable_info_entangled, is_mlvl)

    def _dependencies_for_scannable_info_light(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.scannable_info_light, is_mlvl)

    def _dependencies_for_scannable_info_annihilator(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.scannable_info_annihilator, is_mlvl)

    def _dependencies_for_collapsed_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.collapsed_effect, is_mlvl)

    def _dependencies_for_expanded_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.expanded_effect, is_mlvl)

    def _dependencies_for_entangled_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.entangled_effect, is_mlvl)
    ...
    def _dependencies_for_echo_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.echo_effect, is_mlvl)

    def _dependencies_for_normal_crystal(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.normal_crystal, is_mlvl)

    def _dependencies_for_entangled_crystal(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.entangled_crystal, is_mlvl)

    def _dependencies_for_energized_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.energized_model, is_mlvl)

    def _dependencies_for_echo_crystal(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.echo_crystal, is_mlvl)

    def _dependencies_for_power_beam_refresh_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.power_beam_refresh_effect, is_mlvl)
