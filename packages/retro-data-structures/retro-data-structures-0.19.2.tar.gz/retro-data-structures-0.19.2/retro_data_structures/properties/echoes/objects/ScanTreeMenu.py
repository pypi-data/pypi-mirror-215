...
class ScanTreeMenu(BaseObjectType):
    ...
    def _dependencies_for_name_string_table(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.name_string_table, is_mlvl)

    def _dependencies_for_menu_options_string_table(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.menu_options_string_table, is_mlvl)
