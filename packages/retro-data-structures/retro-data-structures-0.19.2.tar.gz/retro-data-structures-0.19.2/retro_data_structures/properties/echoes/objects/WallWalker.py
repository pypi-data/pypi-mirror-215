...
class WallWalker(BaseObjectType):
    ...
    def _dependencies_for_leg_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.leg_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_explode_damage(self, asset_manager, is_mlvl: bool):
        yield from self.explode_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_grenade_explosion(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.grenade_explosion, is_mlvl)

    def _dependencies_for_grenade_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.grenade_effect, is_mlvl)

    def _dependencies_for_grenade_trail(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.grenade_trail, is_mlvl)

    def _dependencies_for_unknown_0x7f1613b7(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_0x7f1613b7, is_mlvl)

    def _dependencies_for_unknown_0x7050d866(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_0x7050d866, is_mlvl)
    ...
    def _dependencies_for_camera_shaker_data(self, asset_manager, is_mlvl: bool):
        yield from self.camera_shaker_data.dependencies_for(asset_manager, is_mlvl)
