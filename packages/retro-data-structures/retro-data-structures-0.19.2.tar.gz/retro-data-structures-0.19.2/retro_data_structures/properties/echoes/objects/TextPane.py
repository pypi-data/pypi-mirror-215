...
class TextPane(BaseObjectType):
    ...
    def _dependencies_for_text_properties(self, asset_manager, is_mlvl: bool):
        yield from self.text_properties.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_japan_text_properties(self, asset_manager, is_mlvl: bool):
        yield from self.japan_text_properties.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_default_string(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.default_string, is_mlvl)
