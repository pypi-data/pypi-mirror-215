...
class Glowbug(BaseObjectType):
    ...
    def _dependencies_for_death_flash_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.death_flash_effect, is_mlvl)
    ...
    def _dependencies_for_attack_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.attack_effect, is_mlvl)

    def _dependencies_for_attack_telegraph_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.attack_telegraph_effect, is_mlvl)

    def _dependencies_for_attack_echo_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.attack_echo_effect, is_mlvl)

    def _dependencies_for_attack_telegraph_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.attack_telegraph_sound, is_mlvl)

    def _dependencies_for_attack_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.attack_sound, is_mlvl)

    def _dependencies_for_scan_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.scan_model, is_mlvl)
