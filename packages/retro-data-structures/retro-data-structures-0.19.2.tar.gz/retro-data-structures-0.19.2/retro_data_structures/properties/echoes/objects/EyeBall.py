...
class EyeBall(BaseObjectType):
    ...
    def _dependencies_for_ray_damage(self, asset_manager, is_mlvl: bool):
        yield from self.ray_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_plasma_burn(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.plasma_burn, is_mlvl)

    def _dependencies_for_plasma_pulse(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.plasma_pulse, is_mlvl)

    def _dependencies_for_plasma_texture(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.plasma_texture, is_mlvl)

    def _dependencies_for_plasma_glow(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.plasma_glow, is_mlvl)

    def _dependencies_for_laser_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.laser_sound, is_mlvl)
