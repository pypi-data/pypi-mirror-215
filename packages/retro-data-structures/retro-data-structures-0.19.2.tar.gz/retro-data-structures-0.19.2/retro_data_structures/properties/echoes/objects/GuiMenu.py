...
class GuiMenu(BaseObjectType):
    ...
    def _dependencies_for_gui_widget_properties(self, asset_manager, is_mlvl: bool):
        yield from self.gui_widget_properties.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_selection_changed_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.selection_changed_sound, is_mlvl)
