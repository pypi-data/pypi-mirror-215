...
class WorldTeleporter(BaseObjectType):
    ...
    def _dependencies_for_platform(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.platform, is_mlvl)

    def _dependencies_for_shaft(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.shaft, is_mlvl)

    def _dependencies_for_sound_group(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.sound_group, is_mlvl)

    def _dependencies_for_elevator(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.elevator, is_mlvl)

    def _dependencies_for_display_font(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.display_font, is_mlvl)
