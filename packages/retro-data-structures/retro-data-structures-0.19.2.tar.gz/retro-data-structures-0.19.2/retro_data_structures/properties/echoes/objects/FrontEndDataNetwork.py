...
class FrontEndDataNetwork(BaseObjectType):
    ...
    def _dependencies_for_hot_dot_texture(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.hot_dot_texture, is_mlvl)

    def _dependencies_for_txtr_0x547fffc3(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.txtr_0x547fffc3, is_mlvl)

    def _dependencies_for_txtr_0xcdaaba00(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.txtr_0xcdaaba00, is_mlvl)

    def _dependencies_for_rotation_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.rotation_sound, is_mlvl)
