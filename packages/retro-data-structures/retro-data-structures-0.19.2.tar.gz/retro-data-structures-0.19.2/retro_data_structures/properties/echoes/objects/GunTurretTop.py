...
class GunTurretTop(BaseObjectType):
    ...
    def _dependencies_for_part_0xbf87e353(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0xbf87e353, is_mlvl)

    def _dependencies_for_part_0xaf6e671a(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0xaf6e671a, is_mlvl)

    def _dependencies_for_sound_0xe4aeeba4(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0xe4aeeba4, is_mlvl)

    def _dependencies_for_sound_0x5d9ed447(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x5d9ed447, is_mlvl)
