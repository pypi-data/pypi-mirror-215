...
class Actor(BaseObjectType):
    ...
    def _dependencies_for_collision_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.collision_model, is_mlvl)
    ...
    def _dependencies_for_echo_information(self, asset_manager, is_mlvl: bool):
        yield from self.echo_information.dependencies_for(asset_manager, is_mlvl)
