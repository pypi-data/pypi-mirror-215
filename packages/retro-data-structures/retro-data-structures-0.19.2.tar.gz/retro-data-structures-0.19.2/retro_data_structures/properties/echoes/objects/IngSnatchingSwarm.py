...
class IngSnatchingSwarm(BaseObjectType):
    ...
    def _dependencies_for_swarm_particle_system(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.swarm_particle_system, is_mlvl)

    def _dependencies_for_part_0x35a88fa1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x35a88fa1, is_mlvl)

    def _dependencies_for_part_0x2d2afc26(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x2d2afc26, is_mlvl)

    def _dependencies_for_impact_damage(self, asset_manager, is_mlvl: bool):
        yield from self.impact_damage.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_swarm_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.swarm_vulnerability.dependencies_for(asset_manager, is_mlvl)
