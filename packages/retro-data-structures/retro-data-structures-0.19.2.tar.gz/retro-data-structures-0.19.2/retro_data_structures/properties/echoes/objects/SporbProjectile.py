...
class SporbProjectile(BaseObjectType):
    ...
    def _dependencies_for_ball_spit_particle_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.ball_spit_particle_effect, is_mlvl)

    def _dependencies_for_ball_escape_particle_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.ball_escape_particle_effect, is_mlvl)
