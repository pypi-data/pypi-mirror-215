...
class DarkTrooper(BaseObjectType):
    ...
    def _dependencies_for_ranged_attack_damage(self, asset_manager, is_mlvl: bool):
        yield from self.ranged_attack_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ranged_attack_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.ranged_attack_projectile, is_mlvl)

    def _dependencies_for_ragdoll_impact_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.ragdoll_impact_sound, is_mlvl)

    def _dependencies_for_missile_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.missile_projectile, is_mlvl)
    ...
    def _dependencies_for_scannable_info_when_attacking(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.scannable_info_when_attacking, is_mlvl)
