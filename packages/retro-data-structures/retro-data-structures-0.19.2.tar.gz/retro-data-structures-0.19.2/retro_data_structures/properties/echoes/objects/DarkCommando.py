...
class DarkCommando(BaseObjectType):
    ...
    def _dependencies_for_dark_commando_properties(self, asset_manager, is_mlvl: bool):
        yield from self.dark_commando_properties.dependencies_for(asset_manager, is_mlvl)
