...
class SnakeWeedSwarm(BaseObjectType):
    ...
    def _dependencies_for_sound_looped(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_looped, is_mlvl)

    def _dependencies_for_sound_into_ground(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_into_ground, is_mlvl)

    def _dependencies_for_sound_outof_ground(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_outof_ground, is_mlvl)
