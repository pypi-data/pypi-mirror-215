...
class SpacePirate(BaseObjectType):
    ...
    def _dependencies_for_blade_damage(self, asset_manager, is_mlvl: bool):
        yield from self.blade_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_kneel_attack_shot(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.kneel_attack_shot, is_mlvl)

    def _dependencies_for_kneel_attack_damage(self, asset_manager, is_mlvl: bool):
        yield from self.kneel_attack_damage.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_weapon_data(self, asset_manager, is_mlvl: bool):
        yield from self.weapon_data.dependencies_for(asset_manager, is_mlvl)
