...
class IngBoostBallGuardian(BaseObjectType):
    ...
    def _dependencies_for_unknown_struct28(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct28.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct29(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct29.dependencies_for(asset_manager, is_mlvl)
