...
class FlyingPirate(BaseObjectType):
    ...
    def _dependencies_for_sound_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_projectile, is_mlvl)

    def _dependencies_for_missile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.missile, is_mlvl)

    def _dependencies_for_missile_damage(self, asset_manager, is_mlvl: bool):
        yield from self.missile_damage.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_part_0x6475fc6f(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x6475fc6f, is_mlvl)

    def _dependencies_for_rocket_pack_explosion_damage(self, asset_manager, is_mlvl: bool):
        yield from self.rocket_pack_explosion_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_impact(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_impact, is_mlvl)

    def _dependencies_for_sound_spiral(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_spiral, is_mlvl)

    def _dependencies_for_part_0x317212ab(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x317212ab, is_mlvl)

    def _dependencies_for_part_0xbc113d7b(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0xbc113d7b, is_mlvl)

    def _dependencies_for_part_0x738bbbaa(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x738bbbaa, is_mlvl)

    def _dependencies_for_sound_hurled(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_hurled, is_mlvl)

    def _dependencies_for_sound_death(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_death, is_mlvl)
