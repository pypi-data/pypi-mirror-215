...
class ControlHint(BaseObjectType):
    ...
    def _dependencies_for_command1(self, asset_manager, is_mlvl: bool):
        yield from self.command1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_command2(self, asset_manager, is_mlvl: bool):
        yield from self.command2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_command3(self, asset_manager, is_mlvl: bool):
        yield from self.command3.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_command4(self, asset_manager, is_mlvl: bool):
        yield from self.command4.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_command5(self, asset_manager, is_mlvl: bool):
        yield from self.command5.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_command6(self, asset_manager, is_mlvl: bool):
        yield from self.command6.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_command7(self, asset_manager, is_mlvl: bool):
        yield from self.command7.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_command8(self, asset_manager, is_mlvl: bool):
        yield from self.command8.dependencies_for(asset_manager, is_mlvl)
