...
class TweakPlayer(BaseObjectType):
    ...
    def _dependencies_for_dark_world(self, asset_manager, is_mlvl: bool):
        yield from self.dark_world.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_grapple_beam(self, asset_manager, is_mlvl: bool):
        yield from self.grapple_beam.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_motion(self, asset_manager, is_mlvl: bool):
        yield from self.motion.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_misc(self, asset_manager, is_mlvl: bool):
        yield from self.misc.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_aim_stuff(self, asset_manager, is_mlvl: bool):
        yield from self.aim_stuff.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_orbit(self, asset_manager, is_mlvl: bool):
        yield from self.orbit.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_scan_visor(self, asset_manager, is_mlvl: bool):
        yield from self.scan_visor.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_grapple(self, asset_manager, is_mlvl: bool):
        yield from self.grapple.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_collision(self, asset_manager, is_mlvl: bool):
        yield from self.collision.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_first_person_camera(self, asset_manager, is_mlvl: bool):
        yield from self.first_person_camera.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_shield(self, asset_manager, is_mlvl: bool):
        yield from self.shield.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_frozen(self, asset_manager, is_mlvl: bool):
        yield from self.frozen.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_suit_damage_reduction(self, asset_manager, is_mlvl: bool):
        yield from self.suit_damage_reduction.dependencies_for(asset_manager, is_mlvl)
