...
class VisorFlare(BaseObjectType):
    ...
    def _dependencies_for_flare1(self, asset_manager, is_mlvl: bool):
        yield from self.flare1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_flare2(self, asset_manager, is_mlvl: bool):
        yield from self.flare2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_flare3(self, asset_manager, is_mlvl: bool):
        yield from self.flare3.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_flare4(self, asset_manager, is_mlvl: bool):
        yield from self.flare4.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_flare5(self, asset_manager, is_mlvl: bool):
        yield from self.flare5.dependencies_for(asset_manager, is_mlvl)
