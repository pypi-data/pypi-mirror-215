...
class Splinter(BaseObjectType):
    ...
    def _dependencies_for_unknown_0x6d752efc(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0x6d752efc.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_0x0d6ab7b5(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0x0d6ab7b5.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_part_0x630d93a1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x630d93a1, is_mlvl)

    def _dependencies_for_damage_info_0x4436a388(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_0x4436a388.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_damage_info_0x02fd0913(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_0x02fd0913.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_part_0x496f191b(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x496f191b, is_mlvl)
