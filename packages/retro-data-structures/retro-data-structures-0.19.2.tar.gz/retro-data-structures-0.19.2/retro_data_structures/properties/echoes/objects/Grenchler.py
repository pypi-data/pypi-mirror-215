...
class Grenchler(BaseObjectType):
    ...
    def _dependencies_for_damage_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.damage_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_tail(self, asset_manager, is_mlvl: bool):
        yield from self.tail.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_0x0abef809(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0x0abef809.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_tailless_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.tailless_model, is_mlvl)

    def _dependencies_for_tailless_skin_rules(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.tailless_skin_rules, is_mlvl)

    def _dependencies_for_unknown_0x9b193ae8(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0x9b193ae8.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_0xc24cf580(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0xc24cf580.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_cmdl(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.cmdl, is_mlvl)

    def _dependencies_for_cskr(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.cskr, is_mlvl)

    def _dependencies_for_tail_hit_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.tail_hit_sound, is_mlvl)

    def _dependencies_for_tail_destroyed_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.tail_destroyed_sound, is_mlvl)

    def _dependencies_for_bite_damage(self, asset_manager, is_mlvl: bool):
        yield from self.bite_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_electric_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.electric_effect, is_mlvl)

    def _dependencies_for_beam_damage(self, asset_manager, is_mlvl: bool):
        yield from self.beam_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0xad47febe(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0xad47febe.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_burst_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.burst_projectile, is_mlvl)

    def _dependencies_for_burst_damage(self, asset_manager, is_mlvl: bool):
        yield from self.burst_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_surface_rings_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.surface_rings_effect, is_mlvl)

    def _dependencies_for_part_0xbf4daae6(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0xbf4daae6, is_mlvl)

    def _dependencies_for_part_always_ff(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_always_ff, is_mlvl)

    def _dependencies_for_part_0xffcee1a9(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0xffcee1a9, is_mlvl)

    def _dependencies_for_grapple_swoosh(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.grapple_swoosh, is_mlvl)

    def _dependencies_for_grapple_beam_part(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.grapple_beam_part, is_mlvl)

    def _dependencies_for_grapple_hit_fx(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.grapple_hit_fx, is_mlvl)

    def _dependencies_for_grapple_damage(self, asset_manager, is_mlvl: bool):
        yield from self.grapple_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0xb6b9074b(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0xb6b9074b.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_beam_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.beam_effect, is_mlvl)

    def _dependencies_for_grapple_visor_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.grapple_visor_effect, is_mlvl)

    def _dependencies_for_damage_info(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_part_0x54b6bfa1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x54b6bfa1, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x5cf705f2(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x5cf705f2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_part_0xb9f9f4f2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0xb9f9f4f2, is_mlvl)
    ...
    def _dependencies_for_ing_possession_data(self, asset_manager, is_mlvl: bool):
        yield from self.ing_possession_data.dependencies_for(asset_manager, is_mlvl)
