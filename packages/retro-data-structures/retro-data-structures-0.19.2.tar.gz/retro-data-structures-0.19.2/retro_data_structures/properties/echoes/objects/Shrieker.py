...
class Shrieker(BaseObjectType):
    ...
    def _dependencies_for_buried_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.buried_vulnerability.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_melee_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.melee_effect, is_mlvl)

    def _dependencies_for_sound_missile_deflection(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_missile_deflection, is_mlvl)
