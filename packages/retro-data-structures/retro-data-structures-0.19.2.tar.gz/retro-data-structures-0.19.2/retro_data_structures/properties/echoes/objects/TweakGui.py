...
class TweakGui(BaseObjectType):
    ...
    def _dependencies_for_scannable_object_download_times(self, asset_manager, is_mlvl: bool):
        yield from self.scannable_object_download_times.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown(self, asset_manager, is_mlvl: bool):
        yield from self.unknown.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_echo_visor(self, asset_manager, is_mlvl: bool):
        yield from self.echo_visor.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_log_book(self, asset_manager, is_mlvl: bool):
        yield from self.log_book.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_credits(self, asset_manager, is_mlvl: bool):
        yield from self.credits.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_completion(self, asset_manager, is_mlvl: bool):
        yield from self.completion.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_movie_volumes(self, asset_manager, is_mlvl: bool):
        yield from self.movie_volumes.dependencies_for(asset_manager, is_mlvl)
