...
class Krocuss(BaseObjectType):
    ...
    def _dependencies_for_shell_closed_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.shell_closed_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_dpsc(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.dpsc, is_mlvl)

    def _dependencies_for_shell_open_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.shell_open_sound, is_mlvl)

    def _dependencies_for_shell_close_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.shell_close_sound, is_mlvl)
