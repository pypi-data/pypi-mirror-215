...
class ConditionalRelay(BaseObjectType):
    ...
    def _dependencies_for_conditional1(self, asset_manager, is_mlvl: bool):
        yield from self.conditional1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_conditional2(self, asset_manager, is_mlvl: bool):
        yield from self.conditional2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_conditional3(self, asset_manager, is_mlvl: bool):
        yield from self.conditional3.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_conditional4(self, asset_manager, is_mlvl: bool):
        yield from self.conditional4.dependencies_for(asset_manager, is_mlvl)
