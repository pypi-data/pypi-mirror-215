...
class SwampBossStage2(BaseObjectType):
    ...
    def _dependencies_for_swamp_boss_stage2_data(self, asset_manager, is_mlvl: bool):
        yield from self.swamp_boss_stage2_data.dependencies_for(asset_manager, is_mlvl)
