...
class TweakAutoMapper(BaseObjectType):
    ...
    def _dependencies_for_base(self, asset_manager, is_mlvl: bool):
        yield from self.base.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_door_colors(self, asset_manager, is_mlvl: bool):
        yield from self.door_colors.dependencies_for(asset_manager, is_mlvl)
