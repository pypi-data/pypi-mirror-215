...
class Door(BaseObjectType):
    ...
    def _dependencies_for_shell_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.shell_model, is_mlvl)

    def _dependencies_for_blue_shell_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.blue_shell_model, is_mlvl)

    def _dependencies_for_burn_texture(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.burn_texture, is_mlvl)
    ...
    def _dependencies_for_alt_scannable(self, asset_manager, is_mlvl: bool):
        yield from self.alt_scannable.dependencies_for(asset_manager, is_mlvl)
