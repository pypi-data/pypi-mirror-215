...
class PlantScarabSwarm(BaseObjectType):
    ...
    def _dependencies_for_basic_swarm_properties(self, asset_manager, is_mlvl: bool):
        yield from self.basic_swarm_properties.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_grenade_damage(self, asset_manager, is_mlvl: bool):
        yield from self.grenade_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_grenade_explosion_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.grenade_explosion_effect, is_mlvl)
    ...
    def _dependencies_for_grenade_trail_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.grenade_trail_effect, is_mlvl)
    ...
    def _dependencies_for_grenade_bounce_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.grenade_bounce_sound, is_mlvl)

    def _dependencies_for_grenade_explosion_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.grenade_explosion_sound, is_mlvl)
