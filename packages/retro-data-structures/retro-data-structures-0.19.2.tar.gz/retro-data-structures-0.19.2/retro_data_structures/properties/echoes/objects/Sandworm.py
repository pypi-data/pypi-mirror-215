...
class Sandworm(BaseObjectType):
    ...
    def _dependencies_for_walk_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.walk_sound, is_mlvl)

    def _dependencies_for_walk_vocal_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.walk_vocal_sound, is_mlvl)

    def _dependencies_for_melee_attack_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.melee_attack_sound, is_mlvl)

    def _dependencies_for_eye_killed_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.eye_killed_sound, is_mlvl)

    def _dependencies_for_pincer_l(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.pincer_l, is_mlvl)

    def _dependencies_for_pincer_r(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.pincer_r, is_mlvl)

    def _dependencies_for_spit_attack_visor_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.spit_attack_visor_effect, is_mlvl)

    def _dependencies_for_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.projectile, is_mlvl)

    def _dependencies_for_projectile_damage(self, asset_manager, is_mlvl: bool):
        yield from self.projectile_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_morphball_toss_damage(self, asset_manager, is_mlvl: bool):
        yield from self.morphball_toss_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_pincer_swipe_damage(self, asset_manager, is_mlvl: bool):
        yield from self.pincer_swipe_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_eye_glow(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.eye_glow, is_mlvl)

    def _dependencies_for_part_0x3221407e(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x3221407e, is_mlvl)

    def _dependencies_for_part_0x8b2a15ee(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x8b2a15ee, is_mlvl)

    def _dependencies_for_part_0x526c6956(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x526c6956, is_mlvl)

    def _dependencies_for_part_0xd24a1751(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0xd24a1751, is_mlvl)

    def _dependencies_for_ing_boss_bomb_damage(self, asset_manager, is_mlvl: bool):
        yield from self.ing_boss_bomb_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_bomb_bounce_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.bomb_bounce_sound, is_mlvl)

    def _dependencies_for_bomb_explode_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.bomb_explode_sound, is_mlvl)

    def _dependencies_for_sandworm_struct_0xb8c15f15(self, asset_manager, is_mlvl: bool):
        yield from self.sandworm_struct_0xb8c15f15.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sandworm_struct_0xce246628(self, asset_manager, is_mlvl: bool):
        yield from self.sandworm_struct_0xce246628.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sandworm_struct_0x55578cfc(self, asset_manager, is_mlvl: bool):
        yield from self.sandworm_struct_0x55578cfc.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sandworm_struct_0x23ee1452(self, asset_manager, is_mlvl: bool):
        yield from self.sandworm_struct_0x23ee1452.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sandworm_struct_0xb89dfe86(self, asset_manager, is_mlvl: bool):
        yield from self.sandworm_struct_0xb89dfe86.dependencies_for(asset_manager, is_mlvl)
