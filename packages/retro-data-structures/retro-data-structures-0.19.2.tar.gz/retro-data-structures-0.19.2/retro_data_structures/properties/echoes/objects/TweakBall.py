...
class TweakBall(BaseObjectType):
    ...
    def _dependencies_for_movement(self, asset_manager, is_mlvl: bool):
        yield from self.movement.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_camera(self, asset_manager, is_mlvl: bool):
        yield from self.camera.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_misc(self, asset_manager, is_mlvl: bool):
        yield from self.misc.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_boost_ball(self, asset_manager, is_mlvl: bool):
        yield from self.boost_ball.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_cannon_ball(self, asset_manager, is_mlvl: bool):
        yield from self.cannon_ball.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_screw_attack(self, asset_manager, is_mlvl: bool):
        yield from self.screw_attack.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_death_ball(self, asset_manager, is_mlvl: bool):
        yield from self.death_ball.dependencies_for(asset_manager, is_mlvl)
