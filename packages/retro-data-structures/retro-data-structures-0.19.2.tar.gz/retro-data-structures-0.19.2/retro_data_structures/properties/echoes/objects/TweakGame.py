...
class TweakGame(BaseObjectType):
    ...
    def _dependencies_for_unknown_0x1d627808(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0x1d627808.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_0xb2e8828d(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0xb2e8828d.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_0x06af87bd(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0x06af87bd.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_0x1533ea4e(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0x1533ea4e.dependencies_for(asset_manager, is_mlvl)
