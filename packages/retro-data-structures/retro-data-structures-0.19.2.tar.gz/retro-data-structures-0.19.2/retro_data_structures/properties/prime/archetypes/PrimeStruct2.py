...
class PrimeStruct2(BaseProperty):
    ...
    def _dependencies_for_prime_struct3_1(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct3_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct3_2(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct3_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct3_3(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct3_3.dependencies_for(asset_manager, is_mlvl)
