...
class FluidUVMotion(BaseProperty):
    ...
    def _dependencies_for_fluid_layer_motion_1(self, asset_manager, is_mlvl: bool):
        yield from self.fluid_layer_motion_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_fluid_layer_motion_2(self, asset_manager, is_mlvl: bool):
        yield from self.fluid_layer_motion_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_fluid_layer_motion_3(self, asset_manager, is_mlvl: bool):
        yield from self.fluid_layer_motion_3.dependencies_for(asset_manager, is_mlvl)
