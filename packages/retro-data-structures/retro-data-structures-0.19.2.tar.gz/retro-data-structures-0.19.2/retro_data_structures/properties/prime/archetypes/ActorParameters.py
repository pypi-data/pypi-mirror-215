...
class ActorParameters(BaseProperty):
    ...
    def _dependencies_for_unnamed_0x00000000(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000000.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_x_ray_visor_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.x_ray_visor_model, is_mlvl)

    def _dependencies_for_x_ray_visor_skin(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.x_ray_visor_skin, is_mlvl)

    def _dependencies_for_thermal_visor_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.thermal_visor_model, is_mlvl)

    def _dependencies_for_thermal_visor_skin(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.thermal_visor_skin, is_mlvl)
