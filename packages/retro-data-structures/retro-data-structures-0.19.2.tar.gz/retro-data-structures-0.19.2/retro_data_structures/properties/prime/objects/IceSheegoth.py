...
class IceSheegoth(BaseObjectType):
    ...
    def _dependencies_for_damage_vulnerability_3(self, asset_manager, is_mlvl: bool):
        yield from self.damage_vulnerability_3.dependencies_for(asset_manager, is_mlvl)
