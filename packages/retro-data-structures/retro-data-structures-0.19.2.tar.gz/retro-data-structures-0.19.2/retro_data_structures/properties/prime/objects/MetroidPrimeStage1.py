...
class MetroidPrimeStage1(BaseObjectType):
    ...
    def _dependencies_for_health_info_1(self, asset_manager, is_mlvl: bool):
        yield from self.health_info_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_health_info_2(self, asset_manager, is_mlvl: bool):
        yield from self.health_info_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct1_1(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct1_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct1_2(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct1_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct1_3(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct1_3.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct1_4(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct1_4.dependencies_for(asset_manager, is_mlvl)
