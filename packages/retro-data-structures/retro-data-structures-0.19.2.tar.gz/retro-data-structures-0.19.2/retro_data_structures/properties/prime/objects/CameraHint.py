...
class CameraHint(BaseObjectType):
    ...
    def _dependencies_for_unnamed_0x0000000b(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x0000000b.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unnamed_0x0000000d(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x0000000d.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unnamed_0x0000000e(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x0000000e.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unnamed_0x0000000f(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x0000000f.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unnamed_0x00000010(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000010.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unnamed_0x00000013(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000013.dependencies_for(asset_manager, is_mlvl)
