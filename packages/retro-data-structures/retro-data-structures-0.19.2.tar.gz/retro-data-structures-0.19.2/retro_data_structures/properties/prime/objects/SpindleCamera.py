...
class SpindleCamera(BaseObjectType):
    ...
    def _dependencies_for_spindle_camera_struct_1(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_2(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_3(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_3.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_4(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_4.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_5(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_5.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_6(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_6.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_7(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_7.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_8(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_8.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_9(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_9.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_10(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_10.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_11(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_11.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_12(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_12.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_13(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_13.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_14(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_14.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_15(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_15.dependencies_for(asset_manager, is_mlvl)
