...
class PlayerActor(BaseObjectType):
    ...
    def _dependencies_for_unnamed_0x0000000c(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x0000000c.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unnamed_0x00000011(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000011.dependencies_for(asset_manager, is_mlvl)
