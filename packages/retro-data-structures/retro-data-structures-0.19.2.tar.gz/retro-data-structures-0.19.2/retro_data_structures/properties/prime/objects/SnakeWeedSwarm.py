...
class SnakeWeedSwarm(BaseObjectType):
    ...
    def _dependencies_for_unnamed_0x00000014(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000014.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_unknown_18(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_18, is_mlvl)
