...
class Steam(BaseObjectType):
    ...
    def _dependencies_for_guess_struct_1(self, asset_manager, is_mlvl: bool):
        yield from self.guess_struct_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_guess_struct_2(self, asset_manager, is_mlvl: bool):
        yield from self.guess_struct_2.dependencies_for(asset_manager, is_mlvl)
