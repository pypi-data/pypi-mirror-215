...
class WallCrawlerSwarm(BaseObjectType):
    ...
    def _dependencies_for_unnamed_0x00000023(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000023.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unnamed_0x00000024(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000024.dependencies_for(asset_manager, is_mlvl)
