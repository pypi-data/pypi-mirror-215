...
class NewCameraShaker(BaseObjectType):
    ...
    def _dependencies_for_new_camera_shaker_struct_1(self, asset_manager, is_mlvl: bool):
        yield from self.new_camera_shaker_struct_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_new_camera_shaker_struct_2(self, asset_manager, is_mlvl: bool):
        yield from self.new_camera_shaker_struct_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_new_camera_shaker_struct_3(self, asset_manager, is_mlvl: bool):
        yield from self.new_camera_shaker_struct_3.dependencies_for(asset_manager, is_mlvl)
