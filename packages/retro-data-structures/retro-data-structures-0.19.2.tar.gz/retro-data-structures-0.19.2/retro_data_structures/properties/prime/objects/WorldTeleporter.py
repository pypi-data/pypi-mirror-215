...
class WorldTeleporter(BaseObjectType):
    ...
    def _dependencies_for_player_model(self, asset_manager, is_mlvl: bool):
        yield from self.player_model.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_elevator_platform_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.elevator_platform_model, is_mlvl)

    def _dependencies_for_elevator_background_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.elevator_background_model, is_mlvl)

    def _dependencies_for_elevator_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.elevator_sound, is_mlvl)

    def _dependencies_for_font(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.font, is_mlvl)
