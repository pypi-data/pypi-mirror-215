...
class DistanceFog(BaseObjectType):
    ...
    def _dependencies_for_range(self, asset_manager, is_mlvl: bool):
        yield from self.range.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_range_delta(self, asset_manager, is_mlvl: bool):
        yield from self.range_delta.dependencies_for(asset_manager, is_mlvl)
