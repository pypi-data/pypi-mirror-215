...
class FlyingPirate(BaseObjectType):
    ...
    def _dependencies_for_unknown_16(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_16, is_mlvl)

    def _dependencies_for_unknown_17(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_17, is_mlvl)
