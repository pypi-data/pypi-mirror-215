...
class SafeZoneStructB(BaseProperty):
    ...
    def _dependencies_for_turn_on_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.turn_on_sound, is_mlvl)

    def _dependencies_for_active_loop_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.active_loop_sound, is_mlvl)

    def _dependencies_for_turn_off_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.turn_off_sound, is_mlvl)

    def _dependencies_for_player_enter_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.player_enter_sound, is_mlvl)

    def _dependencies_for_player_exit_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.player_exit_sound, is_mlvl)

    def _dependencies_for_dark_visor_spot_texture(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.dark_visor_spot_texture, is_mlvl)

    def _dependencies_for_shell_environment_map(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.shell_environment_map, is_mlvl)

    def _dependencies_for_shell1_texture(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.shell1_texture, is_mlvl)

    def _dependencies_for_shell2_texture(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.shell2_texture, is_mlvl)
