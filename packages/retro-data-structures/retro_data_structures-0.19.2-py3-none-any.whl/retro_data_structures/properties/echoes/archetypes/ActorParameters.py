...
class ActorParameters(BaseProperty):
    ...
    def _dependencies_for_lighting(self, asset_manager, is_mlvl: bool):
        yield from self.lighting.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_scannable(self, asset_manager, is_mlvl: bool):
        yield from self.scannable.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_dark_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.dark_model, is_mlvl)

    def _dependencies_for_dark_skin(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.dark_skin, is_mlvl)

    def _dependencies_for_echo_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.echo_model, is_mlvl)

    def _dependencies_for_echo_skin(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.echo_skin, is_mlvl)

    def _dependencies_for_visor(self, asset_manager, is_mlvl: bool):
        yield from self.visor.dependencies_for(asset_manager, is_mlvl)
