...
class SandBossData(BaseProperty):
    ...
    def _dependencies_for_scannable_info1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.scannable_info1, is_mlvl)

    def _dependencies_for_cracked_sphere1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.cracked_sphere1, is_mlvl)

    def _dependencies_for_cracked_sphere2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.cracked_sphere2, is_mlvl)

    def _dependencies_for_cracked_sphere3(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.cracked_sphere3, is_mlvl)

    def _dependencies_for_snap_jaw_damage(self, asset_manager, is_mlvl: bool):
        yield from self.snap_jaw_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spit_out_damage(self, asset_manager, is_mlvl: bool):
        yield from self.spit_out_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_dark_beam_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.dark_beam_projectile, is_mlvl)

    def _dependencies_for_dark_beam_damage(self, asset_manager, is_mlvl: bool):
        yield from self.dark_beam_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_part(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part, is_mlvl)

    def _dependencies_for_unknown_struct40(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct40.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct41(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct41.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sand_boss_struct_a_0x8b452a19(self, asset_manager, is_mlvl: bool):
        yield from self.sand_boss_struct_a_0x8b452a19.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sand_boss_struct_a_0x0cf8c54c(self, asset_manager, is_mlvl: bool):
        yield from self.sand_boss_struct_a_0x0cf8c54c.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_model_with_tail_armor(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.model_with_tail_armor, is_mlvl)

    def _dependencies_for_skin_for_armored_tail(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.skin_for_armored_tail, is_mlvl)
    ...
    def _dependencies_for_stampede_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.stampede_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_suck_air_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.suck_air_vulnerability.dependencies_for(asset_manager, is_mlvl)
