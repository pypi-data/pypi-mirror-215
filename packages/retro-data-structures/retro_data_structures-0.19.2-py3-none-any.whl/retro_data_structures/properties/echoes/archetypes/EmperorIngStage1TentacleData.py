...
class EmperorIngStage1TentacleData(BaseProperty):
    ...
    def _dependencies_for_normal_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.normal_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_warp_attack_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.warp_attack_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_melee_attack_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.melee_attack_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_projectile_attack_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.projectile_attack_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_tentacle_damaged_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.tentacle_damaged_sound, is_mlvl)
