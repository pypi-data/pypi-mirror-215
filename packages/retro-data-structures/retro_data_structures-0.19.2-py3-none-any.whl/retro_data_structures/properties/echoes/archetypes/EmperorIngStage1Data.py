...
class EmperorIngStage1Data(BaseProperty):
    ...
    def _dependencies_for_tentacle(self, asset_manager, is_mlvl: bool):
        yield from self.tentacle.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct20(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct20.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct21(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct21.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct22(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct22.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct23(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct23.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct24(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct24.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_heart_damage_sound(self, asset_manager, is_mlvl: bool):
        yield from self.heart_damage_sound.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_vulnerability_change_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.vulnerability_change_sound, is_mlvl)
