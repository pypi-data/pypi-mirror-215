...
class UnknownStruct13(BaseProperty):
    ...
    def _dependencies_for_mold_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.mold_effect, is_mlvl)

    def _dependencies_for_mold_damage(self, asset_manager, is_mlvl: bool):
        yield from self.mold_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_mold(self, asset_manager, is_mlvl: bool):
        yield from self.sound_mold.dependencies_for(asset_manager, is_mlvl)
