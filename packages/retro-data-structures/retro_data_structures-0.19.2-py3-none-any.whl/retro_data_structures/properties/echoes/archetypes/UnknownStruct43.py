...
class UnknownStruct43(BaseProperty):
    ...
    def _dependencies_for_laser_pulse_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.laser_pulse_projectile, is_mlvl)

    def _dependencies_for_laser_pulse_damage(self, asset_manager, is_mlvl: bool):
        yield from self.laser_pulse_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_laser_sweep_damage(self, asset_manager, is_mlvl: bool):
        yield from self.laser_sweep_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_laser_sweep_beam_info(self, asset_manager, is_mlvl: bool):
        yield from self.laser_sweep_beam_info.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct42(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct42.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_laser_sweep(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_laser_sweep, is_mlvl)

    def _dependencies_for_sound_laser_charge_up(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_laser_charge_up, is_mlvl)

    def _dependencies_for_sound_docking(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_docking, is_mlvl)

    def _dependencies_for_sound_scanning(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_scanning, is_mlvl)

    def _dependencies_for_sound_shield_on(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_shield_on, is_mlvl)
    ...
    def _dependencies_for_light_shield_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.light_shield_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_dark_shield_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.dark_shield_vulnerability.dependencies_for(asset_manager, is_mlvl)
