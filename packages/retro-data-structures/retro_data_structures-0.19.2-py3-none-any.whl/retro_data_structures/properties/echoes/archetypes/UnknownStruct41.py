...
class UnknownStruct41(BaseProperty):
    ...
    def _dependencies_for_sand_boss_struct_b_0xb9784f0e(self, asset_manager, is_mlvl: bool):
        yield from self.sand_boss_struct_b_0xb9784f0e.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sand_boss_struct_b_0xb8ae1bdc(self, asset_manager, is_mlvl: bool):
        yield from self.sand_boss_struct_b_0xb8ae1bdc.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_charge_beam_info(self, asset_manager, is_mlvl: bool):
        yield from self.charge_beam_info.dependencies_for(asset_manager, is_mlvl)
