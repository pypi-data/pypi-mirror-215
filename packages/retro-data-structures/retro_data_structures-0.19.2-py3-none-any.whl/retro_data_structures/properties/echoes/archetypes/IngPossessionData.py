...
class IngPossessionData(BaseProperty):
    ...
    def _dependencies_for_ing_possessed_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.ing_possessed_model, is_mlvl)

    def _dependencies_for_ing_possessed_skin_rules(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.ing_possessed_skin_rules, is_mlvl)

    def _dependencies_for_dark_scan_info(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.dark_scan_info, is_mlvl)

    def _dependencies_for_ing_possessed_health(self, asset_manager, is_mlvl: bool):
        yield from self.ing_possessed_health.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ing_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.ing_vulnerability.dependencies_for(asset_manager, is_mlvl)
