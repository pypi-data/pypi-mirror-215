...
class BasicSwarmProperties(BaseProperty):
    ...
    def _dependencies_for_death_particle_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.death_particle_effect, is_mlvl)

    def _dependencies_for_locomotion_looped_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.locomotion_looped_sound, is_mlvl)

    def _dependencies_for_attack_looped_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.attack_looped_sound, is_mlvl)
