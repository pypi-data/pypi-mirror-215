...
class UnknownStruct22(BaseProperty):
    ...
    def _dependencies_for_portal_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.portal_effect, is_mlvl)

    def _dependencies_for_attack_tip(self, asset_manager, is_mlvl: bool):
        yield from self.attack_tip.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_stab_damage(self, asset_manager, is_mlvl: bool):
        yield from self.stab_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_0x1c3e84b6(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x1c3e84b6, is_mlvl)

    def _dependencies_for_sound_0xa93f0198(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0xa93f0198, is_mlvl)
