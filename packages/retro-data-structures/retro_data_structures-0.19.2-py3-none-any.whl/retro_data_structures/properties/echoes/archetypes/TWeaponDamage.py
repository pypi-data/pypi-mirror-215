...
class TWeaponDamage(BaseProperty):
    ...
    def _dependencies_for_normal(self, asset_manager, is_mlvl: bool):
        yield from self.normal.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_charged(self, asset_manager, is_mlvl: bool):
        yield from self.charged.dependencies_for(asset_manager, is_mlvl)
