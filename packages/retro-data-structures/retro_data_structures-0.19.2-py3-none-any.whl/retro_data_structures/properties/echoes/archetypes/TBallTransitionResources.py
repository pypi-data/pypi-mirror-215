...
class TBallTransitionResources(BaseProperty):
    ...
    def _dependencies_for_unknown_0x01e12c84(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0x01e12c84.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_0xf24b055d(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0xf24b055d.dependencies_for(asset_manager, is_mlvl)
