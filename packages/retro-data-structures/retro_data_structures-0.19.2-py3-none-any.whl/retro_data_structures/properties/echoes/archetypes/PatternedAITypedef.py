...
class PatternedAITypedef(BaseProperty):
    ...
    def _dependencies_for_contact_damage(self, asset_manager, is_mlvl: bool):
        yield from self.contact_damage.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_x_damage(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_x_damage, is_mlvl)

    def _dependencies_for_animation_information(self, asset_manager, is_mlvl: bool):
        yield from self.animation_information.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_state_machine2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.state_machine2, is_mlvl)

    def _dependencies_for_gib_particles(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.gib_particles, is_mlvl)

    def _dependencies_for_unknown_0xf35f5164(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.unknown_0xf35f5164, is_mlvl)

    def _dependencies_for_ice_gib_particles(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.ice_gib_particles, is_mlvl)

    def _dependencies_for_sound_0x7344d6cd(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x7344d6cd, is_mlvl)

    def _dependencies_for_sound_0x562cf323(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x562cf323, is_mlvl)

    def _dependencies_for_sound_frozen(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_frozen, is_mlvl)

    def _dependencies_for_knockback_rules(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.knockback_rules, is_mlvl)
