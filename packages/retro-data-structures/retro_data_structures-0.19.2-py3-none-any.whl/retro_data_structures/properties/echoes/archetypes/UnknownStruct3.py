...
class UnknownStruct3(BaseProperty):
    ...
    def _dependencies_for_telegraph_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.telegraph_effect, is_mlvl)
