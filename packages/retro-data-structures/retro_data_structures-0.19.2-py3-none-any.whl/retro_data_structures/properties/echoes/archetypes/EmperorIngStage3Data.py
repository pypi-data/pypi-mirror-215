...
class EmperorIngStage3Data(BaseProperty):
    ...
    def _dependencies_for_yellow_health(self, asset_manager, is_mlvl: bool):
        yield from self.yellow_health.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_health(self, asset_manager, is_mlvl: bool):
        yield from self.health.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_red_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.red_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_light_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.light_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_dark_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.dark_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_melee_damage(self, asset_manager, is_mlvl: bool):
        yield from self.melee_damage.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_jump_slide_damage(self, asset_manager, is_mlvl: bool):
        yield from self.jump_slide_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ground_pound_damage(self, asset_manager, is_mlvl: bool):
        yield from self.ground_pound_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_emperor_ing_stage3_struct_a_0x98e311c1(self, asset_manager, is_mlvl: bool):
        yield from self.emperor_ing_stage3_struct_a_0x98e311c1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_emperor_ing_stage3_struct_a_0x93dae216(self, asset_manager, is_mlvl: bool):
        yield from self.emperor_ing_stage3_struct_a_0x93dae216.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_light_swarm_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.light_swarm_effect, is_mlvl)

    def _dependencies_for_light_swarm_properties(self, asset_manager, is_mlvl: bool):
        yield from self.light_swarm_properties.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_light_swarm_death_sound(self, asset_manager, is_mlvl: bool):
        yield from self.light_swarm_death_sound.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_unknown_struct26(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct26.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_jump_attack_shock_wave_info(self, asset_manager, is_mlvl: bool):
        yield from self.jump_attack_shock_wave_info.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound, is_mlvl)

    def _dependencies_for_emperor_ing_stage3_struct_b_0xe843417f(self, asset_manager, is_mlvl: bool):
        yield from self.emperor_ing_stage3_struct_b_0xe843417f.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_emperor_ing_stage3_struct_b_0xd13bec3f(self, asset_manager, is_mlvl: bool):
        yield from self.emperor_ing_stage3_struct_b_0xd13bec3f.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_emperor_ing_stage3_struct_b_0xc61388ff(self, asset_manager, is_mlvl: bool):
        yield from self.emperor_ing_stage3_struct_b_0xc61388ff.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_emperor_ing_stage3_struct_b_0xa3cab6bf(self, asset_manager, is_mlvl: bool):
        yield from self.emperor_ing_stage3_struct_b_0xa3cab6bf.dependencies_for(asset_manager, is_mlvl)
