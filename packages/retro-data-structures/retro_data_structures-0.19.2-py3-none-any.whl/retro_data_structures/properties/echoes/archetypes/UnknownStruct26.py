...
class UnknownStruct26(BaseProperty):
    ...
    def _dependencies_for_portal_open_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.portal_open_sound, is_mlvl)
    ...
    def _dependencies_for_beam_info(self, asset_manager, is_mlvl: bool):
        yield from self.beam_info.dependencies_for(asset_manager, is_mlvl)
