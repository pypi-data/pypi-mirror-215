...
class Misc(BaseProperty):
    ...
    def _dependencies_for_unknown_0x8aacfc27(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0x8aacfc27.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_0xa054ff1c(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0xa054ff1c.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_imploder_annihilator(self, asset_manager, is_mlvl: bool):
        yield from self.imploder_annihilator.dependencies_for(asset_manager, is_mlvl)
