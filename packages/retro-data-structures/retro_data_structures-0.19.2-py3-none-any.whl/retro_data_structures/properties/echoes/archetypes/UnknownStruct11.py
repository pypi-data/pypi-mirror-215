...
class UnknownStruct11(BaseProperty):
    ...
    def _dependencies_for_shield_charge_damage(self, asset_manager, is_mlvl: bool):
        yield from self.shield_charge_damage.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_sound_shield_explode(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_shield_explode, is_mlvl)

    def _dependencies_for_arm_shield_explode_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.arm_shield_explode_effect, is_mlvl)

    def _dependencies_for_shield_charge_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.shield_charge_effect, is_mlvl)

    def _dependencies_for_arm_shield_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.arm_shield_effect, is_mlvl)

    def _dependencies_for_sound_0xbf3c59b6(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0xbf3c59b6, is_mlvl)

    def _dependencies_for_sound_0x78be3b8d(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x78be3b8d, is_mlvl)
