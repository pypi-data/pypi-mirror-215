...
class UnknownStruct30(BaseProperty):
    ...
    def _dependencies_for_blob_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.blob_effect, is_mlvl)

    def _dependencies_for_part_0xe8a6e174(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0xe8a6e174, is_mlvl)

    def _dependencies_for_part_0x1ab2b090(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x1ab2b090, is_mlvl)

    def _dependencies_for_puddle_death(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.puddle_death, is_mlvl)
