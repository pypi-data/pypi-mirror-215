...
class DigitalGuardianData(BaseProperty):
    ...
    def _dependencies_for_scannable_info_crippled(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.scannable_info_crippled, is_mlvl)

    def _dependencies_for_leg_stab_damage(self, asset_manager, is_mlvl: bool):
        yield from self.leg_stab_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_toe_target_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.toe_target_model, is_mlvl)

    def _dependencies_for_part_0x783635a6(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x783635a6, is_mlvl)

    def _dependencies_for_sound_toe_target(self, asset_manager, is_mlvl: bool):
        yield from self.sound_toe_target.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_toe_target_attack(self, asset_manager, is_mlvl: bool):
        yield from self.sound_toe_target_attack.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_toe_target_explosion(self, asset_manager, is_mlvl: bool):
        yield from self.sound_toe_target_explosion.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_toe_target_hit(self, asset_manager, is_mlvl: bool):
        yield from self.sound_toe_target_hit.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_shock_wave(self, asset_manager, is_mlvl: bool):
        yield from self.sound_shock_wave.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_shock_wave_info(self, asset_manager, is_mlvl: bool):
        yield from self.shock_wave_info.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_vortex_damage(self, asset_manager, is_mlvl: bool):
        yield from self.vortex_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_vortex_flash(self, asset_manager, is_mlvl: bool):
        yield from self.sound_vortex_flash.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_leg_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.leg_model, is_mlvl)

    def _dependencies_for_shin_armor(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.shin_armor, is_mlvl)

    def _dependencies_for_sound_knee_armor_hit(self, asset_manager, is_mlvl: bool):
        yield from self.sound_knee_armor_hit.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_knee_vulnerable(self, asset_manager, is_mlvl: bool):
        yield from self.sound_knee_vulnerable.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_knee_armor(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.knee_armor, is_mlvl)

    def _dependencies_for_echo_parameters_0x7b5b7312(self, asset_manager, is_mlvl: bool):
        yield from self.echo_parameters_0x7b5b7312.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_transmission_beacon(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.transmission_beacon, is_mlvl)

    def _dependencies_for_part_0x3fa7df1c(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x3fa7df1c, is_mlvl)

    def _dependencies_for_echo_parameters_0x021b6f9d(self, asset_manager, is_mlvl: bool):
        yield from self.echo_parameters_0x021b6f9d.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_transmission_beacon(self, asset_manager, is_mlvl: bool):
        yield from self.sound_transmission_beacon.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_sound_beacon_retract(self, asset_manager, is_mlvl: bool):
        yield from self.sound_beacon_retract.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_part_0x71f0c674(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x71f0c674, is_mlvl)

    def _dependencies_for_part_0xc8ec315b(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0xc8ec315b, is_mlvl)

    def _dependencies_for_sound_beacon_explode(self, asset_manager, is_mlvl: bool):
        yield from self.sound_beacon_explode.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_beacon_hit(self, asset_manager, is_mlvl: bool):
        yield from self.sound_beacon_hit.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_knee_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.knee_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_vortex_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.vortex_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_toe_target_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.toe_target_vulnerability.dependencies_for(asset_manager, is_mlvl)
