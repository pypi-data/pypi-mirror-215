...
class UnknownStruct36(BaseProperty):
    ...
    def _dependencies_for_audio_playback_parms_0x4f904909(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x4f904909.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x82e108de(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x82e108de.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0xdf090545(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0xdf090545.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x3dd5b3cf(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x3dd5b3cf.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0xf82231bb(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0xf82231bb.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x009e3658(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x009e3658.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x62bd75b1(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x62bd75b1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x32969cba(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x32969cba.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_audio_playback_parms_0x597d2ac9(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms_0x597d2ac9.dependencies_for(asset_manager, is_mlvl)
