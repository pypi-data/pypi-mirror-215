...
class DarkCommandoData(BaseProperty):
    ...
    def _dependencies_for_sound_impact_rag_doll(self, asset_manager, is_mlvl: bool):
        yield from self.sound_impact_rag_doll.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_hurled_death(self, asset_manager, is_mlvl: bool):
        yield from self.sound_hurled_death.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct12(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct12.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct13(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct13.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct14(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct14.dependencies_for(asset_manager, is_mlvl)
