...
class Metaree(BaseObjectType):
    ...
    def _dependencies_for_radius_damage(self, asset_manager, is_mlvl: bool):
        yield from self.radius_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_turn_sound(self, asset_manager, is_mlvl: bool):
        yield from self.turn_sound.dependencies_for(asset_manager, is_mlvl)
