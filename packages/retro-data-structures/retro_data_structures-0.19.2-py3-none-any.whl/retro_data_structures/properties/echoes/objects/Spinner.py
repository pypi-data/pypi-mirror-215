...
class Spinner(BaseObjectType):
    ...
    def _dependencies_for_loop_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.loop_sound, is_mlvl)

    def _dependencies_for_start_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.start_sound, is_mlvl)

    def _dependencies_for_stop_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.stop_sound, is_mlvl)
