...
class CommandoPirate(BaseObjectType):
    ...
    def _dependencies_for_unknown_struct10(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct10.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct11(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct11.dependencies_for(asset_manager, is_mlvl)
