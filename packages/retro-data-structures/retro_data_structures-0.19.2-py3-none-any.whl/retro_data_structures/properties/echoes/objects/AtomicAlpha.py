...
class AtomicAlpha(BaseObjectType):
    ...
    def _dependencies_for_bomb_weapon(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.bomb_weapon, is_mlvl)

    def _dependencies_for_bomb_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.bomb_model, is_mlvl)

    def _dependencies_for_bomb_damage(self, asset_manager, is_mlvl: bool):
        yield from self.bomb_damage.dependencies_for(asset_manager, is_mlvl)
