...
class Puffer(BaseObjectType):
    ...
    def _dependencies_for_cloud_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.cloud_effect, is_mlvl)

    def _dependencies_for_cloud_damage(self, asset_manager, is_mlvl: bool):
        yield from self.cloud_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_cloud_steam(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.cloud_steam, is_mlvl)
    ...
    def _dependencies_for_sound_turn(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_turn, is_mlvl)
