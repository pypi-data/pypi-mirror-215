...
class ChozoGhost(BaseObjectType):
    ...
    def _dependencies_for_unknown_0x54151870(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.unknown_0x54151870, is_mlvl)

    def _dependencies_for_damage_info_0xffcda1f8(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_0xffcda1f8.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_0x3a58089c(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.unknown_0x3a58089c, is_mlvl)

    def _dependencies_for_damage_info_0x1ff047a9(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_0x1ff047a9.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_behave_chance_0xe832241f(self, asset_manager, is_mlvl: bool):
        yield from self.behave_chance_0xe832241f.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_behave_chance_0x1e2c8483(self, asset_manager, is_mlvl: bool):
        yield from self.behave_chance_0x1e2c8483.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_behave_chance_0x78d76034(self, asset_manager, is_mlvl: bool):
        yield from self.behave_chance_0x78d76034.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_right_disappear_crossfade(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.right_disappear_crossfade, is_mlvl)
    ...
    def _dependencies_for_projectile_visor_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.projectile_visor_effect, is_mlvl)

    def _dependencies_for_sound_projectile_visor(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_projectile_visor, is_mlvl)
