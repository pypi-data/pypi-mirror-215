...
class CameraHint(BaseObjectType):
    ...
    def _dependencies_for_unknown_struct4(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct4.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_camera_hint_struct_a_0x456d05c6(self, asset_manager, is_mlvl: bool):
        yield from self.camera_hint_struct_a_0x456d05c6.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_camera_hint_struct_a_0xf5521ffa(self, asset_manager, is_mlvl: bool):
        yield from self.camera_hint_struct_a_0xf5521ffa.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_camera_hint_struct_a_0x89658a06(self, asset_manager, is_mlvl: bool):
        yield from self.camera_hint_struct_a_0x89658a06.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct5(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct5.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct6(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct6.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_camera_hint_struct_b_0x664c450a(self, asset_manager, is_mlvl: bool):
        yield from self.camera_hint_struct_b_0x664c450a.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_camera_hint_struct_b_0xc82395fa(self, asset_manager, is_mlvl: bool):
        yield from self.camera_hint_struct_b_0xc82395fa.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct7(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct7.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct8(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct8.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_camera_hint_struct_a1(self, asset_manager, is_mlvl: bool):
        yield from self.camera_hint_struct_a1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct9(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct9.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_camera_hint_struct_a_0x138729a7(self, asset_manager, is_mlvl: bool):
        yield from self.camera_hint_struct_a_0x138729a7.dependencies_for(asset_manager, is_mlvl)
