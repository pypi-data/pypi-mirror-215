...
class MysteryFlyer(BaseObjectType):
    ...
    def _dependencies_for_mystery_flyer_properties(self, asset_manager, is_mlvl: bool):
        yield from self.mystery_flyer_properties.dependencies_for(asset_manager, is_mlvl)
