...
class PortalTransition(BaseObjectType):
    ...
    def _dependencies_for_agsc_0xe08e2172(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.agsc_0xe08e2172, is_mlvl)

    def _dependencies_for_agsc_0xb3e6c4e3(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.agsc_0xb3e6c4e3, is_mlvl)

    def _dependencies_for_start_portal(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.start_portal, is_mlvl)

    def _dependencies_for_in_portal1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.in_portal1, is_mlvl)

    def _dependencies_for_in_portal2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.in_portal2, is_mlvl)
