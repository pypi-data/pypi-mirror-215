...
class AreaAttributes(BaseObjectType):
    ...
    def _dependencies_for_environment_group_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.environment_group_sound, is_mlvl)

    def _dependencies_for_override_sky(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.override_sky, is_mlvl)
