...
class DestructibleBarrier(BaseObjectType):
    ...
    def _dependencies_for_left_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.left_model, is_mlvl)

    def _dependencies_for_center_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.center_model, is_mlvl)

    def _dependencies_for_right_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.right_model, is_mlvl)

    def _dependencies_for_unknown_0x396660b4(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.unknown_0x396660b4, is_mlvl)

    def _dependencies_for_unknown_0x48e25884(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.unknown_0x48e25884, is_mlvl)

    def _dependencies_for_base_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.base_model, is_mlvl)

    def _dependencies_for_unknown_0x1eb90d06(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.unknown_0x1eb90d06, is_mlvl)

    def _dependencies_for_unknown_0x982d7fa8(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.unknown_0x982d7fa8, is_mlvl)

    def _dependencies_for_unknown_0x5371ac0d(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.unknown_0x5371ac0d, is_mlvl)

    def _dependencies_for_unknown_0x4e749cb5(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.unknown_0x4e749cb5, is_mlvl)
