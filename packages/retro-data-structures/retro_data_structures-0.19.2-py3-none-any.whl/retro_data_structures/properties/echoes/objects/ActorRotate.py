...
class ActorRotate(BaseObjectType):
    ...
    def _dependencies_for_rotation_controls(self, asset_manager, is_mlvl: bool):
        yield from self.rotation_controls.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_scale_controls(self, asset_manager, is_mlvl: bool):
        yield from self.scale_controls.dependencies_for(asset_manager, is_mlvl)
