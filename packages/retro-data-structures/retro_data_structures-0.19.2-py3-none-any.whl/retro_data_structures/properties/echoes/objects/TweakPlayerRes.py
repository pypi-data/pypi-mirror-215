...
class TweakPlayerRes(BaseObjectType):
    ...
    def _dependencies_for_auto_mapper_icons(self, asset_manager, is_mlvl: bool):
        yield from self.auto_mapper_icons.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_map_screen_icons(self, asset_manager, is_mlvl: bool):
        yield from self.map_screen_icons.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ball_transition_resources(self, asset_manager, is_mlvl: bool):
        yield from self.ball_transition_resources.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_cinematic_resources(self, asset_manager, is_mlvl: bool):
        yield from self.cinematic_resources.dependencies_for(asset_manager, is_mlvl)
