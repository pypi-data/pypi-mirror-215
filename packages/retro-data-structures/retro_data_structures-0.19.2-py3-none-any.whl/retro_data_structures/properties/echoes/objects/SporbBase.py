...
class SporbBase(BaseObjectType):
    ...
    def _dependencies_for_tendril_particle_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.tendril_particle_effect, is_mlvl)
    ...
    def _dependencies_for_power_bomb_projectile_damage(self, asset_manager, is_mlvl: bool):
        yield from self.power_bomb_projectile_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_grabber_fire_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.grabber_fire_sound, is_mlvl)

    def _dependencies_for_grabber_hit_player_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.grabber_hit_player_sound, is_mlvl)

    def _dependencies_for_grabber_hit_world_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.grabber_hit_world_sound, is_mlvl)

    def _dependencies_for_grabber_retract_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.grabber_retract_sound, is_mlvl)

    def _dependencies_for_sound_0x64e9152d(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x64e9152d, is_mlvl)

    def _dependencies_for_morphball_spit_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.morphball_spit_sound, is_mlvl)

    def _dependencies_for_grabber_explosion_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.grabber_explosion_sound, is_mlvl)

    def _dependencies_for_ball_escape_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.ball_escape_sound, is_mlvl)

    def _dependencies_for_needle_telegraph_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.needle_telegraph_sound, is_mlvl)

    def _dependencies_for_grabber_telegraph_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.grabber_telegraph_sound, is_mlvl)

    def _dependencies_for_power_bomb_guardian_stage_properties_0x510dba97(self, asset_manager, is_mlvl: bool):
        yield from self.power_bomb_guardian_stage_properties_0x510dba97.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_power_bomb_guardian_stage_properties_0x0b6c85f7(self, asset_manager, is_mlvl: bool):
        yield from self.power_bomb_guardian_stage_properties_0x0b6c85f7.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_power_bomb_guardian_stage_properties_0x8b9c92e8(self, asset_manager, is_mlvl: bool):
        yield from self.power_bomb_guardian_stage_properties_0x8b9c92e8.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_power_bomb_guardian_stage_properties_0xbfaefb37(self, asset_manager, is_mlvl: bool):
        yield from self.power_bomb_guardian_stage_properties_0xbfaefb37.dependencies_for(asset_manager, is_mlvl)
