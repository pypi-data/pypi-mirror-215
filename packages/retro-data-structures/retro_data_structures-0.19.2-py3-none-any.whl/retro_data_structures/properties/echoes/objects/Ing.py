...
class Ing(BaseObjectType):
    ...
    def _dependencies_for_face_plate_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.face_plate_model, is_mlvl)

    def _dependencies_for_ing_spot_blob_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.ing_spot_blob_effect, is_mlvl)

    def _dependencies_for_ing_spot_hit_normal_damage(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.ing_spot_hit_normal_damage, is_mlvl)

    def _dependencies_for_ing_spot_hit_heavy_damage(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.ing_spot_hit_heavy_damage, is_mlvl)

    def _dependencies_for_ing_spot_death(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.ing_spot_death, is_mlvl)

    def _dependencies_for_sound_ing_spot_idle(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_ing_spot_idle, is_mlvl)

    def _dependencies_for_sound_ing_spot_move(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_ing_spot_move, is_mlvl)

    def _dependencies_for_sound_0xb392943a(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0xb392943a, is_mlvl)

    def _dependencies_for_sound_0x24ecc1e9(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x24ecc1e9, is_mlvl)

    def _dependencies_for_sound_ing_spot_death(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_ing_spot_death, is_mlvl)

    def _dependencies_for_part_0x3c2d681e(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x3c2d681e, is_mlvl)

    def _dependencies_for_srsc(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.srsc, is_mlvl)

    def _dependencies_for_part_0x3da219c7(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x3da219c7, is_mlvl)

    def _dependencies_for_part_0x081e9e6c(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x081e9e6c, is_mlvl)

    def _dependencies_for_sound_swarm_move(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_swarm_move, is_mlvl)

    def _dependencies_for_sound_0x5650366a(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x5650366a, is_mlvl)

    def _dependencies_for_sound_body_projectile_blaster_middle(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_body_projectile_blaster_middle, is_mlvl)

    def _dependencies_for_sound_0x0c13c5a8(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x0c13c5a8, is_mlvl)

    def _dependencies_for_sound_0x148b81e4(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x148b81e4, is_mlvl)

    def _dependencies_for_arm_swipe_damage(self, asset_manager, is_mlvl: bool):
        yield from self.arm_swipe_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_body_projectile_contact_damage(self, asset_manager, is_mlvl: bool):
        yield from self.body_projectile_contact_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_body_projectile_splat_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.body_projectile_splat_effect, is_mlvl)

    def _dependencies_for_sound_body_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_body_projectile, is_mlvl)

    def _dependencies_for_sound_body_projectile_splat_wall(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_body_projectile_splat_wall, is_mlvl)

    def _dependencies_for_mini_portal_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.mini_portal_effect, is_mlvl)

    def _dependencies_for_sound_mini_portal(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_mini_portal, is_mlvl)

    def _dependencies_for_mini_portal_projectile_damage(self, asset_manager, is_mlvl: bool):
        yield from self.mini_portal_projectile_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_mini_portal_beam_info(self, asset_manager, is_mlvl: bool):
        yield from self.mini_portal_beam_info.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_exit_grapple_damage(self, asset_manager, is_mlvl: bool):
        yield from self.exit_grapple_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_grapple(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_grapple, is_mlvl)

    def _dependencies_for_sound_exit_grapple(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_exit_grapple, is_mlvl)

    def _dependencies_for_ing_spot_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.ing_spot_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_grapple_ball_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.grapple_ball_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_trigger_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.trigger_vulnerability.dependencies_for(asset_manager, is_mlvl)
