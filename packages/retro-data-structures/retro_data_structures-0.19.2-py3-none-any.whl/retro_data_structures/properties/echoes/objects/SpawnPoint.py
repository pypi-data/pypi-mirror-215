...
class SpawnPoint(BaseObjectType):
    ...
    def _dependencies_for_amount(self, asset_manager, is_mlvl: bool):
        yield from self.amount.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_capacity(self, asset_manager, is_mlvl: bool):
        yield from self.capacity.dependencies_for(asset_manager, is_mlvl)
