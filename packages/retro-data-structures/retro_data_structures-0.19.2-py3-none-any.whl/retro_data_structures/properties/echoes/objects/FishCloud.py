...
class FishCloud(BaseObjectType):
    ...
    def _dependencies_for_fish_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.fish_model, is_mlvl)
    ...
    def _dependencies_for_death_effect0(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.death_effect0, is_mlvl)

    def _dependencies_for_death_effect1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.death_effect1, is_mlvl)

    def _dependencies_for_death_effect2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.death_effect2, is_mlvl)

    def _dependencies_for_death_effect3(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.death_effect3, is_mlvl)
