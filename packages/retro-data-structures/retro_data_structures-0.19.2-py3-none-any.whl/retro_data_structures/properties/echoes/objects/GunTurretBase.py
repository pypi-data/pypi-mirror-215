...
class GunTurretBase(BaseObjectType):
    ...
    def _dependencies_for_attack_damage(self, asset_manager, is_mlvl: bool):
        yield from self.attack_damage.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_pirate_projectile_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.pirate_projectile_effect, is_mlvl)

    def _dependencies_for_always_ff(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.always_ff, is_mlvl)

    def _dependencies_for_sound_0x23316032(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x23316032, is_mlvl)

    def _dependencies_for_sound_0xa3b39766(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0xa3b39766, is_mlvl)

    def _dependencies_for_lock_on_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.lock_on_sound, is_mlvl)

    def _dependencies_for_gun_pan_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.gun_pan_sound, is_mlvl)

    def _dependencies_for_sound_0xf57880ec(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0xf57880ec, is_mlvl)

    def _dependencies_for_sound_0x99fe97f6(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x99fe97f6, is_mlvl)

    def _dependencies_for_sound_0xa2714856(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0xa2714856, is_mlvl)

    def _dependencies_for_sound_0xd58a2fa7(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0xd58a2fa7, is_mlvl)

    def _dependencies_for_sound_0xb381355a(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0xb381355a, is_mlvl)

    def _dependencies_for_sound_0x00628c84(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x00628c84, is_mlvl)

    def _dependencies_for_sound_0x40533b8d(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x40533b8d, is_mlvl)

    def _dependencies_for_sound_0x613cafd8(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x613cafd8, is_mlvl)

    def _dependencies_for_pole_sparks_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.pole_sparks_sound, is_mlvl)
