...
class DigitalGuardianHead(BaseObjectType):
    ...
    def _dependencies_for_digital_guardian_head_data(self, asset_manager, is_mlvl: bool):
        yield from self.digital_guardian_head_data.dependencies_for(asset_manager, is_mlvl)
