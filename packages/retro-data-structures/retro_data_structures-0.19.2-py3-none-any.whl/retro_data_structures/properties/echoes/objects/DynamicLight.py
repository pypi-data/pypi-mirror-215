...
class DynamicLight(BaseObjectType):
    ...
    def _dependencies_for_intensity(self, asset_manager, is_mlvl: bool):
        yield from self.intensity.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_falloff(self, asset_manager, is_mlvl: bool):
        yield from self.falloff.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spotlight(self, asset_manager, is_mlvl: bool):
        yield from self.spotlight.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_motion_spline(self, asset_manager, is_mlvl: bool):
        yield from self.motion_spline.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_parent(self, asset_manager, is_mlvl: bool):
        yield from self.parent.dependencies_for(asset_manager, is_mlvl)
