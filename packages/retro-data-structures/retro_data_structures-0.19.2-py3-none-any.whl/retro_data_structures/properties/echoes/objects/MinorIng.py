...
class MinorIng(BaseObjectType):
    ...
    def _dependencies_for_unknown_struct33(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct33.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_struct34(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_struct34.dependencies_for(asset_manager, is_mlvl)
