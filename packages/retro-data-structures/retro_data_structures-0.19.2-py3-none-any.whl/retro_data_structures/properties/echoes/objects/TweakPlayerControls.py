...
class TweakPlayerControls(BaseObjectType):
    ...
    def _dependencies_for_unknown_0x3c34dfed(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0x3c34dfed.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_0x168a79f1(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0x168a79f1.dependencies_for(asset_manager, is_mlvl)
