...
class TweakGuiColors(BaseObjectType):
    ...
    def _dependencies_for_hud_colors(self, asset_manager, is_mlvl: bool):
        yield from self.hud_colors.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_misc(self, asset_manager, is_mlvl: bool):
        yield from self.misc.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_multiplayer(self, asset_manager, is_mlvl: bool):
        yield from self.multiplayer.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_combat_hud_color_scheme(self, asset_manager, is_mlvl: bool):
        yield from self.combat_hud_color_scheme.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_echo_hud_color_scheme(self, asset_manager, is_mlvl: bool):
        yield from self.echo_hud_color_scheme.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_scan_hud_color_scheme(self, asset_manager, is_mlvl: bool):
        yield from self.scan_hud_color_scheme.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_dark_hud_color_scheme(self, asset_manager, is_mlvl: bool):
        yield from self.dark_hud_color_scheme.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ball_hud_color_scheme(self, asset_manager, is_mlvl: bool):
        yield from self.ball_hud_color_scheme.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_combat_hud(self, asset_manager, is_mlvl: bool):
        yield from self.combat_hud.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_scan_hud(self, asset_manager, is_mlvl: bool):
        yield from self.scan_hud.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_x_ray_hud(self, asset_manager, is_mlvl: bool):
        yield from self.x_ray_hud.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_thermal_hud(self, asset_manager, is_mlvl: bool):
        yield from self.thermal_hud.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ball_hud(self, asset_manager, is_mlvl: bool):
        yield from self.ball_hud.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_turret_hud(self, asset_manager, is_mlvl: bool):
        yield from self.turret_hud.dependencies_for(asset_manager, is_mlvl)
