...
class SpindleCamera(BaseObjectType):
    ...
    def _dependencies_for_spindle_camera_struct_0xe56495fb(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0xe56495fb.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_0x239debfc(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0x239debfc.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_0x27e8d703(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0x27e8d703.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_0x2f914525(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0x2f914525.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_0x23aa31b7(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0x23aa31b7.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_0xe9e388af(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0xe9e388af.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_0xde5a2c87(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0xde5a2c87.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_0x1b3b2394(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0x1b3b2394.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_0xf5666b6e(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0xf5666b6e.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_0x66c618aa(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0x66c618aa.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_0xb36d0fb6(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0xb36d0fb6.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_0xcbb013cb(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0xcbb013cb.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_0x4abfb789(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0x4abfb789.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_0xfb6a407a(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0xfb6a407a.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_0x3ae66f80(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0x3ae66f80.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spindle_camera_struct_0x6654ae92(self, asset_manager, is_mlvl: bool):
        yield from self.spindle_camera_struct_0x6654ae92.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_target_spline_type(self, asset_manager, is_mlvl: bool):
        yield from self.target_spline_type.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_spline_type(self, asset_manager, is_mlvl: bool):
        yield from self.spline_type.dependencies_for(asset_manager, is_mlvl)
