...
class DistanceFog(BaseObjectType):
    ...
    def _dependencies_for_near_far_plane(self, asset_manager, is_mlvl: bool):
        yield from self.near_far_plane.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_distance_rate(self, asset_manager, is_mlvl: bool):
        yield from self.distance_rate.dependencies_for(asset_manager, is_mlvl)
