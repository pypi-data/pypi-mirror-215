...
class MediumIng(BaseObjectType):
    ...
    def _dependencies_for_mist_damage(self, asset_manager, is_mlvl: bool):
        yield from self.mist_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_misting_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.misting_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_attack_tentacle(self, asset_manager, is_mlvl: bool):
        yield from self.attack_tentacle.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_attack_tentacle_damage(self, asset_manager, is_mlvl: bool):
        yield from self.attack_tentacle_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_ing_spot_blob_fx(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.ing_spot_blob_fx, is_mlvl)

    def _dependencies_for_ing_spot_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.ing_spot_sound, is_mlvl)
