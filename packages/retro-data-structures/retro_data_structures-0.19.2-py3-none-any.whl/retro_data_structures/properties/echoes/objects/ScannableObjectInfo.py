...
class ScannableObjectInfo(BaseObjectType):
    ...
    def _dependencies_for_string(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.string, is_mlvl)

    def _dependencies_for_unknown_0x53336141(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.unknown_0x53336141, is_mlvl)

    def _dependencies_for_static_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.static_model, is_mlvl)

    def _dependencies_for_animated_model(self, asset_manager, is_mlvl: bool):
        yield from self.animated_model.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_0x58f9fe99(self, asset_manager, is_mlvl: bool):
        yield from self.unknown_0x58f9fe99.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_secondary_model0(self, asset_manager, is_mlvl: bool):
        yield from self.secondary_model0.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_secondary_model1(self, asset_manager, is_mlvl: bool):
        yield from self.secondary_model1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_secondary_model2(self, asset_manager, is_mlvl: bool):
        yield from self.secondary_model2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_secondary_model3(self, asset_manager, is_mlvl: bool):
        yield from self.secondary_model3.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_secondary_model4(self, asset_manager, is_mlvl: bool):
        yield from self.secondary_model4.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_secondary_model5(self, asset_manager, is_mlvl: bool):
        yield from self.secondary_model5.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_secondary_model6(self, asset_manager, is_mlvl: bool):
        yield from self.secondary_model6.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_secondary_model7(self, asset_manager, is_mlvl: bool):
        yield from self.secondary_model7.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_secondary_model8(self, asset_manager, is_mlvl: bool):
        yield from self.secondary_model8.dependencies_for(asset_manager, is_mlvl)
