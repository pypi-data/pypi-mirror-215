...
class Blogg(BaseObjectType):
    ...
    def _dependencies_for_projectile_particle_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.projectile_particle_effect, is_mlvl)
    ...
    def _dependencies_for_armor_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.armor_vulnerability.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_ing_possessed_armor_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.ing_possessed_armor_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_blogg_struct_0x3874576d(self, asset_manager, is_mlvl: bool):
        yield from self.blogg_struct_0x3874576d.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_blogg_struct_0x97dd1aa7(self, asset_manager, is_mlvl: bool):
        yield from self.blogg_struct_0x97dd1aa7.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_blogg_struct_0xf2ba21e1(self, asset_manager, is_mlvl: bool):
        yield from self.blogg_struct_0xf2ba21e1.dependencies_for(asset_manager, is_mlvl)
