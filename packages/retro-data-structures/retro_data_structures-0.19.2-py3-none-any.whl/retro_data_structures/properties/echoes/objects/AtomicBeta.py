...
class AtomicBeta(BaseObjectType):
    ...
    def _dependencies_for_beam(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.beam, is_mlvl)
    ...
    def _dependencies_for_contact_fx(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.contact_fx, is_mlvl)

    def _dependencies_for_frozen_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.frozen_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_0x14038b71(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x14038b71, is_mlvl)

    def _dependencies_for_sound_0x16a435cb(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x16a435cb, is_mlvl)

    def _dependencies_for_sound_0x67edefc2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x67edefc2, is_mlvl)
