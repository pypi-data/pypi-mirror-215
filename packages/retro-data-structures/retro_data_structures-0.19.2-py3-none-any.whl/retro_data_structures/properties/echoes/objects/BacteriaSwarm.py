...
class BacteriaSwarm(BaseObjectType):
    ...
    def _dependencies_for_bacteria_particle_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.bacteria_particle_effect, is_mlvl)

    def _dependencies_for_patrol_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.patrol_sound, is_mlvl)

    def _dependencies_for_pursuit_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.pursuit_sound, is_mlvl)

    def _dependencies_for_bacteria_scan_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.bacteria_scan_model, is_mlvl)
