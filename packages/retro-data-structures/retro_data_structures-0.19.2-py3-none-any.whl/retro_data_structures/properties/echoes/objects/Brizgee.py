...
class Brizgee(BaseObjectType):
    ...
    def _dependencies_for_no_shell_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.no_shell_model, is_mlvl)

    def _dependencies_for_no_shell_skin(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.no_shell_skin, is_mlvl)

    def _dependencies_for_shell_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.shell_vulnerability.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_shell_contact_damage(self, asset_manager, is_mlvl: bool):
        yield from self.shell_contact_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_poison_damage(self, asset_manager, is_mlvl: bool):
        yield from self.poison_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_shell_break_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.shell_break_sound, is_mlvl)

    def _dependencies_for_poison_hit_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.poison_hit_sound, is_mlvl)

    def _dependencies_for_player_poison_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.player_poison_sound, is_mlvl)
