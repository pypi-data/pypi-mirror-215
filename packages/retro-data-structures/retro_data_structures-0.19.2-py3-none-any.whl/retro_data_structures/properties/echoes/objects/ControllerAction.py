...
class ControllerAction(BaseObjectType):
    ...
    def _dependencies_for_controller_action_struct(self, asset_manager, is_mlvl: bool):
        yield from self.controller_action_struct.dependencies_for(asset_manager, is_mlvl)
