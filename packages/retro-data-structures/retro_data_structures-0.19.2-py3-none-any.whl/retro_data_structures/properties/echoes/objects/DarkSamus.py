...
class DarkSamus(BaseObjectType):
    ...
    def _dependencies_for_editor_properties(self, asset_manager, is_mlvl: bool):
        yield from self.editor_properties.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_patterned(self, asset_manager, is_mlvl: bool):
        yield from self.patterned.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_actor_information(self, asset_manager, is_mlvl: bool):
        yield from self.actor_information.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_glide_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.glide_sound, is_mlvl)

    def _dependencies_for_missile_ricochet_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.missile_ricochet_sound, is_mlvl)

    def _dependencies_for_txtr_0x3863160b(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.txtr_0x3863160b, is_mlvl)

    def _dependencies_for_melee_attack_damage(self, asset_manager, is_mlvl: bool):
        yield from self.melee_attack_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_part_0x6d40aa56(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x6d40aa56, is_mlvl)

    def _dependencies_for_part_0x9603a544(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x9603a544, is_mlvl)

    def _dependencies_for_dive_attack_damage(self, asset_manager, is_mlvl: bool):
        yield from self.dive_attack_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_dive_attack_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.dive_attack_effect, is_mlvl)

    def _dependencies_for_scatter_shot_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.scatter_shot_projectile, is_mlvl)

    def _dependencies_for_scatter_shot_projectile2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.scatter_shot_projectile2, is_mlvl)

    def _dependencies_for_scatter_shot_damage(self, asset_manager, is_mlvl: bool):
        yield from self.scatter_shot_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_normal_missile_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.normal_missile_projectile, is_mlvl)

    def _dependencies_for_normal_missile_damage(self, asset_manager, is_mlvl: bool):
        yield from self.normal_missile_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_super_missile_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.super_missile_projectile, is_mlvl)

    def _dependencies_for_super_missile_damage(self, asset_manager, is_mlvl: bool):
        yield from self.super_missile_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_freeze_beam_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.freeze_beam_projectile, is_mlvl)

    def _dependencies_for_freeze_beam_damage(self, asset_manager, is_mlvl: bool):
        yield from self.freeze_beam_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_txtr_0x7ffeb33d(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.txtr_0x7ffeb33d, is_mlvl)

    def _dependencies_for_sweep_swoosh(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.sweep_swoosh, is_mlvl)

    def _dependencies_for_sweep_beam_damage(self, asset_manager, is_mlvl: bool):
        yield from self.sweep_beam_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_crsc(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.crsc, is_mlvl)

    def _dependencies_for_invulnerable_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.invulnerable_model, is_mlvl)

    def _dependencies_for_invulnerable_skin_rules(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.invulnerable_skin_rules, is_mlvl)

    def _dependencies_for_boost_ball_model(self, asset_manager, is_mlvl: bool):
        yield from self.boost_ball_model.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_boost_ball_damage(self, asset_manager, is_mlvl: bool):
        yield from self.boost_ball_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_boost_ball_glow(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.boost_ball_glow, is_mlvl)

    def _dependencies_for_swhc_0x449aa4aa(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.swhc_0x449aa4aa, is_mlvl)

    def _dependencies_for_swhc_0x0345fa17(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.swhc_0x0345fa17, is_mlvl)

    def _dependencies_for_sound_0x2c72576b(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0x2c72576b, is_mlvl)

    def _dependencies_for_boost_ball_hit_player_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.boost_ball_hit_player_sound, is_mlvl)

    def _dependencies_for_boost_ball_collision(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.boost_ball_collision, is_mlvl)

    def _dependencies_for_audio_playback_parms(self, asset_manager, is_mlvl: bool):
        yield from self.audio_playback_parms.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_part_0xa6c42023(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0xa6c42023, is_mlvl)

    def _dependencies_for_ice_spread_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.ice_spread_sound, is_mlvl)

    def _dependencies_for_part_0x908b06e9(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x908b06e9, is_mlvl)

    def _dependencies_for_part_0x494de4a4(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0x494de4a4, is_mlvl)

    def _dependencies_for_sound_0xa861649f(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_0xa861649f, is_mlvl)

    def _dependencies_for_damage_info_0x18402aa9(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_0x18402aa9.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_part_0xe701daea(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.part_0xe701daea, is_mlvl)

    def _dependencies_for_phazon_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.phazon_projectile, is_mlvl)

    def _dependencies_for_wpsc(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.wpsc, is_mlvl)

    def _dependencies_for_damage_info_0x58769eb2(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_0x58769eb2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_phazon_projectile_damage(self, asset_manager, is_mlvl: bool):
        yield from self.phazon_projectile_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_phazon_enrage_sphere(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.phazon_enrage_sphere, is_mlvl)

    def _dependencies_for_damage_info_0x8f3af226(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_0x8f3af226.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_alternate_scannable_info(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.alternate_scannable_info, is_mlvl)
