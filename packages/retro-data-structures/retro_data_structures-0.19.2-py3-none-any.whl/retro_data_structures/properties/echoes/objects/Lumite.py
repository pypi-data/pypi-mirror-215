...
class Lumite(BaseObjectType):
    ...
    def _dependencies_for_small_shot_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.small_shot_projectile, is_mlvl)

    def _dependencies_for_small_shot_damage(self, asset_manager, is_mlvl: bool):
        yield from self.small_shot_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_big_shot_projectile(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.big_shot_projectile, is_mlvl)

    def _dependencies_for_big_shot_damage(self, asset_manager, is_mlvl: bool):
        yield from self.big_shot_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_trail_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.trail_effect, is_mlvl)

    def _dependencies_for_sunlight_enter_exit_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.sunlight_enter_exit_effect, is_mlvl)

    def _dependencies_for_phase_in_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.phase_in_sound, is_mlvl)

    def _dependencies_for_phase_out_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.phase_out_sound, is_mlvl)
