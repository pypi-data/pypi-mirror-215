...
class OctapedeSegment(BaseObjectType):
    ...
    def _dependencies_for_between_segments_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.between_segments_effect, is_mlvl)

    def _dependencies_for_explosion_damage(self, asset_manager, is_mlvl: bool):
        yield from self.explosion_damage.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_idle_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.idle_sound, is_mlvl)

    def _dependencies_for_seperate_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.seperate_sound, is_mlvl)

    def _dependencies_for_bounce_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.bounce_sound, is_mlvl)

    def _dependencies_for_explode_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.explode_sound, is_mlvl)
