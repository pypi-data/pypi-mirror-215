...
class PlayerTurret(BaseObjectType):
    ...
    def _dependencies_for_weapon_damage(self, asset_manager, is_mlvl: bool):
        yield from self.weapon_damage.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_weapon_effect(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.weapon_effect, is_mlvl)
    ...
    def _dependencies_for_unknown_0xe7234f72(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_0xe7234f72, is_mlvl)

    def _dependencies_for_unknown_0x3e2f7afb(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_0x3e2f7afb, is_mlvl)

    def _dependencies_for_unknown_0x7cabd1f1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_0x7cabd1f1, is_mlvl)

    def _dependencies_for_unknown_0x7ef976eb(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_0x7ef976eb, is_mlvl)

    def _dependencies_for_unknown_0x035459fd(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_0x035459fd, is_mlvl)
