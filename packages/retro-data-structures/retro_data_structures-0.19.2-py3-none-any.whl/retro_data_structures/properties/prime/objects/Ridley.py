...
class Ridley(BaseObjectType):
    ...
    def _dependencies_for_model_1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.model_1, is_mlvl)

    def _dependencies_for_model_2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.model_2, is_mlvl)

    def _dependencies_for_model_3(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.model_3, is_mlvl)

    def _dependencies_for_model_4(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.model_4, is_mlvl)

    def _dependencies_for_model_5(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.model_5, is_mlvl)

    def _dependencies_for_model_6(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.model_6, is_mlvl)

    def _dependencies_for_model_7(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.model_7, is_mlvl)

    def _dependencies_for_model_8(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.model_8, is_mlvl)

    def _dependencies_for_model_9(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.model_9, is_mlvl)

    def _dependencies_for_model_10(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.model_10, is_mlvl)

    def _dependencies_for_model_11(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.model_11, is_mlvl)

    def _dependencies_for_model_12(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.model_12, is_mlvl)

    def _dependencies_for_particle(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.particle, is_mlvl)
    ...
    def _dependencies_for_unnamed_0x00000019(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000019.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_id_1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_id_1, is_mlvl)
    ...
    def _dependencies_for_ridley_struct2_1(self, asset_manager, is_mlvl: bool):
        yield from self.ridley_struct2_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_wpsc_3(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.wpsc_3, is_mlvl)
    ...
    def _dependencies_for_ridley_struct2_2(self, asset_manager, is_mlvl: bool):
        yield from self.ridley_struct2_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_sound_id_2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_id_2, is_mlvl)
    ...
    def _dependencies_for_ridley_struct2_3(self, asset_manager, is_mlvl: bool):
        yield from self.ridley_struct2_3.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_damage_info_6(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_6.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_damage_info_7(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_7.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_elsc(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.elsc, is_mlvl)

    def _dependencies_for_sound_id_3(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_id_3, is_mlvl)

    def _dependencies_for_damage_info_8(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_8.dependencies_for(asset_manager, is_mlvl)
