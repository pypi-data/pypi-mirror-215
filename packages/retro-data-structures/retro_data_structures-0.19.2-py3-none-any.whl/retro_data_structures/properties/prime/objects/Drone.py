...
class Drone(BaseObjectType):
    ...
    def _dependencies_for_unnamed_0x00000006(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000006.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unnamed_0x00000007(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000007.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_flare_def_1(self, asset_manager, is_mlvl: bool):
        yield from self.flare_def_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_flare_def_2(self, asset_manager, is_mlvl: bool):
        yield from self.flare_def_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_flare_def_3(self, asset_manager, is_mlvl: bool):
        yield from self.flare_def_3.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_flare_def_4(self, asset_manager, is_mlvl: bool):
        yield from self.flare_def_4.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_flare_def_5(self, asset_manager, is_mlvl: bool):
        yield from self.flare_def_5.dependencies_for(asset_manager, is_mlvl)
