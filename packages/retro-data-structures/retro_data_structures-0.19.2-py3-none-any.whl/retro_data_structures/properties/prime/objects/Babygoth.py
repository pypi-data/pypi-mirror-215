...
class Babygoth(BaseObjectType):
    ...
    def _dependencies_for_damage_vulnerability_1(self, asset_manager, is_mlvl: bool):
        yield from self.damage_vulnerability_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_damage_vulnerability_2(self, asset_manager, is_mlvl: bool):
        yield from self.damage_vulnerability_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.model, is_mlvl)
    ...
    def _dependencies_for_unknown_4(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_4, is_mlvl)
    ...
    def _dependencies_for_unknown_5(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_5, is_mlvl)

    def _dependencies_for_unknown_6(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_6, is_mlvl)
