...
class ChozoGhost(BaseObjectType):
    ...
    def _dependencies_for_behave_chance_1(self, asset_manager, is_mlvl: bool):
        yield from self.behave_chance_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_behave_chance_2(self, asset_manager, is_mlvl: bool):
        yield from self.behave_chance_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_behave_chance_3(self, asset_manager, is_mlvl: bool):
        yield from self.behave_chance_3.dependencies_for(asset_manager, is_mlvl)
