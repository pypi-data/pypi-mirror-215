...
class SpecialFunction(BaseObjectType):
    ...
    def _dependencies_for_used_by_spinner_controller_1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.used_by_spinner_controller_1, is_mlvl)

    def _dependencies_for_used_by_spinner_controller_2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.used_by_spinner_controller_2, is_mlvl)

    def _dependencies_for_used_by_spinner_controller_3(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.used_by_spinner_controller_3, is_mlvl)
