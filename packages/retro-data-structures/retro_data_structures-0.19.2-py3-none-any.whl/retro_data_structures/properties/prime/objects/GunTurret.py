...
class GunTurret(BaseObjectType):
    ...
    def _dependencies_for_unnamed_0x00000008(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000008.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unnamed_0x00000009(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000009.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unnamed_0x0000000a(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x0000000a.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unknown_18(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.unknown_18, is_mlvl)

    def _dependencies_for_unnamed_0x0000001b(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x0000001b.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_unknown_19(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_19, is_mlvl)

    def _dependencies_for_unknown_20(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_20, is_mlvl)

    def _dependencies_for_unknown_21(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_21, is_mlvl)

    def _dependencies_for_unknown_22(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_22, is_mlvl)

    def _dependencies_for_unknown_23(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_23, is_mlvl)

    def _dependencies_for_unknown_24(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_24, is_mlvl)
