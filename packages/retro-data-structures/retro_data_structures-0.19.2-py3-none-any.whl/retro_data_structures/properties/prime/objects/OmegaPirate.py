...
class OmegaPirate(BaseObjectType):
    ...
    def _dependencies_for_unnamed(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_actor_parameters_1(self, asset_manager, is_mlvl: bool):
        yield from self.actor_parameters_1.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_actor_parameters_2(self, asset_manager, is_mlvl: bool):
        yield from self.actor_parameters_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_animation_parameters(self, asset_manager, is_mlvl: bool):
        yield from self.animation_parameters.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_grenade_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.grenade_model, is_mlvl)
    ...
    def _dependencies_for_sound_id_4(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_id_4, is_mlvl)
    ...
    def _dependencies_for_sound_id_5(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_id_5, is_mlvl)

    def _dependencies_for_x_ray_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.x_ray_model, is_mlvl)

    def _dependencies_for_x_ray_cskr(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.x_ray_cskr, is_mlvl)

    def _dependencies_for_x_ray_cinf(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.x_ray_cinf, is_mlvl)
