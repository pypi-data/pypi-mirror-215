...
class MetroidAlpha(BaseObjectType):
    ...
    def _dependencies_for_animation_parameters_1(self, asset_manager, is_mlvl: bool):
        yield from self.animation_parameters_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_animation_parameters_2(self, asset_manager, is_mlvl: bool):
        yield from self.animation_parameters_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_animation_parameters_3(self, asset_manager, is_mlvl: bool):
        yield from self.animation_parameters_3.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_animation_parameters_4(self, asset_manager, is_mlvl: bool):
        yield from self.animation_parameters_4.dependencies_for(asset_manager, is_mlvl)
