...
class Thardus(BaseObjectType):
    ...
    def _dependencies_for_unnamed_0x00000004(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000004.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unnamed_0x00000005(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000005.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_rock_weak_point_1_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.rock_weak_point_1_model, is_mlvl)

    def _dependencies_for_rock_weak_point_2_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.rock_weak_point_2_model, is_mlvl)

    def _dependencies_for_rock_weak_point_3_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.rock_weak_point_3_model, is_mlvl)

    def _dependencies_for_rock_weak_point_4_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.rock_weak_point_4_model, is_mlvl)

    def _dependencies_for_rock_weak_point_5_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.rock_weak_point_5_model, is_mlvl)

    def _dependencies_for_rock_weak_point_6_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.rock_weak_point_6_model, is_mlvl)

    def _dependencies_for_rock_weak_point_7_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.rock_weak_point_7_model, is_mlvl)

    def _dependencies_for_phazon_weak_point_1_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.phazon_weak_point_1_model, is_mlvl)

    def _dependencies_for_phazon_weak_point_2_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.phazon_weak_point_2_model, is_mlvl)

    def _dependencies_for_phazon_weak_point_3_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.phazon_weak_point_3_model, is_mlvl)

    def _dependencies_for_phazon_weak_point_4_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.phazon_weak_point_4_model, is_mlvl)

    def _dependencies_for_phazon_weak_point_5_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.phazon_weak_point_5_model, is_mlvl)

    def _dependencies_for_phazon_weak_point_6_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.phazon_weak_point_6_model, is_mlvl)

    def _dependencies_for_phazon_weak_point_7_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.phazon_weak_point_7_model, is_mlvl)

    def _dependencies_for_particle_1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.particle_1, is_mlvl)

    def _dependencies_for_particle_2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.particle_2, is_mlvl)

    def _dependencies_for_particle_3(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.particle_3, is_mlvl)

    def _dependencies_for_state_machine(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.state_machine, is_mlvl)

    def _dependencies_for_particle_4(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.particle_4, is_mlvl)

    def _dependencies_for_particle_5(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.particle_5, is_mlvl)

    def _dependencies_for_particle_6(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.particle_6, is_mlvl)

    def _dependencies_for_particle_7(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.particle_7, is_mlvl)

    def _dependencies_for_particle_8(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.particle_8, is_mlvl)

    def _dependencies_for_particle_9(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.particle_9, is_mlvl)

    def _dependencies_for_texture(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.texture, is_mlvl)

    def _dependencies_for_unknown_9(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_9, is_mlvl)

    def _dependencies_for_particle_10(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.particle_10, is_mlvl)

    def _dependencies_for_unknown_10(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_10, is_mlvl)

    def _dependencies_for_unknown_11(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_11, is_mlvl)

    def _dependencies_for_unknown_12(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_12, is_mlvl)
