...
class Beetle(BaseObjectType):
    ...
    def _dependencies_for_abdomen_vulnerability(self, asset_manager, is_mlvl: bool):
        yield from self.abdomen_vulnerability.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_abdomen_model(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.abdomen_model, is_mlvl)
