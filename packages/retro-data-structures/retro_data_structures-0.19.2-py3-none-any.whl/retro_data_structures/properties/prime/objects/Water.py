...
class Water(BaseObjectType):
    ...
    def _dependencies_for_unnamed_0x00000003(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000003.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_texture_3(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.texture_3, is_mlvl)

    def _dependencies_for_texture_4(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.texture_4, is_mlvl)

    def _dependencies_for_reflection_map(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.reflection_map, is_mlvl)

    def _dependencies_for_texture_6(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.texture_6, is_mlvl)

    def _dependencies_for_unnamed_0x00000016(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000016.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_enter_particle(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.enter_particle, is_mlvl)
    ...
    def _dependencies_for_sound_1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_1, is_mlvl)

    def _dependencies_for_sound_2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_2, is_mlvl)

    def _dependencies_for_sound_3(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_3, is_mlvl)

    def _dependencies_for_sound_4(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_4, is_mlvl)

    def _dependencies_for_sound_5(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.sound_5, is_mlvl)

    def _dependencies_for_lightmap_texture(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.lightmap_texture, is_mlvl)
