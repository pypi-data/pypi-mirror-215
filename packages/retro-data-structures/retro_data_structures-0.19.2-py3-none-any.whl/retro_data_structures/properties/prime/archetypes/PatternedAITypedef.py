...
class PatternedAITypedef(BaseProperty):
    ...
    def _dependencies_for_death_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.death_sound, is_mlvl)
    ...
    def _dependencies_for_ice_shatter_sound(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.ice_shatter_sound, is_mlvl)
