...
class MassivePrimeStruct(BaseProperty):
    ...
    def _dependencies_for_unnamed_0x00000001(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000001.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_unnamed_0x00000002(self, asset_manager, is_mlvl: bool):
        yield from self.unnamed_0x00000002.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct2_1(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct2_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct2_2(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct2_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct2_3(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct2_3.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_damage_info_1(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_texture_1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.texture_1, is_mlvl)

    def _dependencies_for_unknown_7(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_audio_group_dependency(self.unknown_7, is_mlvl)
    ...
    def _dependencies_for_prime_struct4_1(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct4_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct4_2(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct4_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct4_3(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct4_3.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct4_4(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct4_4.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_wpsc_1(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.wpsc_1, is_mlvl)

    def _dependencies_for_damage_info_2(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct2_4(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct2_4.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_wpsc_2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.wpsc_2, is_mlvl)

    def _dependencies_for_damage_info_3(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_3.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct2_5(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct2_5.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_damage_info_4(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_4.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_texture_2(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.texture_2, is_mlvl)

    def _dependencies_for_damage_info_5(self, asset_manager, is_mlvl: bool):
        yield from self.damage_info_5.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct2_6(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct2_6.dependencies_for(asset_manager, is_mlvl)
    ...
    def _dependencies_for_swhc(self, asset_manager, is_mlvl: bool):
        yield from asset_manager.get_dependencies_for_asset(self.swhc, is_mlvl)
    ...
    def _dependencies_for_prime_struct6_1(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct6_1.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct6_2(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct6_2.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct6_3(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct6_3.dependencies_for(asset_manager, is_mlvl)

    def _dependencies_for_prime_struct6_4(self, asset_manager, is_mlvl: bool):
        yield from self.prime_struct6_4.dependencies_for(asset_manager, is_mlvl)
