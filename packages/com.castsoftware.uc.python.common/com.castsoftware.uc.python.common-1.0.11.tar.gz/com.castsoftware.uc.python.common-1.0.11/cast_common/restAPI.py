...
#                    status_forcelist = [408],
    ...
    def get(self, url = "",header={'Accept': 'application/json'}):
        start_dttm = ctime()
    ...
    def post(self, url = "",data = {},header={'Accept': 'application/json'}):
        ...
        try:
            ...
            resp = self._session.post(u,data=dumps(data),timeout = (5, 15),auth=self._auth,headers=header)
            resp.raise_for_status()
