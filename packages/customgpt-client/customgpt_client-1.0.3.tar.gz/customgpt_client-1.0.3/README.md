...
```python
from custom_gpt_client.models import MyDataModel
from custom_gpt_client.api.my_tag import get_my_data_model
...
1. Any endpoint which did not have a tag will be in `custom_gpt_client.api.default`
