...
class Display:
    ...
    def add_trajectories(self,
        ...
        for index, agent in enumerate(split):
            ...
            colorfade = matplotlib.colors.to_rgb(color) + (0.0,)
            mycolor = matplotlib.colors.LinearSegmentedColormap.from_list('my', [colorfade, colors[agent]])
            lc = matplotlib.collections.LineCollection(segments, array=step_alphas, cmap=mycolor, lw=3, zorder=zorder)
