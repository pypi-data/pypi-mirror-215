...
def EpisodeRepresentation(episode: Episode, world: World, frames: list = None, time_stamps: list = None, colors={"prey": "blue", "predator": "red"}, cols=0, figsize=(10,10), video_path:str = "", video_frames:list=None, icons:dict={"prey":"mouse", "predator":"robot"}, distance_equalization: int=30, **kwargs):
