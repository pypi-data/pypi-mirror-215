...
def EpisodeRepresentation(episode: Episode, video_path: str, world: World, frames: list=None, time_stamps: list=None, colors={"prey": "blue", "predator": "red"}, cols=0, figsize=(10,10), **kwargs):
    import cv2
    ...
    for i, selection in enumerate(selections):
        ...
        displays[-1].set_background(cropped_frames[selection_frames[i]], 1)
        if frames:
