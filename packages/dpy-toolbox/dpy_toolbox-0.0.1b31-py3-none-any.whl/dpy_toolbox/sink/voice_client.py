...
from .opus import DecodeManager, _OpusStruct
from discord import utils, DiscordException
...
class RecordingException(DiscordException):
    pass
...
class SinkVoiceClient(VoiceProtocol):
    ...
    def __init__(self, client: Client, channel: abc.Connectable):
        ...
        self.ws: DiscordSinkWebSocket = MISSING
    ...
    async def connect_websocket(self) -> DiscordVoiceWebSocket:
        ws = await DiscordSinkWebSocket.from_client(self)
    ...
    def recv_decoded_audio(self, data):
        ...
        data.decoded_data = struct.pack('<h', 0) * silence * _OpusStruct.CHANNELS + data.decoded_data
        # if getattr(self.ws, 'ssrc_map', None) == None:
        #     self.ws.ssrc_map = {}
    ...
    def send_audio_packet(self, data: bytes, *, encode: bool = True) -> None:
        ...
        self.checked_add("timestamp", Encoder.SAMPLES_PER_FRAME, 4294967295)