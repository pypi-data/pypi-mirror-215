...
def sendFailureMail(FailureMailBody, filePath):
    subprocess.call(['bash',filePath, FailureMailBody])
    print ("Failure email has been sent ")

def sendSuccessMail(SuccessMailBody, filePath):
    subprocess.call(['bash',filePath,SuccessMailBody])
