...
class TestCancellableGather(IsolatedAsyncioTestCase):
    def test_prioritized_item(self) -> None:
        self.assertTrue(is_dataclass(prioritized_item := PrioritizedItem(priority=0, item="for testing purposes")))
        self.assertEqual(prioritized_item, PrioritizedItem(priority=0, item=b"for testing purposes"))
        self.assertNotEqual(prioritized_item, PrioritizedItem(priority=123, item="for testing purposes"))
        self.assertLess(prioritized_item, PrioritizedItem(priority=1, item="the other one"))
