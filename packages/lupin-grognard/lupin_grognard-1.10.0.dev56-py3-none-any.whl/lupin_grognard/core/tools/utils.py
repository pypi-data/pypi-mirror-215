...
def generate_commits_range_to_check(
    ...
    If ci_mr_target_branch_name equals main or master, the function returns the commit range
    starting from the second merge found.

    If ci_mr_target_branch_name and equals dev or develop, the function returns the commit range
