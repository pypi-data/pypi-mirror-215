...
def test_calculate_weights_serial(get_xarray, get_gdf, get_out_path):
...
def test_calculate_weights_serial_median(get_xarray, get_gdf, get_out_path):
    """Test calculate weights."""
    user_data = UserCatData(
        ds=get_xarray,
        proj_ds=data_crs,
...
def test_calculate_weights_dask(get_xarray, get_gdf, get_out_path):
    """Test calculate weights."""
...
def test_calculate_weights_dask_median(get_xarray, get_gdf, get_out_path):
    """Test calculate weights."""
    cluster = LocalCluster(threads_per_worker=os.cpu_count())
    client = Client(cluster)  # type: ignore
    user_data = UserCatData(
...
def test_calculate_weights_parallel(get_xarray, get_gdf, get_out_path):
    """Test calculate weights."""
    user_data = UserCatData(
        ds=get_xarray,
        proj_ds=data_crs,
...
def test_calculate_weights_parallel_median(get_xarray, get_gdf, get_out_path):
    """Test calculate weights."""
    user_data = UserCatData(
        ds=get_xarray,
        proj_ds=data_crs,
