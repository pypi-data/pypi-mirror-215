...
class ApiAuthSendPost400Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiAuthSendPost400Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiAuthSendPost400Response:
        """Create an instance of ApiAuthSendPost400Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiAuthSendPost400Response.parse_obj(obj)

        _obj = ApiAuthSendPost400Response.parse_obj({
