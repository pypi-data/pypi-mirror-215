...
def nwb_perg():
    nwb = nwb_gen()
    SimpleNWB.p_erg_add_data(nwb, perg_filename, "perg_table", description="test desc")
    SimpleNWB.p_erg_add_data(nwb, perg_filename, "perg_table", description="test desc")
    SimpleNWB.p_erg_add_folder(nwb, foldername=perg_folder, file_pattern="*.txt", table_name="p_ergs", description="test desc")
