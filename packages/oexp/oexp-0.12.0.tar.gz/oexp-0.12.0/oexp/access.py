...
JAR_URL = f"https://matt-central.s3.us-east-2.amazonaws.com//0/versioned/front/593/oexp-front-0-all.jar"
...
def image(remote_path=NO_DEFAULT, protect=NO_DEFAULT):
    _check_required_parameters(**dict(remote_path=remote_path, protect=protect))
    return Image(remote_path, protect)
...
class Image(KBDClass):
    ...
    # [[matt.oexp.olang.lab.model.trial.Image#protect]]
    @property
