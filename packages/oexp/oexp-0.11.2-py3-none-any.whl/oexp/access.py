...
JAR_URL = f"https://matt-central.s3.us-east-2.amazonaws.com//0/versioned/front/584/oexp-front-0-all.jar"
...
# [[matt.oexp.olang.model.stim.EncryptedPhase]]
class EncryptedPhase(TrialStimuli, KBClass, abc.ABC):
    # [[matt.oexp.olang.model.stim.EncryptedPhase]]
    def to_json(self):
        _ensure_synchronized()
        _sendall(GET_JSON)
...
class EncryptedTrial(EncryptedPhase, KBClass, abc.ABC):
    # [[matt.oexp.olang.model.stim.EncryptedTrial]]
    def to_json(self):
        _ensure_synchronized()
        _sendall(GET_JSON)
