...
class ModularKnuckleJoint:
	...
	Offset angle between output link "c" of kinematic 
	chain 1 and input link of kinematic chain2	is 0 in KJ
	...
	def __init__(self, a, b, c, d, e, f, g, h, thd_offset_ccw_dir_add, rpm, root_op):
		...
		rpm : float
			rpm of the input link
		root_op : int
			each kinematic chain has 2 roots. Our std drag link works well with root 2.
		"""
