...
from tinybird.datafile import AlreadyExistsException, Datafile, ParseException, build_graph, folder_push, folder_pull, format_datasource, format_pipe, get_name_tag_version, get_project_filenames, parse_datasource, parse_pipe, wait_job, get_resource_versions, diff_command, CLIGitRelease, CLIGitReleaseException
            ...
            try:
                ...
                if changed:
                    ...
                    if click.confirm(FeedbackManager.prompt_init_git_release_pull(pull_command="tb pull --auto --force")):
                        await folder_pull(client, '.', auto=True, match=None, tag=None, force=True)
