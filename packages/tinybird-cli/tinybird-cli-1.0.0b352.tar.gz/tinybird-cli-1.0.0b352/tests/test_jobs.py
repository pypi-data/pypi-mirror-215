...
class BaseTestJobs(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        ...
        self.job_executor = JobExecutor(redis_client=redis_client, redis_config=redis_config, consumer=True, import_workers=1, query_workers=1, export_sink_workers=1)
