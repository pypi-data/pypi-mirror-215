...
class OracleExportPDBInPlaceTransferStrategy(OracleExportPDBTransferStrategy):
    ...
    *(extends* :py:class:`delphixpy.web.vo.OracleExportPDBTransferStrategy` *)*
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "operations_post_v2_p" == "type" or (self.operations_post_v2_p is not self.__undef__ and (not (dirty and not self._operations_post_v2_p[1]) or isinstance(self.operations_post_v2_p, list) or belongs_to_parent)):
