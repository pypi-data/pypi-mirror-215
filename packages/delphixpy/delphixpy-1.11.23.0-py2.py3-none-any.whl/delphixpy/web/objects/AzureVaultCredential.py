...
class AzureVaultCredential(AbstractVaultCredential):
    ...
    *(extends* :py:class:`delphixpy.web.vo.AbstractVaultCredential` *)* The
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "azure_vault_name" == "type" or (self.azure_vault_name is not self.__undef__ and (not (dirty and not self._azure_vault_name[1]) or isinstance(self.azure_vault_name, list) or belongs_to_parent)):
