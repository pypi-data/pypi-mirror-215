...
class SystemInfo(PublicSystemInfo):
    ...
    *(extends* :py:class:`v1_11_23.web.vo.PublicSystemInfo` *)* Retrieve
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "max_native_memory_gb" == "type" or (self.max_native_memory_gb is not self.__undef__ and (not (dirty and not self._max_native_memory_gb[1]) or isinstance(self.max_native_memory_gb, list) or belongs_to_parent)):
