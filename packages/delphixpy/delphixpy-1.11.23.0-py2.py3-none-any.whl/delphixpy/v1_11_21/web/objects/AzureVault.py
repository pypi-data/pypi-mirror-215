    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "azure_authentication" == "type" or (self.azure_authentication is not self.__undef__ and (not (dirty and not self._azure_authentication[1]) or isinstance(self.azure_authentication, list) or belongs_to_parent)):
