    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        def dictify(obj, prop_is_list_or_vo=False):
            if isinstance(obj, list):
                ...
                return obj
        if "ignore_disable_sources_failures" == "type" or (self.ignore_disable_sources_failures is not self.__undef__ and (not (dirty and not self._ignore_disable_sources_failures[1]) or isinstance(self.ignore_disable_sources_failures, list) or belongs_to_parent)):
