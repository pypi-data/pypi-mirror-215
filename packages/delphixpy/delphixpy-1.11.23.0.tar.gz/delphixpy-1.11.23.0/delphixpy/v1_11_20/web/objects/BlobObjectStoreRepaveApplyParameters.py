...
class BlobObjectStoreRepaveApplyParameters(RepaveApplyParameters):
    ...
    *(extends* :py:class:`v1_11_20.web.vo.RepaveApplyParameters` *)* An Azure
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "domain0_pool_guid" == "type" or (self.domain0_pool_guid is not self.__undef__ and (not (dirty and not self._domain0_pool_guid[1]) or isinstance(self.domain0_pool_guid, list) or belongs_to_parent)):
