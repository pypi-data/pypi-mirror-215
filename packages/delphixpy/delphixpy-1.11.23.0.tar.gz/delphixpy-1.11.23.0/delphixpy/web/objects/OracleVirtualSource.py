...
class OracleVirtualSource(OracleManagedSource):
    ...
    *(extends* :py:class:`delphixpy.web.vo.OracleManagedSource` *)* A virtual
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        ...
        if "allow_refresh_rewind_post_v2_p" == "type" or (self.allow_refresh_rewind_post_v2_p is not self.__undef__ and (not (dirty and not self._allow_refresh_rewind_post_v2_p[1]) or isinstance(self.allow_refresh_rewind_post_v2_p, list) or belongs_to_parent)):
