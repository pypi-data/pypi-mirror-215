...
async def find_lowest_iv2(output):
...
# async def main():
#     tickers = ["AAPL","MSFT","AMD","U","W","SNAP","META"]
#     for ticker in tickers:
...
#         request_urls = await get_near_the_money_options2(ticker=ticker, lower_strike=lower_strike,upper_strike=upper_strike)
#         print(request_urls['implied_volatility'])
#         print(request_urls['strike_price'])
#         print(price)


# asyncio.run(main())
# # upper_strike = price * 0.95
# # lower_strike = price * 1.05