...
from cmon.clients.base import retry
from cmon.enums import WebsocketSubProtocols
...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from cmon._docarray import Document
    from cmon.logging.logger import CmonLogger

if docarray_v2:
    from docarray.base_doc.io.json import orjson_dumps

    class CmonJsonPayload(BytesPayload):
        """A JSON payload for Cmon Requests"""
        ...
        for attempt in range(1, self.max_attempts + 1):
            try:
                ...
                if not docarray_v2:
                    ...
                    request_kwargs['data'] = CmonJsonPayload(value=req_dict)
