...
from cmon.constants import __docker_host__, __windows__
from cmon.enums import PodRoleType, DockerNetworkMode
from cmon.excepts import BadImageNameError, DockerVersionError
from cmon.helper import random_name, slugify
...
from cmon.orchestrate.pods import BasePod
from cmon.orchestrate.pods.container_helper import (
    get_docker_network,
...
def run(
    ...
    logger = CmonLogger(name, **log_kwargs)
