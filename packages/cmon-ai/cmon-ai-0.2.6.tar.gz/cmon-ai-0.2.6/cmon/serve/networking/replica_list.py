...
from cmon.excepts import EstablishGrpcConnectionError
...
from cmon.serve.networking.utils import TLS_PROTOCOL_SCHEMES
...
class _ReplicaList:
    ...
    async def remove_connection(self, address: str):
        ...
        .. warning::
            ...
            If you want to reset (remove and re-add) a connection, use :meth:`cmon.serve.networking.ReplicaList.reset_connection`,
