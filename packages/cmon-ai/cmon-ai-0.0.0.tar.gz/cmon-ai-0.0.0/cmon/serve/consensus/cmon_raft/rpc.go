...
type RpcInterface struct {
    ...
    Raft     *raft.Raft
    Logger   hclog.Logger
    pb.UnimplementedCmonSingleDataRequestRPCServer
    pb.UnimplementedCmonDiscoverEndpointsRPCServer
    pb.UnimplementedCmonInfoRPCServer
    pb.UnimplementedCmonRPCServer
}
...
func (rpc *RpcInterface) Call(stream pb.CmonRPC_CallServer) error {
...
/**
 * cmon gRPC func for DataRequests.
...
func (rpc *RpcInterface) XStatus(ctx context.Context, empty *empty.Empty) (*pb.CmonInfoProto, error) {
