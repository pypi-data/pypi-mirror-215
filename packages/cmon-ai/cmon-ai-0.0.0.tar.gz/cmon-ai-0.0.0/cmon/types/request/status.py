...
StatusSourceType = TypeVar('StatusSourceType', cmon_pb2.StatusProto, str, Dict, bytes)
...
class StatusMessage(ProtoTypeMixin):
    ...
    def __init__(
        ...
        self._pb_body = cmon_pb2.StatusProto()
        try:
            if isinstance(status_object, cmon_pb2.StatusProto):
    ...
    def set_exception(self, ex: Exception):
        ...
        self.proto.code = cmon_pb2.StatusProto.ERROR
