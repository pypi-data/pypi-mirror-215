...
// Cmon re-implementation of raft.GetConfiguration. Returns the persisted configuration of the Raft cluster
...
func CmonGetConfiguration(conf *raft.Config, fsm raft.FSM, logs raft.LogStore, stable raft.StableStore,
...
// Cmon Re-implementation of NewRaft so that restoring is not triggered. DummyNewRaft is used to get a dummy new Raft node.
