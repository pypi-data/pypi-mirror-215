...
from cmon import DocumentArray
from cmon._docarray import docarray_v2
from cmon.importer import ImportExtensions
from cmon.serve.networking.sse import EventSourceResponse
...
def get_fastapi_app(
    ...
    **kwargs,
    ...
    from cmon.serve.runtimes.gateway.models import _to_camel_case
    ...
    from cmon.serve.runtimes.gateway.health_model import CmonHealthModel

    @app.get(
        path='/',
        summary='Get the health of Cmon Executor service',
        response_model=CmonHealthModel,
    )
