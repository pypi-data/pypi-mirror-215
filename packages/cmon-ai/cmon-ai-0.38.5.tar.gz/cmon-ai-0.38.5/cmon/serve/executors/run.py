...
from cmon.serve.helper import _get_workspace_from_name_and_shards
...
def run_raft(
    ...
    logger = CmonLogger('run_raft', **vars(args))
    ...
    log_level = raft_configuration.get('LogLevel', os.getenv('CMON_LOG_LEVEL', 'INFO'))
...
def run(
    ...
    logger = CmonLogger(name, **vars(args))
