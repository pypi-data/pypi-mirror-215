...
def get_image_name(uses: str) -> str:
    ...
    """
    try:
        rebuild_image = 'CMON_HUB_NO_IMAGE_REBUILD' not in os.environ
...
def get_base_executor_version():
    """
    Get the version of cmon to be used
    ...
    try:
        ...
        url = 'https://registry.hub.docker.com/v2/repositories/cmonai/cmon/tags'
