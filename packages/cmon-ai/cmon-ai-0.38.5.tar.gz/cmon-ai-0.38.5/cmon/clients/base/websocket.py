"""A module for the websockets-based Client for Cmon."""
import asyncio
...
from cmon.clients.base.helper import WebsocketClientlet
from cmon.clients.helper import callback_exec
from cmon.helper import get_or_reuse_loop
        ...
        async with AsyncExitStack() as stack:
            try:
                ...
                try:
                    ...
                    if response_result.proto.code == cmon_pb2.StatusProto.SUCCESS:
                        return True
                finally:
