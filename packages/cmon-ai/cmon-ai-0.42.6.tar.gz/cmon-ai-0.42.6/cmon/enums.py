"""
Miscellaneous enums used in Cmon.
...
class BetterEnum(IntEnum, metaclass=EnumType):
    """The base class of Enum used in Cmon."""
...
class FlowBuildLevel(BetterEnum):
    ...
    Some :class:`cmon.orchestrate.flow.Flow` class functions require certain build level to run.
    """
