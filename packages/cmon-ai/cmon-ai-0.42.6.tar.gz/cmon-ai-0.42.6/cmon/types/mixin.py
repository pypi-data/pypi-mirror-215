...
from cmon.helper import TYPE_CHECKING, T, deprecate_by, typename
...
class ProtoTypeMixin:
    """The base mixin class of all Cmon types.

    .. note::
        - All Cmon types should inherit from this class.
        ...
        - All subclass should implement ``__init__`` with the possibility of initializing from ``None``, e.g.:
            ...
            .. code-block:: python
                ...
                class MyCmonType(ProtoTypeMixin):
                    def __init__(self, proto: Optional[cmon_pb2.SomePbMsg] = None):
                        self._pb_body = proto or cmon_pb2.SomePbMsg()
    ...
    @property
    def proto(self) -> 'cmon_pb2._reflection.GeneratedProtocolMessageType':
