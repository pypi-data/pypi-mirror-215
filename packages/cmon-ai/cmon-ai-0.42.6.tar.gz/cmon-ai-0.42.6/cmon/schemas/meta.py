...
This is also the structure given by ``cmon hub new`` CLI.
...
2. This is a valid structure but not recommended:
    ...
    - to import ``foo.py``, you must to use ``from cmonhub.foo import bar``
    - ``cmonhub`` is a common namespace for all plugin-modules, not changeable.
