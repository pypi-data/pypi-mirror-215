//protoc --go_out cmon-go-proto --go_opt=paths=source_relative --go_opt=Mcmon.proto=cmon-go-proto=jraft/cmon-go-proto --go-grpc_out cmon-go-proto --go-grpc_opt=paths=source_relative --experimental_allow_proto3_optional cmon.proto
...
func (StatusProto_StatusCode) Descriptor() protoreflect.EnumDescriptor {
	return file_cmon_proto_enumTypes[0].Descriptor()
}

func (StatusProto_StatusCode) Type() protoreflect.EnumType {
	return &file_cmon_proto_enumTypes[0]
}
...
func (StatusProto_StatusCode) EnumDescriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{4, 0}
}
...
func (SnapshotStatusProto_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_cmon_proto_enumTypes[1].Descriptor()
}

func (SnapshotStatusProto_Status) Type() protoreflect.EnumType {
	return &file_cmon_proto_enumTypes[1]
}
...
func (SnapshotStatusProto_Status) EnumDescriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{11, 0}
}
...
func (RestoreSnapshotStatusProto_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_cmon_proto_enumTypes[2].Descriptor()
}

func (RestoreSnapshotStatusProto_Status) Type() protoreflect.EnumType {
	return &file_cmon_proto_enumTypes[2]
}
...
func (RestoreSnapshotStatusProto_Status) EnumDescriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{12, 0}
}
...
func (*RouteProto) Descriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{0}
}
...
type CmonInfoProto struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Cmon map[string]string `protobuf:"bytes,1,rep,name=cmon,proto3" json:"cmon,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // information about the system running and package version information including cmon
...
func (x *CmonInfoProto) Reset() {
	*x = CmonInfoProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cmon_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *CmonInfoProto) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CmonInfoProto) ProtoMessage() {}

func (x *CmonInfoProto) ProtoReflect() protoreflect.Message {
	mi := &file_cmon_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CmonInfoProto.ProtoReflect.Descriptor instead.
func (*CmonInfoProto) Descriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{1}
}

func (x *CmonInfoProto) GetCmon() map[string]string {
	if x != nil {
		return x.Cmon
	}
	return nil
...
func (x *CmonInfoProto) GetEnvs() map[string]string {
	if x != nil {
		return x.Envs
	}
	return nil
...
func (*HeaderProto) Descriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{2}
}
...
type EndpointsProto struct {
	...
	Schemas *_struct.Struct `protobuf:"bytes,3,opt,name=schemas,proto3" json:"schemas,omitempty"` // extra kwargs that will be used in executor
}

func (x *EndpointsProto) Reset() {
	*x = EndpointsProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cmon_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*EndpointsProto) Descriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{3}
}
...
func (x *EndpointsProto) GetSchemas() *_struct.Struct {
	if x != nil {
		return x.Schemas
	}
	return nil
...
type StatusProto struct {
	...
	// status code
	Code StatusProto_StatusCode `protobuf:"varint,1,opt,name=code,proto3,enum=cmon.StatusProto_StatusCode" json:"code,omitempty"`
...
func (*StatusProto) Descriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{4}
}
...
func (*RelatedEntity) Descriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{5}
}
...
func (*DataRequestProto) Descriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{6}
}
...
func (*DataRequestProtoWoData) Descriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{7}
}
...
func (*DataRequestListProto) Descriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{8}
}
...
func (*SnapshotId) Descriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{9}
}
...
func (x *RestoreId) Reset() {
	*x = RestoreId{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cmon_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RestoreId) Descriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{10}
}
...
type SnapshotStatusProto struct {
	...
	// status code
	Status SnapshotStatusProto_Status `protobuf:"varint,2,opt,name=status,proto3,enum=cmon.SnapshotStatusProto_Status" json:"status,omitempty"`
	// snapshot file
...
func (x *SnapshotStatusProto) Reset() {
	*x = SnapshotStatusProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cmon_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SnapshotStatusProto) Descriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{11}
}
...
type RestoreSnapshotStatusProto struct {
	...
	// status code
	Status RestoreSnapshotStatusProto_Status `protobuf:"varint,2,opt,name=status,proto3,enum=cmon.RestoreSnapshotStatusProto_Status" json:"status,omitempty"`
}

func (x *RestoreSnapshotStatusProto) Reset() {
	*x = RestoreSnapshotStatusProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cmon_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RestoreSnapshotStatusProto) Descriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{12}
}
...
func (x *RestoreSnapshotCommand) Reset() {
	*x = RestoreSnapshotCommand{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cmon_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RestoreSnapshotCommand) Descriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{13}
}
...
func (x *StatusProto_ExceptionProto) Reset() {
	*x = StatusProto_ExceptionProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cmon_proto_msgTypes[16]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *DataRequestProto_DataContentProto) Reset() {
	*x = DataRequestProto_DataContentProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cmon_proto_msgTypes[17]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DataRequestProto_DataContentProto) Descriptor() ([]byte, []int) {
	return file_cmon_proto_rawDescGZIP(), []int{6, 0}
}
...
var File_cmon_proto protoreflect.FileDescriptor

var file_cmon_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x73, 0x22, 0xa6, 0x01, 0x0a, 0x16, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x57, 0x6f, 0x44, 0x61, 0x74, 0x61, 0x12,
	0x29, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x11, 0x2e, 0x6a, 0x69, 0x6e, 0x61, 0x2e, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x50, 0x72, 0x6f,
	0x74, 0x6f, 0x52, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x37, 0x0a, 0x0a, 0x70, 0x61,
	...
	,
	...
	0x09, 0x4e, 0x4f, 0x54, 0x5f, 0x46, 0x4f, 0x55, 0x4e, 0x44, 0x10, 0x06, 0x22, 0xd6, 0x01, 0x0a,
	0x1a, 0x52, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1f, 0x0a, 0x02, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x6a, 0x69, 0x6e, 0x61, 0x2e, 0x52,
	0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x49, 0x64, 0x52, 0x02, 0x69, 0x64, 0x12, 0x3f, 0x0a, 0x06,
	...
	0x68, 0x6f, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53,
	...
	,
	...
	,
}

var (
	file_cmon_proto_rawDescOnce sync.Once
	file_cmon_proto_rawDescData = file_cmon_proto_rawDesc
)

func file_cmon_proto_rawDescGZIP() []byte {
	file_cmon_proto_rawDescOnce.Do(func() {
		file_cmon_proto_rawDescData = protoimpl.X.CompressGZIP(file_cmon_proto_rawDescData)
	})
	return file_cmon_proto_rawDescData
}

var file_cmon_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_cmon_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_cmon_proto_goTypes = []interface{}{
	(StatusProto_StatusCode)(0),               // 0: cmon.StatusProto.StatusCode
	(SnapshotStatusProto_Status)(0),           // 1: cmon.SnapshotStatusProto.Status
	(RestoreSnapshotStatusProto_Status)(0),    // 2: cmon.RestoreSnapshotStatusProto.Status
	(*RouteProto)(nil),                        // 3: cmon.RouteProto
	(*CmonInfoProto)(nil),                     // 4: cmon.CmonInfoProto
	(*HeaderProto)(nil),                       // 5: cmon.HeaderProto
	(*EndpointsProto)(nil),                    // 6: cmon.EndpointsProto
	(*StatusProto)(nil),                       // 7: cmon.StatusProto
	(*RelatedEntity)(nil),                     // 8: cmon.RelatedEntity
	(*DataRequestProto)(nil),                  // 9: cmon.DataRequestProto
	(*DataRequestProtoWoData)(nil),            // 10: cmon.DataRequestProtoWoData
	(*DataRequestListProto)(nil),              // 11: cmon.DataRequestListProto
	(*SnapshotId)(nil),                        // 12: cmon.SnapshotId
	(*RestoreId)(nil),                         // 13: cmon.RestoreId
	(*SnapshotStatusProto)(nil),               // 14: cmon.SnapshotStatusProto
	(*RestoreSnapshotStatusProto)(nil),        // 15: cmon.RestoreSnapshotStatusProto
	(*RestoreSnapshotCommand)(nil),            // 16: cmon.RestoreSnapshotCommand
	nil,                                       // 17: cmon.CmonInfoProto.CmonEntry
	nil,                                       // 18: cmon.CmonInfoProto.EnvsEntry
	(*StatusProto_ExceptionProto)(nil),        // 19: cmon.StatusProto.ExceptionProto
	(*DataRequestProto_DataContentProto)(nil), // 20: cmon.DataRequestProto.DataContentProto
	(*timestamp.Timestamp)(nil),               // 21: google.protobuf.Timestamp
	(*_struct.Struct)(nil),                    // 22: google.protobuf.Struct
	(*docarray_go_proto.DocListProto)(nil),    // 23: docarray.DocListProto
	(*empty.Empty)(nil),                       // 24: google.protobuf.Empty
}
var file_cmon_proto_depIdxs = []int32{
	21, // 0: cmon.RouteProto.start_time:type_name -> google.protobuf.Timestamp
	21, // 1: cmon.RouteProto.end_time:type_name -> google.protobuf.Timestamp
	7,  // 2: cmon.RouteProto.status:type_name -> cmon.StatusProto
	17, // 3: cmon.CmonInfoProto.cmon:type_name -> cmon.CmonInfoProto.CmonEntry
	18, // 4: cmon.CmonInfoProto.envs:type_name -> cmon.CmonInfoProto.EnvsEntry
	7,  // 5: cmon.HeaderProto.status:type_name -> cmon.StatusProto
	22, // 6: cmon.EndpointsProto.schemas:type_name -> google.protobuf.Struct
	0,  // 7: cmon.StatusProto.code:type_name -> cmon.StatusProto.StatusCode
	19, // 8: cmon.StatusProto.exception:type_name -> cmon.StatusProto.ExceptionProto
	5,  // 9: cmon.DataRequestProto.header:type_name -> cmon.HeaderProto
	22, // 10: cmon.DataRequestProto.parameters:type_name -> google.protobuf.Struct
	3,  // 11: cmon.DataRequestProto.routes:type_name -> cmon.RouteProto
	20, // 12: cmon.DataRequestProto.data:type_name -> cmon.DataRequestProto.DataContentProto
	5,  // 13: cmon.DataRequestProtoWoData.header:type_name -> cmon.HeaderProto
	22, // 14: cmon.DataRequestProtoWoData.parameters:type_name -> google.protobuf.Struct
	3,  // 15: cmon.DataRequestProtoWoData.routes:type_name -> cmon.RouteProto
	9,  // 16: cmon.DataRequestListProto.requests:type_name -> cmon.DataRequestProto
	12, // 17: cmon.SnapshotStatusProto.id:type_name -> cmon.SnapshotId
	1,  // 18: cmon.SnapshotStatusProto.status:type_name -> cmon.SnapshotStatusProto.Status
	13, // 19: cmon.RestoreSnapshotStatusProto.id:type_name -> cmon.RestoreId
	2,  // 20: cmon.RestoreSnapshotStatusProto.status:type_name -> cmon.RestoreSnapshotStatusProto.Status
	23, // 21: cmon.DataRequestProto.DataContentProto.docs:type_name -> docarray.DocListProto
	11, // 22: cmon.CmonDataRequestRPC.process_data:input_type -> cmon.DataRequestListProto
	9,  // 23: cmon.CmonSingleDataRequestRPC.process_single_data:input_type -> cmon.DataRequestProto
	9,  // 24: cmon.CmonRPC.Call:input_type -> cmon.DataRequestProto
	24, // 25: cmon.CmonDiscoverEndpointsRPC.endpoint_discovery:input_type -> google.protobuf.Empty
	24, // 26: cmon.CmonGatewayDryRunRPC.dry_run:input_type -> google.protobuf.Empty
	24, // 27: cmon.CmonInfoRPC._status:input_type -> google.protobuf.Empty
	24, // 28: cmon.CmonExecutorSnapshot.snapshot:input_type -> google.protobuf.Empty
	12, // 29: cmon.CmonExecutorSnapshotProgress.snapshot_status:input_type -> cmon.SnapshotId
	16, // 30: cmon.CmonExecutorRestore.restore:input_type -> cmon.RestoreSnapshotCommand
	13, // 31: cmon.CmonExecutorRestoreProgress.restore_status:input_type -> cmon.RestoreId
	9,  // 32: cmon.CmonDataRequestRPC.process_data:output_type -> cmon.DataRequestProto
	9,  // 33: cmon.CmonSingleDataRequestRPC.process_single_data:output_type -> cmon.DataRequestProto
	9,  // 34: cmon.CmonRPC.Call:output_type -> cmon.DataRequestProto
	6,  // 35: cmon.CmonDiscoverEndpointsRPC.endpoint_discovery:output_type -> cmon.EndpointsProto
	7,  // 36: cmon.CmonGatewayDryRunRPC.dry_run:output_type -> cmon.StatusProto
	4,  // 37: cmon.CmonInfoRPC._status:output_type -> cmon.CmonInfoProto
	14, // 38: cmon.CmonExecutorSnapshot.snapshot:output_type -> cmon.SnapshotStatusProto
	14, // 39: cmon.CmonExecutorSnapshotProgress.snapshot_status:output_type -> cmon.SnapshotStatusProto
	15, // 40: cmon.CmonExecutorRestore.restore:output_type -> cmon.RestoreSnapshotStatusProto
	15, // 41: cmon.CmonExecutorRestoreProgress.restore_status:output_type -> cmon.RestoreSnapshotStatusProto
...
func init() { file_cmon_proto_init() }
func file_cmon_proto_init() {
	if File_cmon_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cmon_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cmon_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CmonInfoProto); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cmon_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cmon_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cmon_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cmon_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cmon_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cmon_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cmon_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cmon_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cmon_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cmon_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cmon_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cmon_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cmon_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cmon_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
	...
	file_cmon_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_cmon_proto_msgTypes[5].OneofWrappers = []interface{}{}
	file_cmon_proto_msgTypes[17].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cmon_proto_rawDesc,
			NumEnums:      3,
			NumMessages:   18,
			NumExtensions: 0,
			NumServices:   10,
		},
		GoTypes:           file_cmon_proto_goTypes,
		DependencyIndexes: file_cmon_proto_depIdxs,
		EnumInfos:         file_cmon_proto_enumTypes,
		MessageInfos:      file_cmon_proto_msgTypes,
	}.Build()
	File_cmon_proto = out.File
	file_cmon_proto_rawDesc = nil
	file_cmon_proto_goTypes = nil
	file_cmon_proto_depIdxs = nil
}
