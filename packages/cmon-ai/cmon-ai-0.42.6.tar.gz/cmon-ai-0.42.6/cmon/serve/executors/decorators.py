...
from cmon.helper import is_generator, iscoroutinefunction
...
def write(
    ...
    .. code-block:: python
        ...
        from cmon import Deployment, Executor, requests
...
def requests(
    ...
    *,
    ...
    :return: decorated function
    """
    from cmon.constants import __args_executor_func__, __default_endpoint__
    ...
    class FunctionMapper:
        ...
        def _inject_owner_attrs(
            ...
            from cmon.serve.executors import _FunctionWithSchema
    ...
    *,
    ...
    EXAMPLE USAGE
        ...
        .. code-block:: python
            ...
            from cmon import Executor, monitor
