...
from cmon.enums import ProtocolType
...
class GatewayRequestHandler:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        from cmon.serve.runtimes.gateway.streamer import (
            GatewayStreamer,
            _ExecutorStreamer,
        )
    ...
    def _http_fastapi_default_app(
        ...
        **kwargs,
        ...
        from cmon.helper import extend_rest_interface

        if not docarray_v2:
            from cmon.serve.runtimes.gateway.http_fastapi_app import get_fastapi_app
        else:
            from cmon.serve.runtimes.gateway.http_fastapi_app_docarrayv2 import (
                get_fastapi_app,
            )
    ...
    def _websocket_fastapi_default_app(self, tracing, tracer_provider):
        from cmon.helper import extend_rest_interface
        from cmon.serve.runtimes.gateway.websocket_fastapi_app import get_fastapi_app
    ...
    async def dry_run(self, empty, context) -> cmon_pb2.StatusProto:
        """
        ...
        """
        from cmon._docarray import Document, DocumentArray
