...
class Runner():
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> OptimizationValue:
        ...
        def _run(config):
            ...
            with MLflowRunner(config, base_dir=self._path_manager.base_dir):
                ...
                # The Runner can be used as a decorator around functions and
                # classes which may not have a setup method.
                try:
                    exp.setup()
