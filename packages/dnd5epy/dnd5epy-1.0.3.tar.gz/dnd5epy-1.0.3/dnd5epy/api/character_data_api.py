...
class CharacterDataApi(object):
    ...
    @validate_arguments
    def api_ability_scores_get(self, **kwargs) -> List[AbilityScore]:  # noqa: E501
        """Get all ability scores.  # noqa: E501

        Returns a list of all available ability scores.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_ability_scores_get(async_req=True)
        >>> result = thread.get()
        ...
        :rtype: List[AbilityScore]
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_ability_scores_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_ability_scores_get_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def api_ability_scores_get_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Get all ability scores.  # noqa: E501
        ...
        >>> thread = api.api_ability_scores_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[AbilityScore], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api_ability_scores_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "List[AbilityScore]",
        }

        return self.api_client.call_api(
            '/api/ability-scores', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def api_ability_scores_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the ability score to get. ")], **kwargs) -> AbilityScore:  # noqa: E501
        ...
        if index is not None:
            ...
            return self.api_ability_scores_get_with_http_info(**kwargs)
