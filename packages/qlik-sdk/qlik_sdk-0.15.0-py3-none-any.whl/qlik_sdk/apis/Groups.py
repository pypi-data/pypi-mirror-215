...
class GroupSettingsSystemGroups:
    ...
    def __init__(self_, **kvargs):
        if (
            "_000000000000000000000001" in kvargs
            and kvargs["_000000000000000000000001"] is not None
        ):
            if (
                type(kvargs["_000000000000000000000001"]).__name__
                == GroupSettingsSystemGroups.__annotations__[
                    "_000000000000000000000001"
                ]
            ):
                self_._000000000000000000000001 = kvargs["_000000000000000000000001"]
            else:
                self_._000000000000000000000001 = (
                    GroupSettingsSystemGroups000000000000000000000001(
                        **kvargs["_000000000000000000000001"]
                    )
                )
        if (
...
class SettingsPatch:
    ...
    path: Literal["/autoCreateGroups", "/syncIdpGroups", "/systemGroups/{id}/enabled", "/systemGroups/{id}/assignedRoles"]
      A JSON Pointer.
    value: object
    ...
    path: Literal[
        "/autoCreateGroups",
        "/syncIdpGroups",
        "/systemGroups/{id}/enabled",
        "/systemGroups/{id}/assignedRoles",
    ] = None
    value: bool | list[SettingsPatchAssignedRolesRefIDs] = None
