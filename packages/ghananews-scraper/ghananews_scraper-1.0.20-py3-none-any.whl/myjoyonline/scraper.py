...
class MyJoyOnline:
    def __init__(self, url: str, driver_name: str = "chrome"):
        ...
        #     options.page_load_timeout = 600  # 300 seconds
        #     options.implicitly_wait = 600  # 300 seconds
        ...
        # else:
        #     raise ValueError("Invalid driver specified. Supported drivers are 'chrome' and 'firefox'.")
...
#     joy = MyJoyOnline(url="https://myjoyonline.com/entertainment")
#     joy.download()
