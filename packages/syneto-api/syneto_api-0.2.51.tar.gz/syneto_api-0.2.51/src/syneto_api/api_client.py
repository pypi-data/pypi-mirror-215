...
from tenacity import Retrying, AsyncRetrying, RetryError, stop_after_delay, retry_if_not_exception_type
    ...
    async def _async_request(
        ...
        try:
            ...
            async for attempt in AsyncRetrying(
                stop=stop_after_delay(self.timeout), retry=retry_if_not_exception_type(APIException), reraise=True
            ):
                with attempt:
