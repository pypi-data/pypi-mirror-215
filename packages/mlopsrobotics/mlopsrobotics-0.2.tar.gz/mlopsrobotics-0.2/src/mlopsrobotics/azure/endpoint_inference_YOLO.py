...
endpoint_name = "yolo-endpt-" + datetime.datetime.now().strftime("%m%d%H%M%f")
...
blue_deployment = ManagedOnlineDeployment(
    ...
    code_configuration=CodeConfiguration(
        code="./src", scoring_script="score_inference_YOLO.py"
    ),
