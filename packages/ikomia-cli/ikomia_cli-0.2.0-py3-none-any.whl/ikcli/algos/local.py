...
class Algo:
    ...
    def info(self) -> dict:
        ...
        data = {
            ...
            "ikomia_version": self._info.ikomia_version,
            "language": ProgrammingLanguages(self._info.language).name,
            "original_implementation_repository": self._info.repository,
        }
...
def get_platform_information() -> dict:
    ...
    return {
        "python_min_version": f"{major}.{minor}",  # Only give major + minor
