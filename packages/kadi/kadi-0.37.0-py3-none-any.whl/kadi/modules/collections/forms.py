...
class EditCollectionForm(BaseCollectionForm):
    ...
    def _check_template_permission(self, template):
        # See ".core.update_collection" on why this special check is done here.
        return (
