...
class SvmSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    anti_ransomware_auto_switch_from_learning_to_enabled = fields.Boolean(
...
* dry_run"""
    ...
    anti_ransomware_incoming_write_threshold = fields.Str(
    ...
    anti_ransomware_incoming_write_threshold_percent = fields.Str(
...
Example: svm1"""
    ...
    qos_adaptive_policy_group_template = fields.Nested("netapp_ontap.resources.qos_policy.QosPolicySchema", data_key="qos_adaptive_policy_group_template", unknown=EXCLUDE)
...
* deleting"""
    ...
    storage = fields.Nested("netapp_ontap.models.svm_storage.SvmStorageSchema", data_key="storage", unknown=EXCLUDE)
