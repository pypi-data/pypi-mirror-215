...
class KerberosRealmSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    admin_server = fields.Nested("netapp_ontap.models.kerberos_realm_admin_server.KerberosRealmAdminServerSchema", data_key="admin_server", unknown=EXCLUDE)
    ...
    password_server = fields.Nested("netapp_ontap.models.kerberos_realm_password_server.KerberosRealmPasswordServerSchema", data_key="password_server", unknown=EXCLUDE)
