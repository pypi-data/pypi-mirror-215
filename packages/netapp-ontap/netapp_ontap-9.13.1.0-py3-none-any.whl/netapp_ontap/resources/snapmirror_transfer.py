...
Example: 2020-12-03T02:36:19.000+0000"""
    ...
    network_compression_ratio = fields.Str(
...
Example: 4ea7a442-86d1-11e0-ae1c-123478563412"""
    ...
    """links,bytes_transferred,checkpoint_size,end_time,error_info,network_compression_ratio,on_demand_attrs,relationship,snapshot,state,throttle,total_duration,uuid,"""
    ...
    """error_info,on_demand_attrs,relationship,state,throttle,"""
    ...
    """error_info,files,on_demand_attrs,relationship,source_snapshot,storage_efficiency_enabled,throttle,"""
...
"""
    ...
    if RECLINE_INSTALLED:
        ...
        def snapmirror_transfer_show(
            ...
            fields: List[Choices.define(["bytes_transferred", "checkpoint_size", "end_time", "network_compression_ratio", "on_demand_attrs", "snapshot", "source_snapshot", "state", "storage_efficiency_enabled", "throttle", "total_duration", "uuid", "*"])]=None,
        ) -> ResourceTable:
