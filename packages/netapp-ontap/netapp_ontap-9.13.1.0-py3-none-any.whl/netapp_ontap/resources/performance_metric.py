    ...
    PerformanceMetric(
        {
            ...
            "iops": {"other": 0, "write": 5, "read": 1, "total": 6},
            "throughput": {"other": 0, "write": 205892, "read": 6826, "total": 212718},
            "latency": {"other": 0, "write": 216, "read": 148, "total": 199},
            "status": "ok",
        }
    )
]
    ...
    PerformanceMetric(
        {
            ...
            "iops": {"other": 0, "write": 26, "read": 18, "total": 45},
            "throughput": {
                "other": 0,
                "write": 5556255,
                "read": 268328,
            ...
            "latency": {"other": 0, "write": 430, "read": 156, "total": 318},
            "status": "ok",
        }
    ),
    PerformanceMetric(
        {
            ...
            "iops": {"other": 0, "write": 28, "read": 48, "total": 76},
            "throughput": {
                "other": 0,
                "write": 6121908,
                "read": 474266,
            ...
            "latency": {"other": 0, "write": 448, "read": 154, "total": 262},
            "status": "ok",
        }
    ),
    PerformanceMetric(
        {
            ...
            "iops": {"other": 437, "write": 16, "read": 94, "total": 548},
            "throughput": {
                "other": 26244685,
                "write": 2411356,
                "read": 540164,
            ...
            "latency": {"other": 192, "write": 394, "read": 159, "total": 193},
            "status": "ok",
        }
    ),
    PerformanceMetric(
        {
            ...
            "iops": {"other": 0, "write": 13, "read": 0, "total": 13},
            "throughput": {
                "other": 0,
                "write": 2765407,
                "read": 2842,
            ...
            "latency": {"other": 0, "write": 540, "read": 189, "total": 523},
            "status": "ok",
        }
    ),
]
