...
class ConsistencyGroupResponseRecordsVolumesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    r""" The activity_tracking field of the consistency_group_response_records_volumes. """
    ...
    r""" The analytics field of the consistency_group_response_records_volumes. """
