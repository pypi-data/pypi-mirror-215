...
class ConsistencyGroupConsistencyGroupsVolumesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    r""" The activity_tracking field of the consistency_group_consistency_groups_volumes. """
    ...
    r""" The analytics field of the consistency_group_consistency_groups_volumes. """
