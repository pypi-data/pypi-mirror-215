...
Example: 1 """
    ...
    parameter_criteria = fields.List(fields.Nested("netapp_ontap.models.ems_filter_rules_parameter_criteria.EmsFilterRulesParameterCriteriaSchema", unknown=EXCLUDE), data_key="parameter_criteria")
