...
Example: 1 """
    ...
    parameter_criteria = fields.List(fields.Nested("netapp_ontap.models.ems_filter_rule_parameter_criteria.EmsFilterRuleParameterCriteriaSchema", unknown=EXCLUDE), data_key="parameter_criteria")
