...
class ConsistencyGroupResponseRecordsSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    metric = fields.Nested("netapp_ontap.resources.consistency_group_metrics.ConsistencyGroupMetricsSchema", unknown=EXCLUDE, data_key="metric")
...
An NVMe namespace must be mapped to an NVMe subsystem to grant access to the subsystem's hosts. Hosts can then access the NVMe namespace and perform I/O using the NVMe over Fabrics protocol. """
    ...
    replication_relationships = fields.List(fields.Nested("netapp_ontap.models.consistency_group_replication_relationships1.ConsistencyGroupReplicationRelationships1Schema", unknown=EXCLUDE), data_key="replication_relationships")
...
This is the dedicated consistency group Snapshot copy policy, not an aggregation of the volume granular Snapshot copy policy. """
    ...
    statistics = fields.Nested("netapp_ontap.models.consistency_group_statistics.ConsistencyGroupStatisticsSchema", unknown=EXCLUDE, data_key="statistics")
