...
def get_html_2XX_only(url: str, config: Optional[Configuration] = None, response: Optional[Response] = None) -> str:
    """
    ...
    if response is not None:
        return _get_html_from_response(response=response, config=config)
