...
class Article(object):
    ...
    def __init__(self, *, url: str, title: str = '', source_url: str = '', config: Configuration = None, **kwargs):
        ...
        # Body text in Markdown format. If this works, we can depreciate the logic for getting
        # the body text from the html
        self.markdown = ''
    ...
    def parse(self) -> None:
        ...
        if self.top_node is not None:
            ...
            self.markdown = output_formatter.get_markdown(top_node=self.top_node, source_url=self.source_url)
            text, article_html = output_formatter.get_formatted(top_node=self.top_node)
