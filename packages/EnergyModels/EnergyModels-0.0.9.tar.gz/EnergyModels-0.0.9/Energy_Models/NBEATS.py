...
from tensorflow.keras.layers import Input, Dense, Lambda, Subtract, Add, Reshape,Flatten
...
class NBeatsNet:
    ...
    def __init__(self,
        ...
        if self.input_dim != self.output_dim:
            y_=Flatten()(y_)
            x_=Flatten()(x_)
            y_ = Dense(self.forecast_length, activation='sigmoid', name='reg_y')(y_)
            x_ = Dense(self.forecast_length, activation='sigmoid', name='reg_x')(x_)
