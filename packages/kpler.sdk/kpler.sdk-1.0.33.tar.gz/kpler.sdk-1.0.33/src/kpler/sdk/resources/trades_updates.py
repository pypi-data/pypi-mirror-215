...
class TradesUpdates(KplerClient):
    ...
    def get(
        ...
        Args:
            ...
            start_date: Optional[date] The starting point in time of the returned "diffs", in UTC 0 time. All diffs that have been computed strictly after that date will be returned. Note: a time window of 15 days of diffs are kept, you can't look before in the past
