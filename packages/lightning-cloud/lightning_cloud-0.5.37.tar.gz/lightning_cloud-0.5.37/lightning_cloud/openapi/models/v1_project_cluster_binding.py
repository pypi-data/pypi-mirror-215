...
class V1ProjectClusterBinding(object):
    ...
    swagger_types = {
        ...
        'project_id': 'str',
        'storage_usage_bytes': 'str',
        'storage_usage_updated_at': 'datetime',
        'updated_at': 'datetime'
    }
    ...
    attribute_map = {
        ...
        'storage_usage_updated_at': 'storageUsageUpdatedAt',
    ...
    def __init__(self,
                 ...
                 project_id: 'str' = None,
                 storage_usage_bytes: 'str' = None,
                 storage_usage_updated_at: 'datetime' = None,
        ...
        self._storage_usage_bytes = None
        self._storage_usage_updated_at = None
        ...
        if storage_usage_updated_at is not None:
            self.storage_usage_updated_at = storage_usage_updated_at
    ...
    @property
    def storage_usage_bytes(self) -> 'str':
        """Gets the storage_usage_bytes of this V1ProjectClusterBinding.  # noqa: E501


        :return: The storage_usage_bytes of this V1ProjectClusterBinding.  # noqa: E501
        :rtype: str
        """
        return self._storage_usage_bytes

    @storage_usage_bytes.setter
    def storage_usage_bytes(self, storage_usage_bytes: 'str'):
        """Sets the storage_usage_bytes of this V1ProjectClusterBinding.


        :param storage_usage_bytes: The storage_usage_bytes of this V1ProjectClusterBinding.  # noqa: E501
        :type: str
        """

        self._storage_usage_bytes = storage_usage_bytes

    @property
    def storage_usage_updated_at(self) -> 'datetime':
        """Gets the storage_usage_updated_at of this V1ProjectClusterBinding.  # noqa: E501


        :return: The storage_usage_updated_at of this V1ProjectClusterBinding.  # noqa: E501
        :rtype: datetime
        """
        return self._storage_usage_updated_at

    @storage_usage_updated_at.setter
    def storage_usage_updated_at(self, storage_usage_updated_at: 'datetime'):
        """Sets the storage_usage_updated_at of this V1ProjectClusterBinding.


        :param storage_usage_updated_at: The storage_usage_updated_at of this V1ProjectClusterBinding.  # noqa: E501
        :type: datetime
        """

        self._storage_usage_updated_at = storage_usage_updated_at
