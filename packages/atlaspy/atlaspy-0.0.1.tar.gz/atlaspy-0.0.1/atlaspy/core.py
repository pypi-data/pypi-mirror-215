...
def load_atlas_stls(atlas_name):
    ...
    stl_dir = pkg_resources.resource_filename('atlaspy', 'source_data/atlases/stls/' + atlas_name + '_stls')
...
def get_dataframe_from_nifti(atlas_name, nifti_path):
    atlas_dir = pkg_resources.resource_filename('atlaspy', '/source_data/atlases/niftis'+atlas_name+'.nii.gz')
