...
def get_velocity_ligands_spatial(
    ...
    result_ligands = velocity_ligands_spatial(adata,
                                              vclusters_of_interest = vclusters,
...
def velocity_ligands_spatial(adata,
                             vclusters_of_interest,
    ...
    spatially_interacting_ligands = adata.uns["entrain"]["spatially_interacting_ligands"]
    ...
    for i, vcluster in enumerate(vclusters_of_interest):
        test_ligands = spatially_interacting_ligands[vcluster]
