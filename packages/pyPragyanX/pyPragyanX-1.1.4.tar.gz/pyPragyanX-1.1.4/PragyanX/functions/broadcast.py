...
async def broadcast_(Pragyan, message):
    ...
    async for cht in Pragyan.get_dialogs():
          try:
                await Pragyan.send_message(cht.chat.id, msg, disable_web_page_preview=True)
                dn += 1
                await asyncio.sleep(0.1)
          except Exception as e:
              err += 1 
    return await Pragyan.send_message(ok, f"**• Broadcast Done** ✅ \n\n Chats: {dn} \n Failed In {err} chats")
