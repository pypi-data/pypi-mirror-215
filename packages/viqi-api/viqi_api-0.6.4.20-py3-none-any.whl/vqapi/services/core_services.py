...
class AdminProxy(FuturizedServiceProxy):
    ...
    def login_as(self, login_id: str, create:bool=False, close:bool=True) -> "BQSession":  # noqa: F821
        ...
        params= { 'create': str(create).lower(), close: str(close).lower() }
    ...
    def login_create(self, login_id: str, close:bool=True) -> "BQSession":  # noqa: F821
        ...
        Returns:
         a new BQSession
        """
        return self.login_as(login_id=login_id, create=True, close=close)
...
class BlobProxy(FuturizedServiceProxy):
    ...
    def unregister(self, path: str = None, resource: Metadoc = None):
        ...
        res = self.delete(posixpath.join("register", path))
