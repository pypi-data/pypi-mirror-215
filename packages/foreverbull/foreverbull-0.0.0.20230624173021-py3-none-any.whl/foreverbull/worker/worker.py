...
from foreverbull.broker.models.socket import Request, Response
...
class Worker:
    ...
    def _setup_function(self, func, parameters: List[models.Parameter]):
        func = partial(func)
    ...
    def _process_ohlc(self, ohlc: models.OHLC):
    ...
    def configure(self, configuration: models.Execution):
        ...
        while True:
            try:
                ...
                if request.task == "configure":
                    configuration = models.Execution(**request.data)
                    self.configuration = configuration
    ...
    def run_backtest(self):
        while True:
            try:
                ...
                order = self._process_ohlc(models.OHLC(**request.data))
