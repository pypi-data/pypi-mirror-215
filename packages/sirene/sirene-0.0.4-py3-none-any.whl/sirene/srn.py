...
class nfr_to_cnae: 
    ...
    def group_(self):
        ...
        agri = f_agricultura(self.ghg,self.year)
        agri['setor_nfr_0'] = 'agricultura'
        db = pd.concat([resi,ippu, lulucf, energia,agri], axis=0)
