...
class Command(BaseCommand):
    ...
    def update_device_ss_data(self, serial_number, pid, data):
        ...
        # Compare the releases to set the status for the desired release and the current release
    ...
    def update_device_sni_summary_data(self, device, pid, eox_data):
        ...
        if (
            ...
            ds.contract_supplier = "Cisco SNTC" if covered else "Not covered by any contract"
