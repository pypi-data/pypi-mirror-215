...
from layerx.datalake.constants import MetadataUploadType
from .keys import COLLECTION_NAME, FILES, IMAGES, IS_APPLY_TO_ALL_FILES, METADATA
...
class Metadata:
    ...
    """
    def upload_metadata_json(self, storage_base_path: str, file_path: str):
