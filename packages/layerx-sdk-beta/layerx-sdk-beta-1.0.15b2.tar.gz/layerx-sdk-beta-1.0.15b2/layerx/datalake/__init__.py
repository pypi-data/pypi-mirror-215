...
class DatalakeClient:
    ...
    def upload_metadata_from_json(
        ...
        response =  _metadata.upload_metadata_json(storage_base_path, file_path)
        print(response)
        return response
    ...
    def upload_metadata_from_metaObject(
        ...
        _metadata = Metadata(client=self)
        response = _metadata.upload_metadata_object(collection_name, metadata_object, is_apply_to_all_files)
        print(response)
        return response
