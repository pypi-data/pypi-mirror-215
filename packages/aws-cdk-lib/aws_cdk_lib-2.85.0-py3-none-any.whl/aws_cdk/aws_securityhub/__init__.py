    ...
    class AutomationRulesFindingFieldsUpdateProperty:
        def __init__(
            ...
            *,
            ...
            :param confidence: The rule action will update the ``Confidence`` field of a finding.
            :param criticality: The rule action will update the ``Criticality`` field of a finding.
            ...
            :param types: The rule action will update the ``Types`` field of a finding.
            :param user_defined_fields: The rule action will update the ``UserDefinedFields`` field of a finding.
            :param verification_state: The rule action will update the ``VerificationState`` field of a finding.
