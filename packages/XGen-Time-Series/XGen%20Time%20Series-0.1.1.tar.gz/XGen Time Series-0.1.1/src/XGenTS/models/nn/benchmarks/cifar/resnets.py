...
class Encoder_ResNet_AE_CIFAR(BaseEncoder):
    ...
    .. code-block::
        ...
        >>> from XGen.models.nn.benchmarks.cifar import Encoder_ResNet_AE_CIFAR
...
class Encoder_ResNet_VAE_CIFAR(BaseEncoder):
    ...
    .. code-block::
        ...
        >>> from XGen.models.nn.benchmarks.cifar import Encoder_ResNet_VAE_CIFAR
...
class Encoder_ResNet_SVAE_CIFAR(BaseEncoder):
    ...
    .. code-block::
        ...
        >>> from XGen.models.nn.benchmarks.cifar import Encoder_ResNet_SVAE_CIFAR
...
class Encoder_ResNet_VQVAE_CIFAR(BaseEncoder):
    ...
    .. code-block::
        ...
        >>> from XGen.models.nn.benchmarks.cifar import Encoder_ResNet_VQVAE_CIFAR
...
class Decoder_ResNet_AE_CIFAR(BaseDecoder):
    ...
    .. code-block::
        ...
        >>> from XGen.models.nn.benchmarks.cifar import Decoder_ResNet_AE_CIFAR
        >>> from XGen.models import VAEConfig
        >>> model_config = VAEConfig(input_dim=(3, 32, 32), latent_dim=16)
...
class Decoder_ResNet_VQVAE_CIFAR(BaseDecoder):
    ...
    .. code-block::
        ...
        >>> from XGen.models.nn.benchmarks.cifar import Decoder_ResNet_VQVAE_CIFAR
        >>> from XGen.models import VQVAEConfig
        >>> model_config = VQVAEConfig(input_dim=(3, 32, 32), latent_dim=16)
