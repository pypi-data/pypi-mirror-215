...
class Encoder_Conv_AE_CIFAR(BaseEncoder):
    ...
    .. code-block::
            ...
            >>> from XGen.models.nn.benchmarks.cifar import Encoder_Conv_AE_CIFAR
...
class Encoder_Conv_VAE_CIFAR(BaseEncoder):
    ...
    .. code-block::
            ...
            >>> from XGen.models.nn.benchmarks.cifar import Encoder_Conv_VAE_CIFAR
...
class Encoder_Conv_SVAE_CIFAR(BaseEncoder):
    ...
    .. code-block::
            ...
            >>> from XGen.models.nn.benchmarks.cifar import Encoder_Conv_SVAE_CIFAR
...
class Decoder_Conv_AE_CIFAR(BaseDecoder):
    ...
    .. code-block::
            ...
            >>> from XGen.models.nn.benchmarks.cifar import Decoder_Conv_AE_CIFAR
            >>> from XGen.models import VAEConfig
            >>> model_config = VAEConfig(input_dim=(3, 32, 32), latent_dim=16)
...
class Discriminator_Conv_CIFAR(BaseDiscriminator):
    ...
    .. code-block::
            ...
            >>> from XGen.models.nn.benchmarks.cifar import Discriminator_Conv_CIFAR
