...
This is an extension for `Disnake`. It is recommended that there exists an installation of `disnake>=2.7.0`.

To install this extension, run the following command:

```
# Linux/macOS
python3 -m pip install -U disnake-ext-i18n

# Windows
py -3 -m pip install -U disnake-ext-i18n
```
...
- Define a language getter function decorated with the `Detector.lang_getter` decorator
  ...
  language preference)
- Instantiate a `disnake.ext.i18n.Agent` class to configure and inject code
...
from disnake.ext.i18n import Agent, Language, Detector
...
1. [Get Started](https://github.com/Jaymart95/disnake-ext-i18n/blob/master/examples/get_started.py) - A minimal example on how to get started with the extension.
2. [Cog Example](https://github.com/Jaymart95/disnake-ext-i18n/blob/master/examples/cog_example.py) - Get started but inside a cog.
3. [Customized](https://github.com/Jaymart95/disnake-ext-i18n/blob/master/examples/customized.py) - An example on how to customize/make your own translator and override the default one.
4. [Settings](https://github.com/Jaymart95/disnake-ext-i18n/blob/master/examples/settings.py) - An example on how to enable/disable the extension from translating certain fields
5. [Optimized](https://github.com/Jaymart95/disnake-ext-i18n/blob/master/examples/optimized.py) - An example on how to ignore translation on parts of a string that is prone to change
6. [All Objects](https://github.com/Jaymart95/discdisnakeord-ext-i18n/blob/master/examples/all_objects.py) - A summary example of every object that is affected by translation + all features discussed prior
...
`translate_x` flag from the class. See detailed example [here](https://github.com/Jaymart95/disnake-ext-i18n/blob/master/examples/settings.py)
...
[here](https://github.com/Jaymart95/disnake-ext-i18n/blob/master/examples/customized.py).
...
code changes. One example is the command `selective` [here](https://github.com/Jaymart95/disnake-ext-i18n/blob/master/examples/settings.py).

---

#### Credits

[-] https://github.com/Rickaym/discord-ext-i18n
