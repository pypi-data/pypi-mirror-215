...
from ...conversion_common import JsonRecord, RecordExtractorDict
...
from ...integration.processor import AbstractSyncProcessor, ContextAwareObject
...
class SyncProcessor(AbstractSyncProcessor):
    """
    ...
    _table_def: Table
    _upsert_converters: RecordExtractorDict
    _delete_converters: RecordExtractorDict
