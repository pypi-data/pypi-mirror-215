...
class Processor(APScript):
    ...
    def __init__(
        ...
        personality_config_template = ConfigTemplate(
            [
                {"name":"database_path","type":"str","value":f"{self.personality.name}_db.json", "help":"Path to the database"},
                ...
                {"name":"chunk_overlap","type":"int","value":20, "min":10, "max":personality.config["ctx_size"],"help":"Overlap between chunks"},
        ...
        for file in self.files:
            try:
                ...
                try:
                    ...
                    chunk_size=512
                try:
                    overlap_size=int(self.personality_config["overlap_size"])
                except:
                    ASCIIColors.warning(f"Couldn't read chunk size. Verify your configuration file")
                    overlap_size=50
