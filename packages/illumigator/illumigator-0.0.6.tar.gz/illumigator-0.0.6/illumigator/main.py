...
class Character:
    def __init__(self, sprite_path, scale_factor=2, image_width=24, image_height=24,
        ...
        self.textures = []
        texture_right = arcade.load_texture('illumigator/assets/character_right.png')
        texture_left = arcade.load_texture('illumigator/assets/character_left.png')
...
class GameObject(arcade.Window):
    ...
    def setup(self):
        ...
        self.character = Character('illumigator/assets/character_right.png')
