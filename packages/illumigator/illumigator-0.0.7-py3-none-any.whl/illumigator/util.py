...
# ========================= Sprite Constants =========================
# World Objects
WALL_SPRITE_INFO: tuple = ("illumigator/assets/wall.png", 2, 16, 16)  # path, scale, width, height
MIRROR_SPRITE_INFO: tuple = ("illumigator/assets/mirror.png", 1.3, 9, 48)
RECEIVER_SPRITE_INFO: tuple = ("illumigator/assets/light_receiver.png", 2, 32, 32)
PLACEHOLDER_SPRITE_INFO: tuple = ("illumigator/assets/light_source.png", 2, 16, 16)

# Player
PLAYER_SPRITE_RIGHT = 'illumigator/assets/character_right.png'
PLAYER_SPRITE_LEFT = 'illumigator/assets/character_left.png'
