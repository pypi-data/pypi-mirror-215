...
"""try this to test 
from reports import monthly_ecommerce_overview, monthly_coupons_overview, monthly_google_ads_overview

# Replace these values by yours
service = "your_service"
view = "your_view"
start_date = "your_start_date"
end_date = "your_end_date"

df_ecommerce = monthly_ecommerce_overview(service, view, start_date, end_date)
df_coupons = monthly_coupons_overview(service, view, start_date, end_date)
df_ads = monthly_google_ads_overview(service, view, start_date, end_date)
"""