...
def download_and_full_analyse(download_params):
    ...
    local_datas_full_analyse(data_save_path, data_list, analysis_save_path=analysis_save_path, sleep_variables_save_name=sleep_variables_save_file_name, show_plots)
