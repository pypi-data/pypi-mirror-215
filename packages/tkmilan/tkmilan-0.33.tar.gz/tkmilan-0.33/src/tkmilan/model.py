...
There is no Python documentation, see ``Tk`` `trace validation modes <https://www.tcl.tk/man/tcl/TkCmd/ttk_entry.html#M35>`_ documentation.
'''
...
There is no Python documentation, see ``Tk`` `trace validation return mode <https://www.tcl.tk/man/tcl/TkCmd/ttk_entry.html#M49>`_ documentation.
'''
...
There is no Python documentation, see ``Tk`` `trace validation action type <https://www.tcl.tk/man/tcl/TkCmd/ttk_entry.html#M43>`_ documentation.
'''
...
class VWhy:
    ...
    There is no Python documentation, see ``Tk`` `trace validation <https://www.tcl.tk/man/tcl/TkCmd/ttk_entry.htm#M34>`_ documentation.
...
class VSettings:
    ...
    Parameters:
        ...
        tkWhen: Calculated ``Tk`` setting, based on the other parameters. See
            `validation modes <https://www.tcl.tk/man/tcl/TkCmd/ttk_entry.html#M35>`_
            documentation.
    '''
    # Native Validations
