...
** Install:
#+PROPERTY: header-args :eval always :exports both :results output  :python PYTHONPATH=../.. python -m p2g   gen  -
#+BEGIN_EXAMPLE
$ pip install p2g
#+END_EXAMPLE
for big show:
...
#+NAME: haas table
#+BEGIN_SRC python :exports results :output results :results raw replace
  import p2g
  p2g.gbl.config.in_pytest=True
  def pop():
