...
_colorThemeFunc1 = 0
_colorThemeFunc2 = 0
_colorBible = {"k": "", "v": "", "l": "", "d": "", "a": "", "o": "", "s": "", "2": "", "9": "", "1": "", "i": "", "y": "", "c": "", "j": "", "r": "", "HIGHLIGHT_SEARCH": ""}
_themeNr = None
...
def set_locale(locale):
    ...
    if locale == "en":
        _resource = {
            ...
            "ERR_KJV2000_LIMIT_500": "No more than 500 verses (c) KJV2000, RVA1989, LND1991, IRV2017, NJB1973",
            "ERR_KJV2000_LIMIT_FULLBOOK": "No full book (c) KJV2000, RVA1989, LND1991, IRV2017, NJB1973",
            "FILTER": "Filter",
            "FOUND": "Found",
            "HELP": "Help",
            "KEYS": "Keys",
...
def show_bible_preferred():
    ...
    if menu_item_selected < 0:
        ...
        _locale = "pt"
        _alt_locale = _locale
    elif menu_item_selected == 9:
        _bbName = "s"
        _locale = "de"
        _alt_locale = "en"
    elif menu_item_selected == 10:
        _bbName = "i"
        _locale = "in"
        _alt_locale = "en"
    elif menu_item_selected == 11:
        _bbName = "y"
        _locale = "ar"
        _alt_locale = "en"
    elif menu_item_selected == 12:
        _bbName = "c"
        _locale = "ch"
        _alt_locale = "en"
    elif menu_item_selected == 13:
        _bbName = "j"
        _locale = "jp"
        _alt_locale = "en"
    elif menu_item_selected == 14:
        _bbName = "r"
        _locale = "ru"
        _alt_locale = "en"
...
def show_bible_multi():
    ...
    dict_menu = {
        ...
        11: "(IN) Hindi Indian Revised Version 2017 (I)",
...
def show_bible_colors():
    ...
    dict_menu = get_bible_dict_verbose()
    dict_menu[15] = "(**) {0}".format(res("HIGHLIGHT_SEARCH"))
...
def generate_text_for_clipboard():
    try:
        ...
        for bib in range(0, len(bbnames_before_check)):
            ...
            if bbname_current_before_check in ("2", "9", "1", "i", "j"):
                warn_type = 0
        ...
        for i in range(0, len(bbnames)):
            ...
            if bbname == "2":
                bbnames_verbose = f"{bbnames_verbose}, KJV2000"
            if bbname == "9":
...
def get_bible_dict_verbose():
    return {
        ...
        10: "(IN) Hindi Indian Revised Version 2017 (I)",
...
def load_colors():
    ...
    _colorBible = {"k": color_k, "v": color_v, "l": color_l, "d": color_d, "a": color_a, "o": color_o, "s": color_s, "2": color_2, "9": color_9, "1": color_1, "i": color_i, "y": color_y, "c": color_c, "j": color_j, "r": color_r, "HIGHLIGHT_SEARCH": color_highlight_search}


def load_config():
    global _locale, _alt_locale, _useColors, _bbName, _tbbName, _history, _colorBible, _themeNr

    _locale = somconfig.get_option("PREFERENCES", "LOCALE", ("en", "es", "fr", "it", "pt", "de", "in", "ar", "ch", "jp", "ru"), "en")
    ...
    _bbName = somconfig.get_option("PREFERENCES", "BIBLE_PREFERED", ("k", "v", "l", "d", "a", "o", "s", "2", "9", "1", "i", "y", "c", "j", "r"), "k")
