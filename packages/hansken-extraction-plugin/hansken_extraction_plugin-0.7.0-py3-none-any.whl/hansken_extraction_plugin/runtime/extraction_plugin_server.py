...
class GrpcExtractionTraceBuilder(ExtractionTraceBuilder):
    ...
    def open(self, data_type: str = None, offset: int = 0, size: int = None, mode: Literal['rb', 'wb'] = 'rb') \
            -> Union[BufferedReader, BufferedWriter]:
...
class GrpcWriter(BufferedWriter):
    ...
    def write(self, buffer: Union[bytes, bytearray, memoryview, array, mmap], /) -> int:
        """
