...
class Seq2Seq_LSTM2:
    ...
    def __init__(self, config=None):
        ...
        self.epochs = config['epochs']  # Number of epochs to train for.
        self.units = config['units']  # no of lstm units
        self.name_model = 'LSTM2_RV_LSTM2'
...
class Seq2Seq_Conv1D_LSTM:
    ...
    def build_model(self):
        ...
        conv = tkl.Conv1D(filters=64, kernel_size=1, activation='relu')(inputs)  # padding = 'same'
        # conv = tkl.Conv1D(filters=64, kernel_size=6, activation='relu')(conv)
