...
from openpy_fxts.models.models_class import MyModel_exp1_hybrid_normal
from openpy_fxts.models.models_class import MyModel_exp1_hybrid_tf
from openpy_fxts.models.models_class import MyModel_exp1_separate_normal
from openpy_fxts.models.models_class import MyModel_exp1_separate_tf
from openpy_fxts.models.models_class import MyModel_exp1_shared_normal
from openpy_fxts.models.models_class import MyModel_exp1_shared_normal_luongs_concat_attention
from openpy_fxts.models.models_class import MyModel_exp1_shared_normal_luongs_dot_attention
from openpy_fxts.models.models_class import MyModel_exp1_shared_normal_luongs_general_attention
from openpy_fxts.models.models_class import MyModel_exp1_shared_tf
from openpy_fxts.models.models_class import MyModel_exp1_shared_tf_luongs_general_attention
from openpy_fxts.models.models_class import MyModel_exp1_shared_tf_luongs_concat_attention
from openpy_fxts.models.models_class import MyModel_exp1_shared_tf_luongs_dot_attention
...
class exp1_hybrid_normal:
    ...
    def build_model(self, filepath):
        ...
        model = MyModel_exp1_hybrid_normal(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        aux = exp1_hybrid_normal(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
...
class exp1_hybrid_tf:
    ...
    def prediction(self, model_new):
        aux = exp1_hybrid_tf(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class exp1_separate_normal:
    ...
    def build_model(self, filepath):
        ...
        train_dict, val_dict, _ = _scaler_data(train_dict, val_dict)
        model = MyModel_exp1_separate_normal(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        aux = exp1_separate_normal(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class exp1_separate_tf:
    ...
    def build_model(self, filepath):
        ...
        train_dict, val_dict, _ = _scaler_data(train_dict, val_dict)
        model = MyModel_exp1_separate_tf(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        aux = exp1_separate_tf(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class exp1_shared_normal:
    ...
    def build_model(self, filepath):
        ...
        train_dict, val_dict, _ = _scaler_data(train_dict, val_dict)
        model = MyModel_exp1_shared_normal(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        ...
        aux = exp1_shared_normal(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class exp1_shared_normal_luongs_concat_attention:
    ...
    def build_model(self, filepath):
        ...
        train_dict, val_dict, _ = _scaler_data(train_dict, val_dict)
        model = MyModel_exp1_shared_normal_luongs_concat_attention(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        ...
        aux = exp1_shared_normal_luongs_concat_attention(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class exp1_shared_normal_luongs_dot_attention:
    ...
    def build_model(self, filepath):
        ...
        train_dict, val_dict, _ = _scaler_data(train_dict, val_dict)
        model = MyModel_exp1_shared_normal_luongs_dot_attention(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        ...
        aux = exp1_shared_normal_luongs_dot_attention(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class exp1_shared_normal_luongs_general_attention:
    ...
    def build_model(self, filepath):
        ...
        train_dict, val_dict, _ = _scaler_data(train_dict, val_dict)
        model = MyModel_exp1_shared_normal_luongs_general_attention(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        ...
        aux = exp1_shared_normal_luongs_general_attention(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class exp1_shared_tf:
    ...
    def prediction(self, model_new):
        ...
        aux = exp1_shared_tf(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class exp1_shared_tf_luongs_general_attention:
    ...
    def build_model(self, filepath):
        ...
        model = MyModel_exp1_shared_tf_luongs_general_attention(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        ...
        aux = exp1_shared_tf_luongs_general_attention(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class exp1_shared_tf_luongs_concat_attention:
    ...
    def build_model(self, filepath):
        ...
        train_dict, val_dict, _ = _scaler_data(train_dict, val_dict)
        model = MyModel_exp1_shared_tf_luongs_concat_attention(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        ...
        aux = exp1_shared_tf_luongs_concat_attention(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class exp1_shared_tf_luongs_dot_attention:
    ...
    def build_model(self, filepath):
        ...
        model = MyModel_exp1_shared_tf_luongs_dot_attention(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        ...
        aux = exp1_shared_tf_luongs_dot_attention(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
