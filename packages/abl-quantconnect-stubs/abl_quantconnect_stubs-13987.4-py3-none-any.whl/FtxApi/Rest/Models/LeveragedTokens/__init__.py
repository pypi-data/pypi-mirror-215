...
while os.path.basename(current_path) != "FtxApi":
...
del sys.modules["FtxApi.Rest.Models.LeveragedTokens"]
from clr import AddReference
AddReference("FtxApi.Rest.Models.LeveragedTokens")
from FtxApi.Rest.Models.LeveragedTokens import *
