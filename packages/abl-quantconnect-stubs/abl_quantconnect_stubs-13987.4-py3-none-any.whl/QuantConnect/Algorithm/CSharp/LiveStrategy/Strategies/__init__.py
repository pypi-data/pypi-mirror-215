...
del sys.modules["QuantConnect.Algorithm.CSharp.LiveStrategy.Strategies"]
from clr import AddReference
AddReference("QuantConnect.Algorithm.CSharp.LiveStrategy.Strategies")
from QuantConnect.Algorithm.CSharp.LiveStrategy.Strategies import *
