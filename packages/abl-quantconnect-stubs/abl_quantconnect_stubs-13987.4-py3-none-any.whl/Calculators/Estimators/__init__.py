...
while os.path.basename(current_path) != "Calculators":
...
del sys.modules["Calculators.Estimators"]
from clr import AddReference
AddReference("Calculators.Estimators")
from Calculators.Estimators import *
