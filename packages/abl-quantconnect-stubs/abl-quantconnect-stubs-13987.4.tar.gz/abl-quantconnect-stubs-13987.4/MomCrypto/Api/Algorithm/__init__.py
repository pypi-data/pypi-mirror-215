...
while os.path.basename(current_path) != "MomCrypto":
...
del sys.modules["MomCrypto.Api.Algorithm"]
from clr import AddReference
AddReference("MomCrypto.Api.Algorithm")
from MomCrypto.Api.Algorithm import *
