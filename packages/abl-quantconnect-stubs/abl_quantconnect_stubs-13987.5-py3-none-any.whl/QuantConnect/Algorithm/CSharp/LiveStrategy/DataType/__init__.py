...
del sys.modules["QuantConnect.Algorithm.CSharp.LiveStrategy.DataType"]
from clr import AddReference
AddReference("QuantConnect.Algorithm.CSharp.LiveStrategy.DataType")
from QuantConnect.Algorithm.CSharp.LiveStrategy.DataType import *
