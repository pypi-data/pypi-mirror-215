...
while os.path.basename(current_path) != "MS":
...
del sys.modules["MS.Internal.Xml.Linq.ComponentModel"]
from clr import AddReference
AddReference("MS.Internal.Xml.Linq.ComponentModel")
from MS.Internal.Xml.Linq.ComponentModel import *
