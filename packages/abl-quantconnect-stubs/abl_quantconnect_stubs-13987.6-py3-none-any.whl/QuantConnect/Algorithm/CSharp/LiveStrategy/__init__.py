...
del sys.modules["QuantConnect.Algorithm.CSharp.LiveStrategy"]
from clr import AddReference
AddReference("QuantConnect.Algorithm.CSharp.LiveStrategy")
from QuantConnect.Algorithm.CSharp.LiveStrategy import *
