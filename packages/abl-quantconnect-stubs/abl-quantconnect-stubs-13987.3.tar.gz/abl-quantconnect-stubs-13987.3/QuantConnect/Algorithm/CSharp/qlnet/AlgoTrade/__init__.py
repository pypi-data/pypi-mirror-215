...
del sys.modules["QuantConnect.Algorithm.CSharp.qlnet.AlgoTrade"]
from clr import AddReference
AddReference("QuantConnect.Algorithm.CSharp.qlnet.AlgoTrade")
from QuantConnect.Algorithm.CSharp.qlnet.AlgoTrade import *
