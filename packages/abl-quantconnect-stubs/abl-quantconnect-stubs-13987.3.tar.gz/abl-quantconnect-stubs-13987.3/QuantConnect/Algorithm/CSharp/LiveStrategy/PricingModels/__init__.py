...
del sys.modules["QuantConnect.Algorithm.CSharp.LiveStrategy.PricingModels"]
from clr import AddReference
AddReference("QuantConnect.Algorithm.CSharp.LiveStrategy.PricingModels")
from QuantConnect.Algorithm.CSharp.LiveStrategy.PricingModels import *
