...
del sys.modules["QuantConnectStubsGenerator.Tests.Model"]
from clr import AddReference
AddReference("QuantConnectStubsGenerator.Tests.Model")
from QuantConnectStubsGenerator.Tests.Model import *
