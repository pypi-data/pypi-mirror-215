...
while os.path.basename(current_path) != "QuantConnectStubsGenerator":
...
del sys.modules["QuantConnectStubsGenerator.Tests.Utility"]
from clr import AddReference
AddReference("QuantConnectStubsGenerator.Tests.Utility")
from QuantConnectStubsGenerator.Tests.Utility import *
