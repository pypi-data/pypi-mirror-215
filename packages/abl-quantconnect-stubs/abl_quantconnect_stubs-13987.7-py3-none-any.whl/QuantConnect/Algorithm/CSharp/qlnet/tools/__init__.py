...
del sys.modules["QuantConnect.Algorithm.CSharp.qlnet.tools"]
from clr import AddReference
AddReference("QuantConnect.Algorithm.CSharp.qlnet.tools")
from QuantConnect.Algorithm.CSharp.qlnet.tools import *
