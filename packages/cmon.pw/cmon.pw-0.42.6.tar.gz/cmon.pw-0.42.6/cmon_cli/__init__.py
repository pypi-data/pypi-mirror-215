...
def _get_run_args(print_args: bool = True):
    ...
    if len(sys.argv) > 1:
        ...
        if unknown:
            from cmon.helper import warn_unknown_args
...
def _try_plugin_command():
    """Tries to call the CLI of an external Cmon project.
    ...
    from cmon_cli.known_plugins import plugin_info
    ...
    if subcommand in plugin_info:
        ...
        console.print(
            ...
            f"To use it via the [green]'cmon {subcommand}'[/green] command, "
