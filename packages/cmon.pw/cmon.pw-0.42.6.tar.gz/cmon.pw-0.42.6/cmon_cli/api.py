...
def executor_native(args: 'Namespace'):
    ...
    :param args: arguments coming from the CLI.
    """
    from cmon.serve.executors.run import run, run_stateful
...
def dryrun(args: 'Namespace'):
    ...
    :param args: arguments coming from the CLI.
    """
    from cmon.checker import dry_run_checker
...
def help(args: 'Namespace'):
    """
    Lookup the usage of certain argument in Cmon API.

    :param args: arguments coming from the CLI.
    """
    from cmon_cli.lookup import lookup_and_print
...
def cloud(args: 'Namespace'):
    """
    Use jcloud (Cmon Cloud) commands
    :param args: arguments coming from the CLI.
    """
