...
if sys.version_info < (3, 7, 0):
    raise OSError(f'Cmon requires Python >=3.7, but yours is {sys.version}')
...
def register_ac():
    ...
    home = str(Path.home())
    resource_path = 'cmon/resources/completions/cmon.%s'
    regex = r'#\sCMON_CLI_BEGIN(.*)#\sCMON_CLI_END'
...
# Use env var to enable a minimum installation of Cmon
# CMON_PIP_INSTALL_CORE=1 pip install cmon
# CMON_PIP_INSTALL_PERF=1 pip install cmon
if os.environ.get('CMON_PIP_INSTALL_CORE'):
    final_deps = core_deps
elif os.environ.get('CMON_PIP_INSTALL_PERF'):
...
setup(
    ...
    project_urls={
        ...
        'Source': 'https://github.com/alinooriyan/cmon.pw/',
        'Tracker': 'https://github.com/alinooriyan/cmon.pw/issues',
    },
