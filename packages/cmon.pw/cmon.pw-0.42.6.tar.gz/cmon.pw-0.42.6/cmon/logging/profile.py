...
from cmon.helper import get_readable_size, get_readable_time, colored, get_rich_console
...
class ProgressBar(Progress):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Init a custom progress bar based on rich. This is the default progress bar of cmon if you want to  customize
...
class _OnDoneColumn(ProgressColumn):
    """Renders custom on done for cmon progress bar."""
...
class TimeContext:
    ...
    def __init__(self, task_name: str, logger: 'CmonLogger' = None):
        """
