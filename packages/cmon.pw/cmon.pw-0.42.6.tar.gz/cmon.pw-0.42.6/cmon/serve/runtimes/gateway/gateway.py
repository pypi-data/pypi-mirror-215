...
from cmon.serve.helper import store_init_kwargs, wrap_func
...
class BaseGateway(JAMLCompatible, metaclass=GatewayType):
    """
    The base class of all custom Gateways, can be used to build a custom interface to a Cmon Flow that supports
    gateway logic
    """
