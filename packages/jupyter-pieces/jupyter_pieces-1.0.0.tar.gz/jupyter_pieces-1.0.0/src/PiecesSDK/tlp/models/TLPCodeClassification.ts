...
export function TLPCodeClassificationFromJSON(
    json: any
): TLPCodeClassification {
    return TLPCodeClassificationFromJSONTyped(json, false);
}

export function TLPCodeClassificationFromJSONTyped(
    json: any,
...
export function TLPCodeClassificationToJSON(
    value?: TLPCodeClassification | null
): any {
    if (value === undefined) {
        return undefined;
    }
