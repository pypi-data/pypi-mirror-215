...
export function TLPLanguageDescriptorFromJSON(
    json: any
): TLPLanguageDescriptor {
    return TLPLanguageDescriptorFromJSONTyped(json, false);
}

export function TLPLanguageDescriptorFromJSONTyped(
    json: any,
...
export function TLPLanguageDescriptorToJSON(
    value?: TLPLanguageDescriptor | null
): any {
    if (value === undefined) {
        return undefined;
    }
