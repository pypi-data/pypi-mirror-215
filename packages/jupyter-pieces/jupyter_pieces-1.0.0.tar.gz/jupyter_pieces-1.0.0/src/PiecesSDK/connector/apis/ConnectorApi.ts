...
export class ConnectorApi extends runtime.BaseAPI {
    ...
    ): Promise<runtime.ApiResponse<Searched>> {
        if (
            requestParameters.application === null ||
            requestParameters.application === undefined
        ) {
     ...
     */
    async snapshotRaw(
        requestParameters: SnapshotRequest
    ): Promise<runtime.ApiResponse<ConnectorSnapshot>> {
        if (
            requestParameters.application === null ||
            requestParameters.application === undefined
        ) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) =>
            ConnectorSnapshotFromJSON(jsonValue)
        );
    }
