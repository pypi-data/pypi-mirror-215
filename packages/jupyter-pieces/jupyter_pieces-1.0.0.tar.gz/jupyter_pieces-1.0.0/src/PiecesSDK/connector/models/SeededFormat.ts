    ...
    return {
        ...
        websites:
            value.websites === undefined
                ? undefined
                : (value.websites as Array<any>).map(SeededWebsiteToJSON),
        classification: SeededClassificationToJSON(value.classification),
        tags:
            value.tags === undefined
                ? undefined
                : (value.tags as Array<any>).map(SeededTagToJSON),
    };
}
