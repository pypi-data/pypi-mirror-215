...
export function AnalyticsTrackedKeyboardEventFromJSON(
    json: any
): AnalyticsTrackedKeyboardEvent {
    return AnalyticsTrackedKeyboardEventFromJSONTyped(json, false);
}

export function AnalyticsTrackedKeyboardEventFromJSONTyped(
    json: any,
...
export function AnalyticsTrackedKeyboardEventToJSON(
    value?: AnalyticsTrackedKeyboardEvent | null
): any {
    if (value === undefined) {
        return undefined;
    }
