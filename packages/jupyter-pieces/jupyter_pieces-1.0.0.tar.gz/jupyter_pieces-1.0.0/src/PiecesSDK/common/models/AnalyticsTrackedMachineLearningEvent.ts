...
export function AnalyticsTrackedMachineLearningEventFromJSON(
    json: any
): AnalyticsTrackedMachineLearningEvent {
    return AnalyticsTrackedMachineLearningEventFromJSONTyped(json, false);
}

export function AnalyticsTrackedMachineLearningEventFromJSONTyped(
    json: any,
...
export function AnalyticsTrackedMachineLearningEventToJSON(
    value?: AnalyticsTrackedMachineLearningEvent | null
): any {
    if (value === undefined) {
        return undefined;
    }
