...
export function AnalyticsTrackedSessionEventIdentifierDescriptionPairsFromJSON(
    json: any
): AnalyticsTrackedSessionEventIdentifierDescriptionPairs {
    return AnalyticsTrackedSessionEventIdentifierDescriptionPairsFromJSONTyped(
        json,
        false
    );
}

export function AnalyticsTrackedSessionEventIdentifierDescriptionPairsFromJSONTyped(
    json: any,
...
export function AnalyticsTrackedSessionEventIdentifierDescriptionPairsToJSON(
    value?: AnalyticsTrackedSessionEventIdentifierDescriptionPairs | null
): any {
    if (value === undefined) {
        return undefined;
    }
