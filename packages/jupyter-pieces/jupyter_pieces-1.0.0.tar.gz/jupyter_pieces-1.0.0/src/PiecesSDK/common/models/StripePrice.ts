...
export function StripePriceFromJSONTyped(
    json: any,
    ...
    return {
        ...
        taxBehavior: !exists(json, 'tax_behavior')
            ? undefined
            : json['tax_behavior'],
        tiers: !exists(json, 'tiers')
            ? undefined
            : (json['tiers'] as Array<any>).map(StripePriceTierFromJSON),
        tiersMode: !exists(json, 'tiers_mode') ? undefined : json['tiers_mode'],
        type: json['type'],
        unitAmount: !exists(json, 'unit_amount')
            ? undefined
            : json['unit_amount'],
        unitAmountDecimal: !exists(json, 'unit_amount_decimal')
            ? undefined
            : json['unit_amount_decimal'],
    };
}
    ...
    return {
        ...
        tiers:
            value.tiers === undefined
                ? undefined
                : (value.tiers as Array<any>).map(StripePriceTierToJSON),
