...
export function SeededTrackedAssetEventMetadataFromJSON(
    json: any
): SeededTrackedAssetEventMetadata {
    return SeededTrackedAssetEventMetadataFromJSONTyped(json, false);
}

export function SeededTrackedAssetEventMetadataFromJSONTyped(
    json: any,
...
export function SeededTrackedAssetEventMetadataToJSON(
    value?: SeededTrackedAssetEventMetadata | null
): any {
    if (value === undefined) {
        return undefined;
    }
