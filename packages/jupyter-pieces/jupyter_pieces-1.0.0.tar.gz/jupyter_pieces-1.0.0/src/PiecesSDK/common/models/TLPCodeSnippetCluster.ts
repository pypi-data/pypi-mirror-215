...
export function TLPCodeSnippetClusterFromJSON(
    json: any
): TLPCodeSnippetCluster {
    return TLPCodeSnippetClusterFromJSONTyped(json, false);
}

export function TLPCodeSnippetClusterFromJSONTyped(
    json: any,
...
export function TLPCodeSnippetClusterToJSON(
    value?: TLPCodeSnippetCluster | null
): any {
    if (value === undefined) {
        return undefined;
    }
