...
export function TLPCodeSnippetTagifyNamedColorFromJSON(
    json: any
): TLPCodeSnippetTagifyNamedColor {
    return TLPCodeSnippetTagifyNamedColorFromJSONTyped(json, false);
}

export function TLPCodeSnippetTagifyNamedColorFromJSONTyped(
    json: any,
...
export function TLPCodeSnippetTagifyNamedColorToJSON(
    value?: TLPCodeSnippetTagifyNamedColor | null
): any {
    if (value === undefined) {
        return undefined;
    }
