...
export function TLPLanguageMapFromJSONTyped(
    json: any,
    ...
    return {
        batchfile: !exists(json, 'batchfile')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['batchfile']),
        c: !exists(json, 'c')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['c']),
        coffeescript: !exists(json, 'coffeescript')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['coffeescript']),
        cpp: !exists(json, 'cpp')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['cpp']),
        csharp: !exists(json, 'csharp')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['csharp']),
        css: !exists(json, 'css')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['css']),
        dart: !exists(json, 'dart')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['dart']),
        erlang: !exists(json, 'erlang')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['erlang']),
        go: !exists(json, 'go')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['go']),
        haskell: !exists(json, 'haskell')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['haskell']),
        html: !exists(json, 'html')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['html']),
        java: !exists(json, 'java')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['java']),
        javascript: !exists(json, 'javascript')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['javascript']),
        lua: !exists(json, 'lua')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['lua']),
        markdown: !exists(json, 'markdown')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['markdown']),
        matlab: !exists(json, 'matlab')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['matlab']),
        objectivec: !exists(json, 'objectivec')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['objectivec']),
        perl: !exists(json, 'perl')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['perl']),
        php: !exists(json, 'php')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['php']),
        powershell: !exists(json, 'powershell')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['powershell']),
        python: !exists(json, 'python')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['python']),
        r: !exists(json, 'r')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['r']),
        ruby: !exists(json, 'ruby')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['ruby']),
        rust: !exists(json, 'rust')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['rust']),
        scala: !exists(json, 'scala')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['scala']),
        shellscript: !exists(json, 'shellscript')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['shellscript']),
        sql: !exists(json, 'sql')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['sql']),
        swift: !exists(json, 'swift')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['swift']),
        tex: !exists(json, 'tex')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['tex']),
        typescript: !exists(json, 'typescript')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['typescript']),
        toml: !exists(json, 'toml')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['toml']),
        yaml: !exists(json, 'yaml')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['yaml']),
        json: !exists(json, 'json')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['json']),
        groovy: !exists(json, 'groovy')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['groovy']),
        kotlin: !exists(json, 'kotlin')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['kotlin']),
        emacslisp: !exists(json, 'emacslisp')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['emacslisp']),
        clojure: !exists(json, 'clojure')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['clojure']),
        elixir: !exists(json, 'elixir')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['elixir']),
        xml: !exists(json, 'xml')
            ? undefined
            : TLPLanguageDescriptorFromJSON(json['xml']),
    };
}
