...
export function AnalyticsTrackedGlobalEventFromJSON(
    json: any
): AnalyticsTrackedGlobalEvent {
    return AnalyticsTrackedGlobalEventFromJSONTyped(json, false);
}

export function AnalyticsTrackedGlobalEventFromJSONTyped(
    json: any,
...
export function AnalyticsTrackedGlobalEventToJSON(
    value?: AnalyticsTrackedGlobalEvent | null
): any {
    if (value === undefined) {
        return undefined;
    }
