...
export function AnalyticsTrackedInteractionEventFromJSON(
    json: any
): AnalyticsTrackedInteractionEvent {
    return AnalyticsTrackedInteractionEventFromJSONTyped(json, false);
}

export function AnalyticsTrackedInteractionEventFromJSONTyped(
    json: any,
...
export function AnalyticsTrackedInteractionEventToJSON(
    value?: AnalyticsTrackedInteractionEvent | null
): any {
    if (value === undefined) {
        return undefined;
    }
