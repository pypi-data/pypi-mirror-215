...
/**
 * This is currently only used within /assets/steam/identifiers but can be used with other as well, if we want to expand this class. && expand the StreamedIdentifier class.
 * @export
