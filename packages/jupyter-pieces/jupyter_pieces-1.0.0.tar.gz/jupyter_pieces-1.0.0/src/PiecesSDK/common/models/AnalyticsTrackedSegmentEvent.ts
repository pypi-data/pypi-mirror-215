...
export function AnalyticsTrackedSegmentEventFromJSON(
    json: any
): AnalyticsTrackedSegmentEvent {
    return AnalyticsTrackedSegmentEventFromJSONTyped(json, false);
}

export function AnalyticsTrackedSegmentEventFromJSONTyped(
    json: any,
    ...
    return {
        ...
        integrations: AnalyticsTrackedSegmentEventIntegrationsFromJSON(
            json['integrations']
        ),
        properties: AnalyticsTrackedSegmentEventPropertiesFromJSON(
            json['properties']
        ),
...
export function AnalyticsTrackedSegmentEventToJSON(
    value?: AnalyticsTrackedSegmentEvent | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        integrations: AnalyticsTrackedSegmentEventIntegrationsToJSON(
            value.integrations
        ),
        properties: AnalyticsTrackedSegmentEventPropertiesToJSON(
            value.properties
        ),
