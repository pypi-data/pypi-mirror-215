...
export function AnalyticsTrackedAssetsEventFromJSON(
    json: any
): AnalyticsTrackedAssetsEvent {
    return AnalyticsTrackedAssetsEventFromJSONTyped(json, false);
}

export function AnalyticsTrackedAssetsEventFromJSONTyped(
    json: any,
    ...
    return {
        ...
        metadata: !exists(json, 'metadata')
            ? undefined
            : AnalyticsTrackedAssetsEventMetadataFromJSON(json['metadata']),
    };
}

export function AnalyticsTrackedAssetsEventToJSON(
    value?: AnalyticsTrackedAssetsEvent | null
): any {
    if (value === undefined) {
        return undefined;
    }
