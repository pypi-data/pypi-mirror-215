...
export function ApigeeSyncAuthorizationFromJSON(
    json: any
): ApigeeSyncAuthorization {
    return ApigeeSyncAuthorizationFromJSONTyped(json, false);
}

export function ApigeeSyncAuthorizationFromJSONTyped(
    json: any,
...
export function ApigeeSyncAuthorizationToJSON(
    value?: ApigeeSyncAuthorization | null
): any {
    if (value === undefined) {
        return undefined;
    }
