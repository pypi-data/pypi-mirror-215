...
export function StripeAnyEventDataFromJSONTyped(
    json: any,
    ...
    return {
        ...
        metadata: !exists(json, 'metadata')
            ? undefined
            : RuntimeStripeAnyMetadataFromJSON(json['metadata']),
        shippable: !exists(json, 'shippable') ? undefined : json['shippable'],
        statementDescriptor: !exists(json, 'statement_descriptor')
            ? undefined
        ...
        address: !exists(json, 'address')
            ? undefined
            : StripeAddressFromJSON(json['address']),
        balance: !exists(json, 'balance') ? undefined : json['balance'],
        currency: !exists(json, 'currency') ? undefined : json['currency'],
        delinquent: !exists(json, 'delinquent')
            ? undefined
            : json['delinquent'],
        ...
        invoicePrefix: !exists(json, 'invoice_prefix')
            ? undefined
            : json['invoice_prefix'],
        invoiceSettings: !exists(json, 'invoice_settings')
            ? undefined
            : StripeInvoiceSettingCustomerSettingFromJSON(
                  json['invoice_settings']
              ),
        name: !exists(json, 'name') ? undefined : json['name'],
        nextInvoiceSequence: !exists(json, 'next_invoice_sequence')
            ? undefined
            : json['next_invoice_sequence'],
        phone: !exists(json, 'phone') ? undefined : json['phone'],
        preferredLocales: !exists(json, 'preferred_locales')
            ? undefined
            : json['preferred_locales'],
        shipping: !exists(json, 'shipping')
            ? undefined
            : StripeShippingFromJSON(json['shipping']),
        taxExempt: !exists(json, 'tax_exempt') ? undefined : json['tax_exempt'],
        applicationFeePercent: !exists(json, 'application_fee_percent')
            ? undefined
            : json['application_fee_percent'],
        automaticTax: !exists(json, 'automatic_tax')
            ? undefined
            : StripeAutomaticTaxFromJSON(json['automatic_tax']),
        billingCycleAnchor: !exists(json, 'billing_cycle_anchor')
            ? undefined
            : json['billing_cycle_anchor'],
        cancelAt: !exists(json, 'cancel_at') ? undefined : json['cancel_at'],
        cancelAtPeriodEnd: !exists(json, 'cancel_at_period_end')
            ? undefined
            : json['cancel_at_period_end'],
        canceledAt: !exists(json, 'canceled_at')
            ? undefined
            : json['canceled_at'],
        collectionMethod: !exists(json, 'collection_method')
            ? undefined
            : json['collection_method'],
        created: !exists(json, 'created') ? undefined : json['created'],
        currentPeriodEnd: !exists(json, 'current_period_end')
            ? undefined
            : json['current_period_end'],
        currentPeriodStart: !exists(json, 'current_period_start')
            ? undefined
            : json['current_period_start'],
        customer: !exists(json, 'customer') ? undefined : json['customer'],
        daysUntilDue: !exists(json, 'days_until_due')
            ? undefined
            : json['days_until_due'],
        defaultPaymentMethod: !exists(json, 'default_payment_method')
            ? undefined
            : json['default_payment_method'],
        defaultSource: !exists(json, 'default_source')
            ? undefined
            : json['default_source'],
        ...
        items: !exists(json, 'items')
            ? undefined
            : SubscriptionItemListFromJSON(json['items']),
        livemode: !exists(json, 'livemode') ? undefined : json['livemode'],
        nextPendingInvoiceItemInvoice: !exists(
            json,
        ...
        pendingSetupIntent: !exists(json, 'pending_setup_intent')
            ? undefined
            : json['pending_setup_intent'],
        pendingUpdate: !exists(json, 'pending_update')
            ? undefined
            : json['pending_update'],
        ...
        trialStart: !exists(json, 'trial_start')
            ? undefined
            : json['trial_start'],
    };
}

export function StripeAnyEventDataToJSON(
    value?: StripeAnyEventData | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        invoice_settings: StripeInvoiceSettingCustomerSettingToJSON(
