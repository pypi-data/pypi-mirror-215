...
export function ReleasePackagesFromJSONTyped(
    json: any,
    ...
    return {
        ...
        pkg: !exists(json, 'pkg')
            ? undefined
            : BuildPackagesFromJSON(json['pkg']),
        zip: !exists(json, 'zip')
            ? undefined
            : BuildPackagesFromJSON(json['zip']),
        linux: !exists(json, 'linux')
            ? undefined
            : BuildPackagesFromJSON(json['linux']),
        snap: !exists(json, 'snap')
            ? undefined
            : BuildPackagesFromJSON(json['snap']),
        macos: !exists(json, 'macos')
            ? undefined
            : BuildPackagesFromJSON(json['macos']),
        windows: !exists(json, 'windows')
            ? undefined
            : BuildPackagesFromJSON(json['windows']),
        windowsMsix: !exists(json, 'windows-msix')
            ? undefined
            : BuildPackagesFromJSON(json['windows-msix']),
        tarGz: !exists(json, 'tar.gz')
            ? undefined
            : BuildPackagesFromJSON(json['tar.gz']),
        appinstaller: !exists(json, 'appinstaller')
            ? undefined
            : BuildPackagesFromJSON(json['appinstaller']),
        crx: !exists(json, 'crx')
            ? undefined
            : BuildPackagesFromJSON(json['crx']),
        sublimePackage: !exists(json, 'sublime_package')
            ? undefined
            : BuildPackagesFromJSON(json['sublime_package']),
        vsix: !exists(json, 'vsix')
            ? undefined
            : BuildPackagesFromJSON(json['vsix']),
        dmg: !exists(json, 'dmg')
            ? undefined
            : BuildPackagesFromJSON(json['dmg']),
        vsixDarwinArm64: !exists(json, 'vsix-darwin-arm64')
            ? undefined
            : BuildPackagesFromJSON(json['vsix-darwin-arm64']),
        vsixDarwinX64: !exists(json, 'vsix-darwin-x64')
            ? undefined
            : BuildPackagesFromJSON(json['vsix-darwin-x64']),
        vsixLinuxX64: !exists(json, 'vsix-linux-x64')
            ? undefined
            : BuildPackagesFromJSON(json['vsix-linux-x64']),
        vsixWin32X64: !exists(json, 'vsix-win32-x64')
            ? undefined
            : BuildPackagesFromJSON(json['vsix-win32-x64']),
        macosArm64: !exists(json, 'macos-arm64')
            ? undefined
            : BuildPackagesFromJSON(json['macos-arm64']),
        dmgArm64: !exists(json, 'dmg-arm64')
            ? undefined
            : BuildPackagesFromJSON(json['dmg-arm64']),
    };
}
