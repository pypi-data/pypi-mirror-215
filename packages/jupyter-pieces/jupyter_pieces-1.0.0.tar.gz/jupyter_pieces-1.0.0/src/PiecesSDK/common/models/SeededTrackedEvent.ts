...
export function SeededTrackedEventFromJSONTyped(
    json: any,
    ...
    return {
        ...
        ml: !exists(json, 'ml')
            ? undefined
            : AnalyticsTrackedMachineLearningEventFromJSON(json['ml']),
        adoption: !exists(json, 'adoption')
            ? undefined
            : AnalyticsTrackedAdoptionEventFromJSON(json['adoption']),
    };
}

export function SeededTrackedEventToJSON(
    value?: SeededTrackedEvent | null
): any {
    if (value === undefined) {
        return undefined;
    }
