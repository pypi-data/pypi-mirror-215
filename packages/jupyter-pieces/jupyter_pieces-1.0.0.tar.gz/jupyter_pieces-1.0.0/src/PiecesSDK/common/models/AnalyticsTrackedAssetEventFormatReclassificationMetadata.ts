...
export function AnalyticsTrackedAssetEventFormatReclassificationMetadataFromJSON(
    json: any
): AnalyticsTrackedAssetEventFormatReclassificationMetadata {
    return AnalyticsTrackedAssetEventFormatReclassificationMetadataFromJSONTyped(
        json,
        false
    );
}

export function AnalyticsTrackedAssetEventFormatReclassificationMetadataFromJSONTyped(
    json: any,
...
export function AnalyticsTrackedAssetEventFormatReclassificationMetadataToJSON(
    value?: AnalyticsTrackedAssetEventFormatReclassificationMetadata | null
): any {
    if (value === undefined) {
        return undefined;
    }
