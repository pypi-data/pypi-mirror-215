...
export function StripeSubscriptionItemFromJSON(
    json: any
): StripeSubscriptionItem {
    return StripeSubscriptionItemFromJSONTyped(json, false);
}

export function StripeSubscriptionItemFromJSONTyped(
    json: any,
...
export function StripeSubscriptionItemToJSON(
    value?: StripeSubscriptionItem | null
): any {
    if (value === undefined) {
        return undefined;
    }
