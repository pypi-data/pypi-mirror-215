...
export function ApigeeOperationConfigFromJSON(
    json: any
): ApigeeOperationConfig {
    return ApigeeOperationConfigFromJSONTyped(json, false);
}

export function ApigeeOperationConfigFromJSONTyped(
    json: any,
    ...
    return {
        ...
        operations: !exists(json, 'operations')
            ? undefined
            : (json['operations'] as Array<any>).map(ApigeeOperationFromJSON),
        quota: !exists(json, 'quota')
            ? undefined
            : ApigeeQuotaFromJSON(json['quota']),
    };
}

export function ApigeeOperationConfigToJSON(
    value?: ApigeeOperationConfig | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        operations:
            value.operations === undefined
                ? undefined
                : (value.operations as Array<any>).map(ApigeeOperationToJSON),
