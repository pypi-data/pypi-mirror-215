...
export function TrackedSegmentEventIntegrationsFromJSON(
    json: any
): TrackedSegmentEventIntegrations {
    return TrackedSegmentEventIntegrationsFromJSONTyped(json, false);
}

export function TrackedSegmentEventIntegrationsFromJSONTyped(
    json: any,
...
export function TrackedSegmentEventIntegrationsToJSON(
    value?: TrackedSegmentEventIntegrations | null
): any {
    if (value === undefined) {
        return undefined;
    }
