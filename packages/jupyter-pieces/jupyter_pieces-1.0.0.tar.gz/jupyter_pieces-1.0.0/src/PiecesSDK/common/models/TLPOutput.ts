...
export function TLPOutputFromJSONTyped(
    json: any,
    ...
    return {
        ...
        codeClassification: TLPCodeClassificationFromJSON(
            json['codeClassification']
        ),
        ...
        title: !exists(json, 'title')
            ? undefined
            : TLPTitleFromJSON(json['title']),
        queries: !exists(json, 'queries')
            ? undefined
            : TLPSearchQueriesFromJSON(json['queries']),
    };
}
...
export function TLPOutputToJSON(value?: TLPOutput | null): any {
    ...
    return {
        ...
        codeClassification: TLPCodeClassificationToJSON(
