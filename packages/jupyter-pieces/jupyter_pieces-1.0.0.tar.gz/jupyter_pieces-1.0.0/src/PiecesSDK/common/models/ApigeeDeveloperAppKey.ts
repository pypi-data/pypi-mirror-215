...
export function ApigeeDeveloperAppKeyFromJSON(
    json: any
): ApigeeDeveloperAppKey {
    return ApigeeDeveloperAppKeyFromJSONTyped(json, false);
}

export function ApigeeDeveloperAppKeyFromJSONTyped(
    json: any,
    ...
    return {
        ...
        consumerKey: !exists(json, 'consumerKey')
            ? undefined
            : json['consumerKey'],
        consumerSecret: !exists(json, 'consumerSecret')
            ? undefined
            : json['consumerSecret'],
        expiresAt: !exists(json, 'expiresAt') ? undefined : json['expiresAt'],
        expiresInSeconds: !exists(json, 'expiresInSeconds')
            ? undefined
...
export function ApigeeDeveloperAppKeyToJSON(
    value?: ApigeeDeveloperAppKey | null
): any {
    if (value === undefined) {
        return undefined;
    }
