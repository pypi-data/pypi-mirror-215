...
export function ApigeeGraphQLOperationConfigFromJSON(
    json: any
): ApigeeGraphQLOperationConfig {
    return ApigeeGraphQLOperationConfigFromJSONTyped(json, false);
}

export function ApigeeGraphQLOperationConfigFromJSONTyped(
    json: any,
    ...
    return {
        ...
        operations: !exists(json, 'operations')
            ? undefined
            : (json['operations'] as Array<any>).map(
                  ApigeeGraphQLOperationFromJSON
              ),
...
export function ApigeeGraphQLOperationConfigToJSON(
    value?: ApigeeGraphQLOperationConfig | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        operations:
            value.operations === undefined
                ? undefined
                : (value.operations as Array<any>).map(
                      ApigeeGraphQLOperationToJSON
                  ),
