...
export function GoogleRpcPreconditionFailureViolationFromJSON(
    json: any
): GoogleRpcPreconditionFailureViolation {
    return GoogleRpcPreconditionFailureViolationFromJSONTyped(json, false);
}

export function GoogleRpcPreconditionFailureViolationFromJSONTyped(
    json: any,
...
export function GoogleRpcPreconditionFailureViolationToJSON(
    value?: GoogleRpcPreconditionFailureViolation | null
): any {
    if (value === undefined) {
        return undefined;
    }
