...
export function AnalyticsTrackedSegmentEventContextFromJSON(
    json: any
): AnalyticsTrackedSegmentEventContext {
    return AnalyticsTrackedSegmentEventContextFromJSONTyped(json, false);
}

export function AnalyticsTrackedSegmentEventContextFromJSONTyped(
    json: any,
    ...
    return {
        ...
        app: !exists(json, 'app')
            ? undefined
            : AnalyticsTrackedSegmentEventContextAppFromJSON(json['app']),
        locale: !exists(json, 'locale') ? undefined : json['locale'],
        os: !exists(json, 'os')
            ? undefined
            : AnalyticsTrackedSegmentEventContextOsFromJSON(json['os']),
    };
}

export function AnalyticsTrackedSegmentEventContextToJSON(
    value?: AnalyticsTrackedSegmentEventContext | null
): any {
    if (value === undefined) {
        return undefined;
    }
