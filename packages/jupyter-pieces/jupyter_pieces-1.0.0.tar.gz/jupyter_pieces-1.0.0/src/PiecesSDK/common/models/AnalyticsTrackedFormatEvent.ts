...
export function AnalyticsTrackedFormatEventFromJSON(
    json: any
): AnalyticsTrackedFormatEvent {
    return AnalyticsTrackedFormatEventFromJSONTyped(json, false);
}

export function AnalyticsTrackedFormatEventFromJSONTyped(
    json: any,
...
export function AnalyticsTrackedFormatEventToJSON(
    value?: AnalyticsTrackedFormatEvent | null
): any {
    if (value === undefined) {
        return undefined;
    }
