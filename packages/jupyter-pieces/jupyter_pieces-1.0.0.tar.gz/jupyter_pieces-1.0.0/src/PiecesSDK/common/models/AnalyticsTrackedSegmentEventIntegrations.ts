...
export function AnalyticsTrackedSegmentEventIntegrationsFromJSON(
    json: any
): AnalyticsTrackedSegmentEventIntegrations {
    return AnalyticsTrackedSegmentEventIntegrationsFromJSONTyped(json, false);
}

export function AnalyticsTrackedSegmentEventIntegrationsFromJSONTyped(
    json: any,
...
export function AnalyticsTrackedSegmentEventIntegrationsToJSON(
    value?: AnalyticsTrackedSegmentEventIntegrations | null
): any {
    if (value === undefined) {
        return undefined;
    }
