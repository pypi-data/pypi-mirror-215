...
export function TrackedSegmentEventContextFromJSON(
    json: any
): TrackedSegmentEventContext {
    return TrackedSegmentEventContextFromJSONTyped(json, false);
}

export function TrackedSegmentEventContextFromJSONTyped(
    json: any,
...
export function TrackedSegmentEventContextToJSON(
    value?: TrackedSegmentEventContext | null
): any {
    if (value === undefined) {
        return undefined;
    }
