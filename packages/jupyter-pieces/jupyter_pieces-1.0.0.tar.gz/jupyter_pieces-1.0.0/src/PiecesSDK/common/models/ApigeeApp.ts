...
export function ApigeeAppFromJSONTyped(
    json: any,
    ...
    return {
        apiProducts: !exists(json, 'apiProducts')
            ? undefined
            : (json['apiProducts'] as Array<any>).map(ApigeeProductRefFromJSON),
        ...
        callbackUrl: !exists(json, 'callbackUrl')
            ? undefined
            : json['callbackUrl'],
        companyName: !exists(json, 'companyName')
            ? undefined
            : json['companyName'],
        createdAt: !exists(json, 'createdAt') ? undefined : json['createdAt'],
        credentials: !exists(json, 'credentials')
            ? undefined
            : (json['credentials'] as Array<any>).map(ApigeeCredentialFromJSON),
        developerId: !exists(json, 'developerId')
            ? undefined
            : json['developerId'],
        keyExpiresIn: !exists(json, 'keyExpiresIn')
            ? undefined
            : json['keyExpiresIn'],
...
export function ApigeeAppToJSON(value?: ApigeeApp | null): any {
    ...
    return {
        apiProducts:
            value.apiProducts === undefined
                ? undefined
                : (value.apiProducts as Array<any>).map(ApigeeProductRefToJSON),
        appId: value.appId,
        attributes:
