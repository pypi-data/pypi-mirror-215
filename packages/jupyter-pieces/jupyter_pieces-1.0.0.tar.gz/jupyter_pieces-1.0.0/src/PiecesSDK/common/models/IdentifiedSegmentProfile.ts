...
export function IdentifiedSegmentProfileFromJSON(
    json: any
): IdentifiedSegmentProfile {
    return IdentifiedSegmentProfileFromJSONTyped(json, false);
}

export function IdentifiedSegmentProfileFromJSONTyped(
    json: any,
    ...
    return {
        ...
        integrations: IdentifiedSegmentProfileIntegrationsFromJSON(
            json['integrations']
        ),
...
export function IdentifiedSegmentProfileToJSON(
    value?: IdentifiedSegmentProfile | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        integrations: IdentifiedSegmentProfileIntegrationsToJSON(
            value.integrations
        ),
