...
export function TrackedAssetsEventMetadataFromJSON(
    json: any
): TrackedAssetsEventMetadata {
    return TrackedAssetsEventMetadataFromJSONTyped(json, false);
}

export function TrackedAssetsEventMetadataFromJSONTyped(
    json: any,
...
export function TrackedAssetsEventMetadataToJSON(
    value?: TrackedAssetsEventMetadata | null
): any {
    if (value === undefined) {
        return undefined;
    }
