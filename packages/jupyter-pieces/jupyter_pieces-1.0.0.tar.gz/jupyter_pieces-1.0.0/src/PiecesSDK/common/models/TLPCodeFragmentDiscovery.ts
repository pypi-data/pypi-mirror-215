...
export function TLPCodeFragmentDiscoveryFromJSON(
    json: any
): TLPCodeFragmentDiscovery {
    return TLPCodeFragmentDiscoveryFromJSONTyped(json, false);
}

export function TLPCodeFragmentDiscoveryFromJSONTyped(
    json: any,
    ...
    return {
        ...
        snippetized: !exists(json, 'snippetized')
            ? undefined
            : json['snippetized'],
        autocreation: !exists(json, 'autocreation')
            ? undefined
            : json['autocreation'],
...
export function TLPCodeFragmentDiscoveryToJSON(
    value?: TLPCodeFragmentDiscovery | null
): any {
    if (value === undefined) {
        return undefined;
    }
