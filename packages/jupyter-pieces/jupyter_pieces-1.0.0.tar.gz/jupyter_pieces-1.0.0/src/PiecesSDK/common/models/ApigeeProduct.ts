...
export function ApigeeProductFromJSONTyped(
    json: any,
    ...
    return {
        apiResources: !exists(json, 'apiResources')
            ? undefined
            : json['apiResources'],
        approvalType: !exists(json, 'approvalType')
            ? undefined
            : json['approvalType'],
        attributes: !exists(json, 'attributes')
            ? undefined
            : (json['attributes'] as Array<any>).map(ApigeeAttributeFromJSON),
        createdAt: !exists(json, 'createdAt') ? undefined : json['createdAt'],
        description: !exists(json, 'description')
            ? undefined
            : json['description'],
        displayName: !exists(json, 'displayName')
            ? undefined
            : json['displayName'],
        environments: !exists(json, 'environments')
            ? undefined
            : json['environments'],
        graphqlOperationGroup: !exists(json, 'graphqlOperationGroup')
            ? undefined
            : ApigeeGraphQLOperationGroupFromJSON(
                  json['graphqlOperationGroup']
              ),
        lastModifiedAt: !exists(json, 'lastModifiedAt')
            ? undefined
            : json['lastModifiedAt'],
        name: !exists(json, 'name') ? undefined : json['name'],
        operationGroup: !exists(json, 'operationGroup')
            ? undefined
            : ApigeeOperationGroupFromJSON(json['operationGroup']),
        proxies: !exists(json, 'proxies') ? undefined : json['proxies'],
        quota: !exists(json, 'quota') ? undefined : json['quota'],
        quotaInterval: !exists(json, 'quotaInterval')
            ? undefined
            : json['quotaInterval'],
        quotaTimeUnit: !exists(json, 'quotaTimeUnit')
            ? undefined
            : json['quotaTimeUnit'],
    ...
    return {
        ...
        attributes:
            value.attributes === undefined
                ? undefined
                : (value.attributes as Array<any>).map(ApigeeAttributeToJSON),
        createdAt: value.createdAt,
        description: value.description,
        displayName: value.displayName,
        environments: value.environments,
        graphqlOperationGroup: ApigeeGraphQLOperationGroupToJSON(
