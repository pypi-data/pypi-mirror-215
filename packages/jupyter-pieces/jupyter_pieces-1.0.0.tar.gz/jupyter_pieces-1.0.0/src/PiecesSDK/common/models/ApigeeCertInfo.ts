...
export function ApigeeCertInfoFromJSONTyped(
    json: any,
    ...
    return {
        basicConstraints: !exists(json, 'basicConstraints')
            ? undefined
        ...
        serialNumber: !exists(json, 'serialNumber')
            ? undefined
            : json['serialNumber'],
        sigAlgName: !exists(json, 'sigAlgName')
            ? undefined
            : json['sigAlgName'],
        subject: !exists(json, 'subject') ? undefined : json['subject'],
        subjectAlternativeNames: !exists(json, 'subjectAlternativeNames')
            ? undefined
