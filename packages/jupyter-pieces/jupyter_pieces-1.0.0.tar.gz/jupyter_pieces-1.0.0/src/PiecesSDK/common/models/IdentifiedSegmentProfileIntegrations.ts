 ...
 * @export
 * @interface IdentifiedSegmentProfileIntegrations
 */
export interface IdentifiedSegmentProfileIntegrations {
    /**
     ...
     * @type {boolean}
     * @memberof IdentifiedSegmentProfileIntegrations
     */
    all: boolean;
    /**
     * In this case, we’re specifying that we want this identify to only go to Mixpanel and Kissmetrics. 'All': false says that no destination should be enabled unless otherwise specified. 'Mixpanel': true turns on Mixpanel, etc.
...
export function IdentifiedSegmentProfileIntegrationsFromJSON(
    json: any
): IdentifiedSegmentProfileIntegrations {
    return IdentifiedSegmentProfileIntegrationsFromJSONTyped(json, false);
}

export function IdentifiedSegmentProfileIntegrationsFromJSONTyped(
    json: any,
...
export function IdentifiedSegmentProfileIntegrationsToJSON(
    value?: IdentifiedSegmentProfileIntegrations | null
): any {
    if (value === undefined) {
        return undefined;
    }
