...
export function TLPCodeSnippetSearchInputFromJSON(
    json: any
): TLPCodeSnippetSearchInput {
    return TLPCodeSnippetSearchInputFromJSONTyped(json, false);
}

export function TLPCodeSnippetSearchInputFromJSONTyped(
    json: any,
    ...
    return {
        ...
        embeddings: !exists(json, 'embeddings')
            ? undefined
            : (json['embeddings'] as Array<any>).map(EmbeddingFromJSON),
        tags: !exists(json, 'tags')
            ? undefined
            : (json['tags'] as Array<any>).map(
                  TLPCodeSnippetTagifyCodeTagFromJSON
              ),
    };
}

export function TLPCodeSnippetSearchInputToJSON(
    value?: TLPCodeSnippetSearchInput | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        embeddings:
            value.embeddings === undefined
                ? undefined
                : (value.embeddings as Array<any>).map(EmbeddingToJSON),
        tags:
            value.tags === undefined
                ? undefined
                : (value.tags as Array<any>).map(
                      TLPCodeSnippetTagifyCodeTagToJSON
                  ),
    };
}
