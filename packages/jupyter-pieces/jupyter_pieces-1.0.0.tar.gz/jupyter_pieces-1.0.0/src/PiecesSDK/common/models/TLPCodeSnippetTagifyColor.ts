...
export function TLPCodeSnippetTagifyColorFromJSON(
    json: any
): TLPCodeSnippetTagifyColor {
    return TLPCodeSnippetTagifyColorFromJSONTyped(json, false);
}

export function TLPCodeSnippetTagifyColorFromJSONTyped(
    json: any,
...
export function TLPCodeSnippetTagifyColorToJSON(
    value?: TLPCodeSnippetTagifyColor | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        hex: value.hex,
        tags: (value.tags as Array<any>).map(
            TLPCodeSnippetTagifyNamedColorToJSON
        ),
    };
}
