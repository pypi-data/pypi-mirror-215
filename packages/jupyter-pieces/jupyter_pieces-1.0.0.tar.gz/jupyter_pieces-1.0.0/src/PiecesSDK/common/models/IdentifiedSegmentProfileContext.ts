...
export function IdentifiedSegmentProfileContextFromJSON(
    json: any
): IdentifiedSegmentProfileContext {
    return IdentifiedSegmentProfileContextFromJSONTyped(json, false);
}

export function IdentifiedSegmentProfileContextFromJSONTyped(
    json: any,
    ...
    return {
        ...
        app: !exists(json, 'app')
            ? undefined
            : AnalyticsTrackedOSFromJSON(json['app']),
...
export function IdentifiedSegmentProfileContextToJSON(
    value?: IdentifiedSegmentProfileContext | null
): any {
    if (value === undefined) {
        return undefined;
    }
