...
export function TLPCodeSnippetizerReturnableFromJSON(
    json: any
): TLPCodeSnippetizerReturnable {
    return TLPCodeSnippetizerReturnableFromJSONTyped(json, false);
}

export function TLPCodeSnippetizerReturnableFromJSONTyped(
    json: any,
...
export function TLPCodeSnippetizerReturnableToJSON(
    value?: TLPCodeSnippetizerReturnable | null
): any {
    if (value === undefined) {
        return undefined;
    }
