...
export function AllocationUpdateFromJSONTyped(
    json: any,
    ...
    return {
        ...
        cloud: !exists(json, 'cloud')
            ? undefined
            : AllocationCloudUpdateFromJSON(json['cloud']),
        urls: !exists(json, 'urls')
            ? undefined
            : AllocationUrlsUpdateFromJSON(json['urls']),
    };
}
