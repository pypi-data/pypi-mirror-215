...
export function AnalyticsTrackedAdoptionEventFromJSON(
    json: any
): AnalyticsTrackedAdoptionEvent {
    return AnalyticsTrackedAdoptionEventFromJSONTyped(json, false);
}

export function AnalyticsTrackedAdoptionEventFromJSONTyped(
    json: any,
...
export function AnalyticsTrackedAdoptionEventToJSON(
    value?: AnalyticsTrackedAdoptionEvent | null
): any {
    if (value === undefined) {
        return undefined;
    }
