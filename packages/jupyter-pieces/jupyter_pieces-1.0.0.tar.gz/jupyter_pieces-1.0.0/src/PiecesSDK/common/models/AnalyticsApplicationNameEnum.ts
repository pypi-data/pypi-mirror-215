...
export function AnalyticsApplicationNameEnumFromJSON(
    json: any
): AnalyticsApplicationNameEnum {
    return AnalyticsApplicationNameEnumFromJSONTyped(json, false);
}

export function AnalyticsApplicationNameEnumFromJSONTyped(
    json: any,
...
export function AnalyticsApplicationNameEnumToJSON(
    value?: AnalyticsApplicationNameEnum | null
): any {
    return value as any;
}
