...
export function TrackedSummaryPropertiesFromJSON(
    json: any
): TrackedSummaryProperties {
    return TrackedSummaryPropertiesFromJSONTyped(json, false);
}

export function TrackedSummaryPropertiesFromJSONTyped(
    json: any,
...
export function TrackedSummaryPropertiesToJSON(
    value?: TrackedSummaryProperties | null
): any {
    if (value === undefined) {
        return undefined;
    }
