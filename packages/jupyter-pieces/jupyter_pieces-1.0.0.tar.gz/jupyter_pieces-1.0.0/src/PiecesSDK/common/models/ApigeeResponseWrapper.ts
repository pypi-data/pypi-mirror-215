...
export function ApigeeResponseWrapperFromJSON(
    json: any
): ApigeeResponseWrapper {
    return ApigeeResponseWrapperFromJSONTyped(json, false);
}

export function ApigeeResponseWrapperFromJSONTyped(
    json: any,
...
export function ApigeeResponseWrapperToJSON(
    value?: ApigeeResponseWrapper | null
): any {
    if (value === undefined) {
        return undefined;
    }
