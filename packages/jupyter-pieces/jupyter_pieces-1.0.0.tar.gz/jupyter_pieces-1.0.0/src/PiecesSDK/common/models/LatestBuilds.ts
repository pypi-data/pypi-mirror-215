...
export function LatestBuildsFromJSONTyped(
    json: any,
    ...
    return {
        ...
        item: json['item'],
        builds: !exists(json, 'builds')
            ? undefined
            : (json['builds'] as Array<any>).map(BuildsFromJSON),
    };
}
    ...
    return {
        ...
        builds:
            value.builds === undefined
                ? undefined
                : (value.builds as Array<any>).map(BuildsToJSON),
    };
}
