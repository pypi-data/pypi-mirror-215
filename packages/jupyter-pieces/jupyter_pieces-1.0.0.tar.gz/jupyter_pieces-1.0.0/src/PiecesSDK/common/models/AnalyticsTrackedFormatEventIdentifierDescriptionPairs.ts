...
export function AnalyticsTrackedFormatEventIdentifierDescriptionPairsFromJSON(
    json: any
): AnalyticsTrackedFormatEventIdentifierDescriptionPairs {
    return AnalyticsTrackedFormatEventIdentifierDescriptionPairsFromJSONTyped(
        json,
        false
    );
}

export function AnalyticsTrackedFormatEventIdentifierDescriptionPairsFromJSONTyped(
    json: any,
...
export function AnalyticsTrackedFormatEventIdentifierDescriptionPairsToJSON(
    value?: AnalyticsTrackedFormatEventIdentifierDescriptionPairs | null
): any {
    if (value === undefined) {
        return undefined;
    }
