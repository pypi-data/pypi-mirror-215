...
export function TLPCodeSnippetClusteringReturnableFromJSON(
    json: any
): TLPCodeSnippetClusteringReturnable {
    return TLPCodeSnippetClusteringReturnableFromJSONTyped(json, false);
}

export function TLPCodeSnippetClusteringReturnableFromJSONTyped(
    json: any,
    ...
    return {
        iterable: (json['iterable'] as Array<any>).map(
            TLPCodeSnippetClusterFromJSON
        ),
...
export function TLPCodeSnippetClusteringReturnableToJSON(
    value?: TLPCodeSnippetClusteringReturnable | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        iterable: (value.iterable as Array<any>).map(
            TLPCodeSnippetClusterToJSON
        ),
