...
export function LinkExtractionReturnableFromJSON(
    json: any
): LinkExtractionReturnable {
    return LinkExtractionReturnableFromJSONTyped(json, false);
}

export function LinkExtractionReturnableFromJSONTyped(
    json: any,
...
export function LinkExtractionReturnableToJSON(
    value?: LinkExtractionReturnable | null
): any {
    if (value === undefined) {
        return undefined;
    }
