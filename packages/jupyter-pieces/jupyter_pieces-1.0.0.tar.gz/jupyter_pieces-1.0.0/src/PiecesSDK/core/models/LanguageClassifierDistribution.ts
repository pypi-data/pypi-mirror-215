...
export function LanguageClassifierDistributionFromJSON(
    json: any
): LanguageClassifierDistribution {
    return LanguageClassifierDistributionFromJSONTyped(json, false);
}

export function LanguageClassifierDistributionFromJSONTyped(
    json: any,
...
export function LanguageClassifierDistributionToJSON(
    value?: LanguageClassifierDistribution | null
): any {
    if (value === undefined) {
        return undefined;
    }
