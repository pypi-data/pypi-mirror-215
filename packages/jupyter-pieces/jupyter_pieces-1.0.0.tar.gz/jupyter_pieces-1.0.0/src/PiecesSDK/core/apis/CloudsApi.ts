...
export class CloudsApi extends runtime.BaseAPI {
     ...
     * /clouds/connect [POST]
     */
    async cloudsConnectNewCloudRaw(
        requestParameters: CloudsConnectNewCloudRequest
     ...
     */
    async cloudsDisconnectCloudRaw(
        requestParameters: CloudsDisconnectCloudRequest
     ...
     */
    async cloudsReconnectCloudRaw(
        requestParameters: CloudsReconnectCloudRequest
    ): Promise<runtime.ApiResponse<Cloud>> {
        const queryParameters: any = {};
