...
export class CloudApi extends runtime.BaseAPI {
     ...
     * /cloud/{cloud} [GET]
     */
    async cloudSnapshotRaw(
        requestParameters: CloudSnapshotRequest
    ): Promise<runtime.ApiResponse<Cloud>> {
        if (
            requestParameters.cloud === null ||
            requestParameters.cloud === undefined
        ) {
            throw new runtime.RequiredError(
                'cloud',
                'Required parameter requestParameters.cloud was null or undefined when calling cloudSnapshot.'
            );
        }
        ...
        const response = await this.request({
            path: `/cloud/{cloud}`.replace(
                `{${'cloud'}}`,
                encodeURIComponent(String(requestParameters.cloud))
            ),
            method: 'GET',
     ...
     * /cloud/update [POST]
     */
    async cloudUpdateRaw(
        requestParameters: CloudUpdateRequest
    ): Promise<runtime.ApiResponse<Cloud>> {
        const queryParameters: any = {};
     ...
     * Version sync
     */
    async cloudVersionSyncRaw(
        requestParameters: CloudVersionSyncRequest
    ): Promise<runtime.ApiResponse<VersionSyncResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) =>
            VersionSyncResponseFromJSON(jsonValue)
        );
    }
     ...
     * Version sync
     */
    async cloudVersionSync(
        requestParameters: CloudVersionSyncRequest
    ): Promise<VersionSyncResponse> {
