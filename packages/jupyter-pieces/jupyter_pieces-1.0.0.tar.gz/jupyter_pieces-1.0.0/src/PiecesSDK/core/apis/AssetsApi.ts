...
export class AssetsApi extends runtime.BaseAPI {
     ...
     */
    async assetsIdentifiersSnapshotRaw(): Promise<
        runtime.ApiResponse<FlattenedAssets>
    > {
        const queryParameters: any = {};
     ...
     */
    async assetsSearchAssetsRaw(
        requestParameters: AssetsSearchAssetsRequest
    ...
    async assetsSpecificAssetFormatsSnapshotRaw(
    ...
    ): Promise<runtime.ApiResponse<AssetFormats>> {
        if (
            requestParameters.asset === null ||
            requestParameters.asset === undefined
        ) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) =>
            AssetFormatsFromJSON(jsonValue)
        );
    }
     ...
     */
    async assetsStreamIdentifiersRaw(): Promise<
        runtime.ApiResponse<StreamedIdentifiers>
    > {
        const queryParameters: any = {};
     ...
     * Your GET endpoint
     */
    async getAssetsStreamTransferablesRaw(): Promise<
        runtime.ApiResponse<Assets>
    > {
        const queryParameters: any = {};
