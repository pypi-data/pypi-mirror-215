...
class TestQciClientFiles(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.graph_job_body = {"job_name": "job_0", "graph_file_id": cls.graph_file_id}

        cls.qubo_job_body = {"job_name": "job_0", "qubo_file_id": cls.qubo_file_id}
    ...
    def test_validate_job_type(self):
        ...
        with self.assertRaises(AssertionError) as context:
            self.q1.validate_job_type(job_type="fake_job_type")

        self.assertEqual(
            str(context.exception),
            f"job_type must be one of {self.q1._supported_job_types}",  # pylint: disable=protected-access
        )
...
class TestMultipartUpload(unittest.TestCase):
    ...
    def test_multipart_process_job(self):
        ...
        qubo_job_body = {"job_name": "job_0", "qubo_file_id": resp["file_id"]}
