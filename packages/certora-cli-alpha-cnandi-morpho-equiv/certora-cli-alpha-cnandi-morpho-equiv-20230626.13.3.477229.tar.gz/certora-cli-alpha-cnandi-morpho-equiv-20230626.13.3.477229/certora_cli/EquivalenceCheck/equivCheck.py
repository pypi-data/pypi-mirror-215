...
LOG_PATH = Path('EquivalenceCheck/EqCheck_log.log')
SANITY_PATH = Path('EquivalenceCheck/sanity.spec')
DEF_TEMPLATE_PATH = Path('EquivalenceCheck/Eq_template.spec')
MC_TEMPLATE_PATH = Path('EquivalenceCheck/Eq_mc_template.spec')
DEFAULT_CONF_PATH = Path("EquivalenceCheck/Eq_default.conf")
SANITY_CONF_PATH = Path("EquivalenceCheck/Eq_sanity.conf")
TMP_SANITY_CONF = Path("EquivalenceCheck/tmp.conf")
...
class EquivalenceChecker:
    ...
    def generate_spec(self) -> Path:
        ...
        spec_file_path = output_dir / (self.functions[0] + "_" + contractA
                                       + "_to_"
                                       + self.functions[1] + "_" + contractB
                                       + "_equivalence.spec")
