...
struct___sFILE._fields_ = [
    ...
    (
        "_seek",
        ctypes.CFUNCTYPE(
            ctypes.c_int64, ctypes.POINTER(None), ctypes.c_int64, ctypes.c_int32
        ),
    ),
    (
        "_write",
...
xnvme_ver_fpr.argtypes = [ctypes.POINTER(struct___sFILE), ctypes.c_int32]
...
xnvme_lba_fpr.argtypes = [ctypes.POINTER(struct___sFILE), uint64_t, xnvme_pr]
...
xnvme_libconf_fpr.argtypes = [ctypes.POINTER(struct___sFILE), xnvme_pr]
