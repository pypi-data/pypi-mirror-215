...
def validateRequisites(object:DataFrame, field:list):
    ...
    if len(error_list) == Zero and rowsNumber != Zero :
        return  print("Ha superado la validación de requisitos exitosamente.\n")
...
def validateConditional(object:DataFrame,
    ...
    qualityFunction[2] = object.count()
    ...
    return [object.count(),Rules.validateConditional.code,Rules.validateConditional.name,Rules.validateConditional.property,Rules.validateConditional.code + "/" + entity + "/" + columnName,threshold,dataRequirement, columnName, ratio, errorCount], errorDf
